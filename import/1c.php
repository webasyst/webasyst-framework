...
//	}
    ...
    $query = mysql_query("SELECT * FROM SC_products WHERE categoryID IN ('726', '675', '667', '677', '676', '666', '727', '672', '670', '674', '673', '671')", $db1);
    while ($row = mysql_fetch_array($query))
    {
        ...
        $insert = mysql_query("INSERT INTO 1C_products (id,
							...
							new,
							brend,
							related) VALUES ('".$row['productID']."',
                                                                         '".$row['categoryID'].",".$cat."',
                                                                         '".$row['Price']."',
                                                                         '".$row['in_stock']."',
                                                                         '".$default_picture['filename']."',
                                                                         '".$row['slug']."',
                                                                         '".$row['name_ru']."',
                                                                         '".$row['brief_description_ru']."',
                                                                         '".$row['description_ru']."',
                                                                         '".$row['meta_title_ru']."',
                                                                         '".$row['meta_description_ru']."',
                                                                         '".$row['meta_keywords_ru']."',
                                                                         '".$row['no_dublicate']."',
                                                                         '".$row['new']."',
                                                                         '".$brend['name']."',
                                                                         '".$related."')", $db1);
...
if (isset($_POST['categories']))
{
	...
	$query = mysql_query("SELECT * FROM SC_categories WHERE categoryID = 665 OR categoryID = 669 OR parent = 665 OR parent = 669", $db1);
    ...
    while ($row = mysql_fetch_array($query))
    {
        $insert = mysql_query("INSERT INTO 1C_categories (id,
													      ...
													      no_dublicate) VALUES ('".$row['categoryID']."',
																				 ...
																				 '".$row['name_ru']."',
																				 '".$row['description_ru']."',
																				 '".$row['description_second_ru']."',
																				 '".$row['meta_title_ru']."',
																				 '".$row['meta_description_ru']."',
																				 '".$row['meta_keywords_ru']."',
																				 '".$row['no_dublicate']."')", $db1);
