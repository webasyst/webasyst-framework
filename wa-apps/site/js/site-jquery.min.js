...
c.find(".dialog-buttons").length){c.find(".dialog-content").length&&b.find(".dialog-content-indent").empty().append(c.find(".dialog-content").contents());c.find(".dialog-buttons").length&&b.find(".dialog-buttons-gradient").empty().append(c.find(".dialog-buttons").contents())}else b.find(".dialog-content-indent").html(f);b.trigger("wa-resize");a.onLoad&&a.onLoad.call(b.get(0))}):a.onLoad&&a.onLoad.call(b.get(0));b.find(".dialog-buttons").delegate(".cancel","click",function(f){f.stopPropagation();f.preventDefault();
...
c):g()})},filesList:function(b,c){b||(b=this.filesPath());c||(c=this.filesPage());a.post("?module=files&action=list&page="+c,{path:b},function(e){a("#s-files-grid tr.s-file").remove();a("div.s-pagination").empty();for(var f=0;f<e.data.files.length;f++){var d=e.data.files[f],d='<tr class="s-file"><td class="min-width"><input type="checkbox" value="'+d.file+'" /></td><td><ul class="menu-h dropdown clickable"><li><a href="#"><i class="icon16 '+d.type+'"></i> '+d.file+' <i class="icon10 darr no-overhanging s-file-actions"></i></a></li></ul></td><td>'+
d.datetime+'</td><td><span class="float-right">'+a.wa.site.getFileSize(d.size)+"</span></td></tr>";a("#s-files-grid").append(d)}if(1<e.data.pages){d='<ul class="menu-h">';for(f=1;f<=e.data.pages;f++)d+="<li"+(f==c?' class="selected"':"")+'><a href="#/files/'+b+"?page="+f+'">'+f+"</a></li>";a("div.s-pagination").html(d+"</ul>").show()}},"json")},getFileSize:function(a){return 1024>a?a+" B":1048576>a?Math.round(a/1024)+" KB":1073741824>a?Math.round(a/1048576)+" MB":Math.round(a/1073741824)+" GB"},checkFileType:function(a){return"image"==
...
this.domain;this.savePanel(!1);var e=function(){a("#s-personal-content").html('<i class="icon16 loading"></i>').load("?module=personal&action=settings&hash="+(b||""),"domain_id="+c,function(){a("ul.s-personal-structure li.selected").removeClass("selected")})};a("#s-personal-content").length?e():this.personalAction(e)},personalAppAction:function(b){var c=this.domain;this.savePanel(!1);var e=function(){a("#s-personal-content").html('<i class="icon16 loading"></i>').load("?module=personal&action=app&app_id="+
b,"domain_id="+c,function(){a("ul.s-personal-structure li.selected").removeClass("selected");a("#s-personal-app-"+b).addClass("selected");a("#s-app-frontend-link").html(a("#s-personal-app-"+b).data("link")).attr("href",a("#s-personal-app-"+b).data("link"))})};a("#s-personal-content").length?e():this.personalAction(e)},personalProfileAction:function(){var b=this.domain;this.savePanel(!1);var c=function(){a("#s-personal-content").html('<i class="icon16 loading"></i>').load("?module=personal&action=profile",
