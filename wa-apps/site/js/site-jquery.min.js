...
return b});if(!d)return b;a.value=d.call("DOMParser"in window&&new DOMParser||window,a.value,"text/xml");return this.isXML(a.value)?a.value:b}}}})(jQuery);(function(a){a.ui=a.ui||{};var b=/left|center|right/,c=/top|center|bottom/,d={},f=a.fn.position,e=a.fn.offset;a.fn.position=function(e){if(!e||!e.of)return f.apply(this,arguments);var e=a.extend({},e),g=a(e.of),j=g[0],l=(e.collision||"flip").split(" "),o=e.offset?e.offset.split(" "):[0,0],h,k,m;return 9===j.nodeType?(h=g.width(),k=g.height(),m={top:0,left:0}):j.setTimeout?(h=g.width(),k=g.height(),m={top:g.scrollTop(),left:g.scrollLeft()}):j.preventDefault?(e.at="left top",h=k=0,m={top:e.of.pageY,
left:e.of.pageX}):(h=g.outerWidth(),k=g.outerHeight(),m=g.offset()),a.each(["my","at"],function(){var a=(e[this]||"").split(" ");1===a.length&&(a=b.test(a[0])?a.concat(["center"]):c.test(a[0])?["center"].concat(a):["center","center"]);a[0]=b.test(a[0])?a[0]:"center";a[1]=c.test(a[1])?a[1]:"center";e[this]=a}),1===l.length&&(l[1]=l[0]),o[0]=parseInt(o[0],10)||0,1===o.length&&(o[1]=o[0]),o[1]=parseInt(o[1],10)||0,"right"===e.at[0]?m.left+=h:"center"===e.at[0]&&(m.left+=h/2),"bottom"===e.at[1]?m.top+=
k:"center"===e.at[1]&&(m.top+=k/2),m.left+=o[0],m.top+=o[1],this.each(function(){var b=a(this),f=b.outerWidth(),c=b.outerHeight(),g=parseInt(a.curCSS(this,"marginLeft",!0))||0,j=parseInt(a.curCSS(this,"marginTop",!0))||0,q=f+g+(parseInt(a.curCSS(this,"marginRight",!0))||0),r=c+j+(parseInt(a.curCSS(this,"marginBottom",!0))||0),n=a.extend({},m),s;"right"===e.my[0]?n.left-=f:"center"===e.my[0]&&(n.left-=f/2);"bottom"===e.my[1]?n.top-=c:"center"===e.my[1]&&(n.top-=c/2);d.fractions||(n.left=Math.round(n.left),
n.top=Math.round(n.top));s={left:n.left-g,top:n.top-j};a.each(["left","top"],function(b,d){a.ui.position[l[b]]&&a.ui.position[l[b]][d](n,{targetWidth:h,targetHeight:k,elemWidth:f,elemHeight:c,collisionPosition:s,collisionWidth:q,collisionHeight:r,offset:o,my:e.my,at:e.at})});a.fn.bgiframe&&b.bgiframe();b.offset(a.extend(n,{using:e.using}))})};a.ui.position={fit:{left:function(b,f){var e=a(window),e=f.collisionPosition.left+f.collisionWidth-e.width()-e.scrollLeft();b.left=0<e?b.left-e:Math.max(b.left-
...
0).keydown(function(d){if(e.closeOnEscape&&d.keyCode&&d.keyCode===a.ui.keyCode.ESCAPE){b.close(d);d.preventDefault()}}).attr({role:"dialog","aria-labelledby":c}).mousedown(function(a){b.moveToTop(false,a)});b.element.show().removeAttr("title").addClass("ui-dialog-content ui-widget-content").appendTo(h);var l=(b.uiDialogTitlebar=a("<div></div>")).addClass("ui-dialog-titlebar ui-widget-header ui-corner-all ui-helper-clearfix").prependTo(h),k=a('<a href="#"></a>').addClass("ui-dialog-titlebar-close ui-corner-all").attr("role",
"button").hover(function(){k.addClass("ui-state-hover")},function(){k.removeClass("ui-state-hover")}).focus(function(){k.addClass("ui-state-focus")}).blur(function(){k.removeClass("ui-state-focus")}).click(function(a){b.close(a);return false}).appendTo(l);(b.uiDialogTitlebarCloseText=a("<span></span>")).addClass("ui-icon ui-icon-closethick").text(e.closeText).appendTo(k);a("<span></span>").addClass("ui-dialog-title").attr("id",c).html(d).prependTo(l);a.isFunction(e.beforeclose)&&!a.isFunction(e.beforeClose)&&
...
this.originalTitle&&this.element.attr("title",this.originalTitle);return this},widget:function(){return this.uiDialog},close:function(b){var e=this,d,c;if(!1!==e._trigger("beforeClose",b))return e.overlay&&e.overlay.destroy(),e.uiDialog.unbind("keypress.ui-dialog"),e._isOpen=!1,e.options.hide?e.uiDialog.hide(e.options.hide,function(){e._trigger("close",b)}):(e.uiDialog.hide(),e._trigger("close",b)),a.ui.dialog.overlay.resize(),e.options.modal&&(d=0,a(".ui-dialog").each(function(){if(this!==e.uiDialog[0]){c=
a(this).css("z-index");isNaN(c)||(d=Math.max(d,c))}}),a.ui.dialog.maxZ=d),e},isOpen:function(){return this._isOpen},moveToTop:function(b,e){var d=this.options;if(d.modal&&!b||!d.stack&&!d.modal)return this._trigger("focus",e);d.zIndex>a.ui.dialog.maxZ&&(a.ui.dialog.maxZ=d.zIndex);this.overlay&&(a.ui.dialog.maxZ+=1,this.overlay.$el.css("z-index",a.ui.dialog.overlay.maxZ=a.ui.dialog.maxZ));b={scrollTop:this.element.attr("scrollTop"),scrollLeft:this.element.attr("scrollLeft")};a.ui.dialog.maxZ+=1;this.uiDialog.css("z-index",
a.ui.dialog.maxZ);this.element.attr(b);this._trigger("focus",e);return this},open:function(){if(!this._isOpen){var b=this.options,e=this.uiDialog;this.overlay=b.modal?new a.ui.dialog.overlay(this):null;this._size();this._position(b.position);e.show(b.show);this.moveToTop(!0);b.modal&&e.bind("keypress.ui-dialog",function(b){if(b.keyCode===a.ui.keyCode.TAB){var f=a(":tabbable",this),e=f.filter(":first"),f=f.filter(":last");if(b.target===f[0]&&!b.shiftKey)return e.focus(1),!1;if(b.target===e[0]&&b.shiftKey)return f.focus(1),
!1}});a(this.element.find(":tabbable").get().concat(e.find(".ui-dialog-buttonpane :tabbable").get().concat(e.get()))).eq(0).focus();this._isOpen=!0;this._trigger("open");return this}},_createButtons:function(b){var e=this,d=!1,c=a("<div></div>").addClass("ui-dialog-buttonpane ui-widget-content ui-helper-clearfix"),h=a("<div></div>").addClass("ui-dialog-buttonset").appendTo(c);e.uiDialog.find(".ui-dialog-buttonpane").remove();"object"===typeof b&&null!==b&&a.each(b,function(){return!(d=!0)});d&&(a.each(b,
function(b,f){f=a.isFunction(f)?{click:f,text:b}:f;b=a('<button type="button"></button>').attr(f,!0).unbind("click").click(function(){f.click.apply(e.element[0],arguments)}).appendTo(h);a.fn.button&&b.button()}),c.appendTo(e.uiDialog))},_makeDraggable:function(){function b(a){return{position:a.position,offset:a.offset}}var e=this,d=e.options,c=a(document),h;e.uiDialog.draggable({cancel:".ui-dialog-content, .ui-dialog-titlebar-close",handle:".ui-dialog-titlebar",containment:"document",start:function(c,
...
function(){a(this).removeClass("ui-state-hover")});this.anchors.bind("focus.tabs",function(){l("focus",a(this).closest("li"))});this.anchors.bind("blur.tabs",function(){a(this).closest("li").removeClass("ui-state-focus")})}var k,p;g.fx&&(a.isArray(g.fx)?(k=g.fx[0],p=g.fx[1]):k=p=g.fx);var q=p?function(b,d){a(b).closest("li").addClass("ui-tabs-selected ui-state-active");d.hide().removeClass("ui-tabs-hide").animate(p,p.duration||"normal",function(){c(d,p);e._trigger("show",null,e._ui(b,d[0]))})}:function(b,
d){a(b).closest("li").addClass("ui-tabs-selected ui-state-active");d.removeClass("ui-tabs-hide");e._trigger("show",null,e._ui(b,d[0]))},r=k?function(a,b){b.animate(k,k.duration||"normal",function(){e.lis.removeClass("ui-tabs-selected ui-state-active");b.addClass("ui-tabs-hide");c(b,k);e.element.dequeue("tabs")})}:function(a,b){e.lis.removeClass("ui-tabs-selected ui-state-active");b.addClass("ui-tabs-hide");e.element.dequeue("tabs")};this.anchors.bind(g.event+".tabs",function(){var b=this,d=a(this).closest("li"),
c=e.panels.filter(":not(.ui-tabs-hide)"),f=a(e._sanitizeSelector(this.hash));if(d.hasClass("ui-tabs-selected")&&!g.collapsible||d.hasClass("ui-state-disabled")||d.hasClass("ui-state-processing")||e._trigger("select",null,e._ui(this,f[0]))===false){this.blur();return false}g.selected=e.anchors.index(this);e.abort();if(g.collapsible){if(d.hasClass("ui-tabs-selected")){g.selected=-1;g.cookie&&e._cookie(g.selected,g.cookie);e.element.queue("tabs",function(){r(b,c)}).dequeue("tabs");this.blur();return false}if(!c.length){g.cookie&&
e._cookie(g.selected,g.cookie);e.element.queue("tabs",function(){q(b,f)});e.load(e.anchors.index(this));this.blur();return false}}g.cookie&&e._cookie(g.selected,g.cookie);if(f.length){c.length&&e.element.queue("tabs",function(){r(b,c)});e.element.queue("tabs",function(){q(b,f)});e.load(e.anchors.index(this))}else throw"jQuery UI Tabs: Mismatching fragment identifier.";a.browser.msie&&this.blur()});this.anchors.bind("click.tabs",function(){return false})},destroy:function(){var b=this.options;this.abort();
...
typeof a?a=this.anchors.index(this.anchors.filter("[href$="+a+"]")):null===a&&(a=-1);-1==a&&this.options.collapsible&&(a=this.options.selected);this.anchors.eq(a).trigger(this.options.event+".tabs");return this},load:function(b){var c=this,e=this.options,g=this.anchors.eq(b)[0],j=a.data(g,"load.tabs");this.abort();if(!j||0!==this.element.queue("tabs").length&&a.data(g,"cache.tabs"))this.element.dequeue("tabs");else{this.lis.eq(b).addClass("ui-state-processing");if(e.spinner){var h=a("span",g);h.data("label.tabs",
h.html()).html(e.spinner)}this.xhr=a.ajax(a.extend({},e.ajaxOptions,{url:j,success:function(h,j){a(c._sanitizeSelector(g.hash)).html(h);c._cleanup();e.cache&&a.data(g,"cache.tabs",!0);c._trigger("load",null,c._ui(c.anchors[b],c.panels[b]));try{e.ajaxOptions.success(h,j)}catch(p){}},error:function(a,h){c._cleanup();c._trigger("load",null,c._ui(c.anchors[b],c.panels[b]));try{e.ajaxOptions.error(a,h,b,g)}catch(j){}}}));c.element.dequeue("tabs");return this}},abort:function(){this.element.queue([]);this.panels.stop(!1,
...
a("#s-save-panel .s-bottom-fixed-bar-content-offset").attr("class","s-bottom-fixed-bar-content-offset")):(a("#s-save-panel").hide(),a("#wa div.s-scrollable-part").addClass("s-no-editor"))},getTreeHTML:function(a,c,d){for(var d=d||"",c="<ul"+(c?"":' style="display:none"')+' class="menu-v with-icons'+(c?" "+c:"")+'">',f="",e=0;e<a.length;e++)f="string"==typeof a[e]?a[e]:a[e].id,c+="<li>","string"!=typeof a[e]&&(c+='<i class="icon16 rarr overhanging"></i>'),c+='<a href="#/files/'+d+f+'/"><i class="icon16 folder"></i><b>'+
...
true:false,g=a(this).children("a");f=f+("<option "+(b?'selected="selected"':"")+' value="'+g.attr("href").substr(8)+'">'+c+g.children("b").html()+"</option>");if(a(this).children("ul").length&&(!d||!a(this).hasClass("selected")))f=f+a.wa.site.filesPathOptions(a(this).children("ul"),c+"&nbsp;&nbsp;&nbsp;",d)});return f}}})(jQuery);
