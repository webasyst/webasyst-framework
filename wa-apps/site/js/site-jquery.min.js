jQuery.fn.waDialog=function(a){var a=jQuery.extend({loading_header:"",title:"",esc:!0,buttons:null,url:null,url_reload:!0,"class":null,content:null,width:0,height:0,"min-width":0,"min-height":0,disableButtonsOnSubmit:!1,onLoad:null,onCancel:null,onSubmit:null},a||{}),b=$(this),c=b.attr("id");c&&!b.hasClass("dialog")&&(b.removeAttr("id"),$("#"+c).length&&(a.url?(b=$("#"+c),a.url_reload||(a.url=null)):$("#"+c).remove()));var e=a["class"]||a.className?a["class"]||a.className:b.attr("class")||"";if(b.hasClass("dialog"))a.content&&
(b.find(".dialog-content-indent").html(a.content),a.title&&b.find(".dialog-content-indent").prepend("<h1>"+a.title+"</h1>")),a.buttons&&b.find(".dialog-buttons-gradient").empty().append(a.buttons);else{var f=$(this),b=$("<div "+(c?'id = "'+c+'"':"")+' class="dialog '+e+'" style="display: none"><div class="dialog-background"></div><div class="dialog-window"></div></div>').appendTo("body");if(f.find(".dialog-content").length||f.find(".dialog-buttons").length){if($(".dialog-window",b).append(f.show()),
c=f.find(".dialog-content"),c.length&&(e=$('<div class="dialog-content-indent"></div>'),c.contents().appendTo(e),c.append(e)),c=f.find(".dialog-buttons"),c.length)e=$('<div class="dialog-buttons-gradient"></div>'),c.contents().appendTo(e),c.append(e)}else $(".dialog-window",b).append((a.onSubmit?'<form method="post" action="">':"")+'<div class="dialog-content"><div class="dialog-content-indent"></div></div><div class="dialog-buttons"><div class="dialog-buttons-gradient"></div></div>'+(a.onSubmit?
...
return b});if(!e)return b;a.value=e.call("DOMParser"in window&&new DOMParser||window,a.value,"text/xml");return this.isXML(a.value)?a.value:b}}}})(jQuery);(function(a){a.ui=a.ui||{};var b=/left|center|right/,c=/top|center|bottom/,e={},f=a.fn.position,d=a.fn.offset;a.fn.position=function(d){if(!d||!d.of)return f.apply(this,arguments);var d=a.extend({},d),g=a(d.of),j=g[0],l=(d.collision||"flip").split(" "),o=d.offset?d.offset.split(" "):[0,0],h,k,m;return 9===j.nodeType?(h=g.width(),k=g.height(),m={top:0,left:0}):j.setTimeout?(h=g.width(),k=g.height(),m={top:g.scrollTop(),left:g.scrollLeft()}):j.preventDefault?(d.at="left top",h=k=0,m={top:d.of.pageY,
left:d.of.pageX}):(h=g.outerWidth(),k=g.outerHeight(),m=g.offset()),a.each(["my","at"],function(){var a=(d[this]||"").split(" ");1===a.length&&(a=b.test(a[0])?a.concat(["center"]):c.test(a[0])?["center"].concat(a):["center","center"]);a[0]=b.test(a[0])?a[0]:"center";a[1]=c.test(a[1])?a[1]:"center";d[this]=a}),1===l.length&&(l[1]=l[0]),o[0]=parseInt(o[0],10)||0,1===o.length&&(o[1]=o[0]),o[1]=parseInt(o[1],10)||0,"right"===d.at[0]?m.left+=h:"center"===d.at[0]&&(m.left+=h/2),"bottom"===d.at[1]?m.top+=
k:"center"===d.at[1]&&(m.top+=k/2),m.left+=o[0],m.top+=o[1],this.each(function(){var b=a(this),f=b.outerWidth(),c=b.outerHeight(),g=parseInt(a.curCSS(this,"marginLeft",!0))||0,j=parseInt(a.curCSS(this,"marginTop",!0))||0,q=f+g+(parseInt(a.curCSS(this,"marginRight",!0))||0),r=c+j+(parseInt(a.curCSS(this,"marginBottom",!0))||0),n=a.extend({},m),s;"right"===d.my[0]?n.left-=f:"center"===d.my[0]&&(n.left-=f/2);"bottom"===d.my[1]?n.top-=c:"center"===d.my[1]&&(n.top-=c/2);e.fractions||(n.left=Math.round(n.left),
n.top=Math.round(n.top));s={left:n.left-g,top:n.top-j};a.each(["left","top"],function(b,e){a.ui.position[l[b]]&&a.ui.position[l[b]][e](n,{targetWidth:h,targetHeight:k,elemWidth:f,elemHeight:c,collisionPosition:s,collisionWidth:q,collisionHeight:r,offset:o,my:d.my,at:d.at})});a.fn.bgiframe&&b.bgiframe();b.offset(a.extend(n,{using:d.using}))})};a.ui.position={fit:{left:function(b,f){var d=a(window),d=f.collisionPosition.left+f.collisionWidth-d.width()-d.scrollLeft();b.left=0<d?b.left-d:Math.max(b.left-
f.collisionPosition.left,b.left)},top:function(b,f){var d=a(window),d=f.collisionPosition.top+f.collisionHeight-d.height()-d.scrollTop();b.top=0<d?b.top-d:Math.max(b.top-f.collisionPosition.top,b.top)}},flip:{left:function(b,f){if("center"!==f.at[0]){var d=a(window),d=f.collisionPosition.left+f.collisionWidth-d.width()-d.scrollLeft(),e="left"===f.my[0]?-f.elemWidth:"right"===f.my[0]?f.elemWidth:0,c="left"===f.at[0]?f.targetWidth:-f.targetWidth,g=-2*f.offset[0];b.left+=0>f.collisionPosition.left?e+
c+g:0<d?e+c+g:0}},top:function(b,f){if("center"!==f.at[1]){var d=a(window),d=f.collisionPosition.top+f.collisionHeight-d.height()-d.scrollTop(),e="top"===f.my[1]?-f.elemHeight:"bottom"===f.my[1]?f.elemHeight:0,c="top"===f.at[1]?f.targetHeight:-f.targetHeight,g=-2*f.offset[1];b.top+=0>f.collisionPosition.top?e+c+g:0<d?e+c+g:0}}}};a.offset.setOffset||(a.offset.setOffset=function(b,f){/static/.test(a.curCSS(b,"position"))&&(b.style.position="relative");var d=a(b),e=d.offset(),c=parseInt(a.curCSS(b,"top",
!0),10)||0,g=parseInt(a.curCSS(b,"left",!0),10)||0,e={top:f.top-e.top+c,left:f.left-e.left+g};"using"in f?f.using.call(b,e):d.css(e)},a.fn.offset=function(b){var f=this[0];return!f||!f.ownerDocument?null:b?a.isFunction(b)?this.each(function(f){a(this).offset(b.call(this,f,a(this).offset()))}):this.each(function(){a.offset.setOffset(this,b)}):d.call(this)});a.curCSS||(a.curCSS=a.css);var g=document.getElementsByTagName("body")[0],j=document.createElement("div"),h,l;h=document.createElement(g?"div":
"body");l={visibility:"hidden",width:0,height:0,border:0,margin:0,background:"none"};g&&a.extend(l,{position:"absolute",left:"-1000px",top:"-1000px"});for(var k in l)h.style[k]=l[k];h.appendChild(j);l=g||document.documentElement;l.insertBefore(h,l.firstChild);j.style.cssText="position: absolute; left: 10.7432222px; top: 10.432325px; height: 30px; width: 201px;";j=a(j).offset(function(a,b){return b}).offset();h.innerHTML="";l.removeChild(h);g=j.top+j.left+(g?2E3:0);e.fractions=21<g&&22>g})(jQuery);(function(a,b){var c={buttons:!0,height:!0,maxHeight:!0,maxWidth:!0,minHeight:!0,minWidth:!0,width:!0},e={maxHeight:!0,maxWidth:!0,minHeight:!0,minWidth:!0};a.widget("ui.dialog",{options:{autoOpen:!0,buttons:{},closeOnEscape:!0,closeText:"close",dialogClass:"",draggable:!0,hide:null,height:"auto",maxHeight:!1,maxWidth:!1,minHeight:150,minWidth:150,modal:!1,position:{my:"center",at:"center",collision:"fit",using:function(b){var d=a(this).css(b).offset().top;0>d&&a(this).css("top",b.top-d)}},resizable:!0,
show:null,stack:!0,title:"",width:300,zIndex:1E3},_create:function(){this.originalTitle=this.element.attr("title");"string"!==typeof this.originalTitle&&(this.originalTitle="");this.options.title=this.options.title||this.originalTitle;var b=this,d=b.options,e=d.title||"&#160;",c=a.ui.dialog.getTitleId(b.element),h=(b.uiDialog=a("<div></div>")).appendTo(document.body).hide().addClass("ui-dialog ui-widget ui-widget-content ui-corner-all "+d.dialogClass).css({zIndex:d.zIndex}).attr("tabIndex",-1).css("outline",
0).keydown(function(e){if(d.closeOnEscape&&e.keyCode&&e.keyCode===a.ui.keyCode.ESCAPE){b.close(e);e.preventDefault()}}).attr({role:"dialog","aria-labelledby":c}).mousedown(function(a){b.moveToTop(false,a)});b.element.show().removeAttr("title").addClass("ui-dialog-content ui-widget-content").appendTo(h);var l=(b.uiDialogTitlebar=a("<div></div>")).addClass("ui-dialog-titlebar ui-widget-header ui-corner-all ui-helper-clearfix").prependTo(h),k=a('<a href="#"></a>').addClass("ui-dialog-titlebar-close ui-corner-all").attr("role",
"button").hover(function(){k.addClass("ui-state-hover")},function(){k.removeClass("ui-state-hover")}).focus(function(){k.addClass("ui-state-focus")}).blur(function(){k.removeClass("ui-state-focus")}).click(function(a){b.close(a);return false}).appendTo(l);(b.uiDialogTitlebarCloseText=a("<span></span>")).addClass("ui-icon ui-icon-closethick").text(d.closeText).appendTo(k);a("<span></span>").addClass("ui-dialog-title").attr("id",c).html(e).prependTo(l);a.isFunction(d.beforeclose)&&!a.isFunction(d.beforeClose)&&
(d.beforeClose=d.beforeclose);l.find("*").add(l).disableSelection();d.draggable&&a.fn.draggable&&b._makeDraggable();d.resizable&&a.fn.resizable&&b._makeResizable();b._createButtons(d.buttons);b._isOpen=!1;a.fn.bgiframe&&h.bgiframe()},_init:function(){this.options.autoOpen&&this.open()},destroy:function(){this.overlay&&this.overlay.destroy();this.uiDialog.hide();this.element.unbind(".dialog").removeData("dialog").removeClass("ui-dialog-content ui-widget-content").hide().appendTo("body");this.uiDialog.remove();
this.originalTitle&&this.element.attr("title",this.originalTitle);return this},widget:function(){return this.uiDialog},close:function(b){var d=this,e,c;if(!1!==d._trigger("beforeClose",b))return d.overlay&&d.overlay.destroy(),d.uiDialog.unbind("keypress.ui-dialog"),d._isOpen=!1,d.options.hide?d.uiDialog.hide(d.options.hide,function(){d._trigger("close",b)}):(d.uiDialog.hide(),d._trigger("close",b)),a.ui.dialog.overlay.resize(),d.options.modal&&(e=0,a(".ui-dialog").each(function(){if(this!==d.uiDialog[0]){c=
a(this).css("z-index");isNaN(c)||(e=Math.max(e,c))}}),a.ui.dialog.maxZ=e),d},isOpen:function(){return this._isOpen},moveToTop:function(b,d){var e=this.options;if(e.modal&&!b||!e.stack&&!e.modal)return this._trigger("focus",d);e.zIndex>a.ui.dialog.maxZ&&(a.ui.dialog.maxZ=e.zIndex);this.overlay&&(a.ui.dialog.maxZ+=1,this.overlay.$el.css("z-index",a.ui.dialog.overlay.maxZ=a.ui.dialog.maxZ));b={scrollTop:this.element.attr("scrollTop"),scrollLeft:this.element.attr("scrollLeft")};a.ui.dialog.maxZ+=1;this.uiDialog.css("z-index",
...
!1}});a(this.element.find(":tabbable").get().concat(d.find(".ui-dialog-buttonpane :tabbable").get().concat(d.get()))).eq(0).focus();this._isOpen=!0;this._trigger("open");return this}},_createButtons:function(b){var d=this,e=!1,c=a("<div></div>").addClass("ui-dialog-buttonpane ui-widget-content ui-helper-clearfix"),h=a("<div></div>").addClass("ui-dialog-buttonset").appendTo(c);d.uiDialog.find(".ui-dialog-buttonpane").remove();"object"===typeof b&&null!==b&&a.each(b,function(){return!(e=!0)});e&&(a.each(b,
function(b,f){f=a.isFunction(f)?{click:f,text:b}:f;b=a('<button type="button"></button>').attr(f,!0).unbind("click").click(function(){f.click.apply(d.element[0],arguments)}).appendTo(h);a.fn.button&&b.button()}),c.appendTo(d.uiDialog))},_makeDraggable:function(){function b(a){return{position:a.position,offset:a.offset}}var d=this,e=d.options,c=a(document),h;d.uiDialog.draggable({cancel:".ui-dialog-content, .ui-dialog-titlebar-close",handle:".ui-dialog-titlebar",containment:"document",start:function(c,
j){h="auto"===e.height?"auto":a(this).height();a(this).height(a(this).height()).addClass("ui-dialog-dragging");d._trigger("dragStart",c,b(j))},drag:function(a,e){d._trigger("drag",a,b(e))},stop:function(l,k){e.position=[k.position.left-c.scrollLeft(),k.position.top-c.scrollTop()];a(this).removeClass("ui-dialog-dragging").height(h);d._trigger("dragStop",l,b(k));a.ui.dialog.overlay.resize()}})},_makeResizable:function(f){function d(a){return{originalPosition:a.originalPosition,originalSize:a.originalSize,
position:a.position,size:a.size}}var f=f===b?this.options.resizable:f,e=this,c=e.options,h=e.uiDialog.css("position"),f="string"===typeof f?f:"n,e,s,w,se,sw,ne,nw";e.uiDialog.resizable({cancel:".ui-dialog-content",containment:"document",alsoResize:e.element,maxWidth:c.maxWidth,maxHeight:c.maxHeight,minWidth:c.minWidth,minHeight:e._minHeight(),handles:f,start:function(b,f){a(this).addClass("ui-dialog-resizing");e._trigger("resizeStart",b,d(f))},resize:function(a,b){e._trigger("resize",a,d(b))},stop:function(b,
f){a(this).removeClass("ui-dialog-resizing");c.height=a(this).height();c.width=a(this).width();e._trigger("resizeStop",b,d(f));a.ui.dialog.overlay.resize()}}).css("position",h).find(".ui-resizable-se").addClass("ui-icon ui-icon-grip-diagonal-se")},_minHeight:function(){var a=this.options;return"auto"===a.height?a.minHeight:Math.min(a.minHeight,a.height)},_position:function(b){var d=[],e=[0,0],c;if(b){if("string"===typeof b||"object"===typeof b&&"0"in b)d=b.split?b.split(" "):[b[0],b[1]],1===d.length&&
(d[1]=d[0]),a.each(["left","top"],function(a,b){+d[a]===d[a]&&(e[a]=d[a],d[a]=b)}),b={my:d.join(" "),at:d.join(" "),offset:e.join(" ")};b=a.extend({},a.ui.dialog.prototype.options.position,b)}else b=a.ui.dialog.prototype.options.position;(c=this.uiDialog.is(":visible"))||this.uiDialog.show();this.uiDialog.css({top:0,left:0}).position(a.extend({of:window},b));c||this.uiDialog.hide()},_setOptions:function(b){var d=this,g={},j=!1;a.each(b,function(a,b){d._setOption(a,b);a in c&&(j=!0);a in e&&(g[a]=
b)});j&&this._size();this.uiDialog.is(":data(resizable)")&&this.uiDialog.resizable("option",g)},_setOption:function(b,d){var e=this.uiDialog;switch(b){case "beforeclose":b="beforeClose";break;case "buttons":this._createButtons(d);break;case "closeText":this.uiDialogTitlebarCloseText.text(""+d);break;case "dialogClass":e.removeClass(this.options.dialogClass).addClass("ui-dialog ui-widget ui-widget-content ui-corner-all "+d);break;case "disabled":d?e.addClass("ui-dialog-disabled"):e.removeClass("ui-dialog-disabled");
break;case "draggable":var c=e.is(":data(draggable)");c&&!d&&e.draggable("destroy");!c&&d&&this._makeDraggable();break;case "position":this._position(d);break;case "resizable":(c=e.is(":data(resizable)"))&&!d&&e.resizable("destroy");c&&"string"===typeof d&&e.resizable("option","handles",d);!c&&!1!==d&&this._makeResizable(d);break;case "title":a(".ui-dialog-title",this.uiDialogTitlebar).html(""+(d||"&#160;"))}a.Widget.prototype._setOption.apply(this,arguments)},_size:function(){var b=this.options,
d,e,c=this.uiDialog.is(":visible");this.element.show().css({width:"auto",minHeight:0,height:0});b.minWidth>b.width&&(b.width=b.minWidth);d=this.uiDialog.css({height:"auto",width:b.width}).height();e=Math.max(0,b.minHeight-d);"auto"===b.height?a.support.minHeight?this.element.css({minHeight:e,height:"auto"}):(this.uiDialog.show(),b=this.element.css("height","auto").height(),c||this.uiDialog.hide(),this.element.height(Math.max(b,e))):this.element.height(Math.max(b.height-d,0));this.uiDialog.is(":data(resizable)")&&
...
height:this.height()});a.fn.bgiframe&&d.bgiframe();this.instances.push(d);return d},destroy:function(b){var d=a.inArray(b,this.instances);-1!=d&&this.oldInstances.push(this.instances.splice(d,1)[0]);0===this.instances.length&&a([document,window]).unbind(".dialog-overlay");b.remove();var e=0;a.each(this.instances,function(){e=Math.max(e,this.css("z-index"))});this.maxZ=e},height:function(){var b,d;return a.browser.msie&&7>a.browser.version?(b=Math.max(document.documentElement.scrollHeight,document.body.scrollHeight),
...
a(this);b.html(b.data("label.tabs")).removeData("label.tabs")})},_tabify:function(b){function c(b,d){b.css({display:""});!a.support.opacity&&d.opacity&&b[0].style.removeAttribute("filter")}this.list=this.element.find("ol,ul").eq(0);this.lis=a("li:has(a[href])",this.list);this.anchors=this.lis.map(function(){return a("a",this)[0]});this.panels=a([]);var d=this,g=this.options,j=/^#.+/;this.anchors.each(function(b,e){var c=a(e).attr("href"),f=c.split("#")[0],h;if(f&&(f===location.toString().split("#")[0]||
(h=a("base")[0])&&f===h.href))c=e.hash,e.href=c;j.test(c)?d.panels=d.panels.add(d._sanitizeSelector(c)):"#"!=c?(a.data(e,"href.tabs",c),a.data(e,"load.tabs",c.replace(/#.*$/,"")),c=d._tabId(e),e.href="#"+c,e=a("#"+c),e.length||(e=a(g.panelTemplate).attr("id",c).addClass("ui-tabs-panel ui-widget-content ui-corner-bottom").insertAfter(d.panels[b-1]||d.list),e.data("destroy.tabs",!0)),d.panels=d.panels.add(e)):g.disabled.push(b)});b?(this.element.addClass("ui-tabs ui-widget ui-widget-content ui-corner-all"),
...
function(){a(this).removeClass("ui-state-hover")});this.anchors.bind("focus.tabs",function(){l("focus",a(this).closest("li"))});this.anchors.bind("blur.tabs",function(){a(this).closest("li").removeClass("ui-state-focus")})}var k,p;g.fx&&(a.isArray(g.fx)?(k=g.fx[0],p=g.fx[1]):k=p=g.fx);var q=p?function(b,e){a(b).closest("li").addClass("ui-tabs-selected ui-state-active");e.hide().removeClass("ui-tabs-hide").animate(p,p.duration||"normal",function(){c(e,p);d._trigger("show",null,d._ui(b,e[0]))})}:function(b,
e){a(b).closest("li").addClass("ui-tabs-selected ui-state-active");e.removeClass("ui-tabs-hide");d._trigger("show",null,d._ui(b,e[0]))},r=k?function(a,b){b.animate(k,k.duration||"normal",function(){d.lis.removeClass("ui-tabs-selected ui-state-active");b.addClass("ui-tabs-hide");c(b,k);d.element.dequeue("tabs")})}:function(a,b){d.lis.removeClass("ui-tabs-selected ui-state-active");b.addClass("ui-tabs-hide");d.element.dequeue("tabs")};this.anchors.bind(g.event+".tabs",function(){var b=this,e=a(this).closest("li"),
c=d.panels.filter(":not(.ui-tabs-hide)"),f=a(d._sanitizeSelector(this.hash));if(e.hasClass("ui-tabs-selected")&&!g.collapsible||e.hasClass("ui-state-disabled")||e.hasClass("ui-state-processing")||d._trigger("select",null,d._ui(this,f[0]))===false){this.blur();return false}g.selected=d.anchors.index(this);d.abort();if(g.collapsible){if(e.hasClass("ui-tabs-selected")){g.selected=-1;g.cookie&&d._cookie(g.selected,g.cookie);d.element.queue("tabs",function(){r(b,c)}).dequeue("tabs");this.blur();return false}if(!c.length){g.cookie&&
d._cookie(g.selected,g.cookie);d.element.queue("tabs",function(){q(b,f)});d.load(d.anchors.index(this));this.blur();return false}}g.cookie&&d._cookie(g.selected,g.cookie);if(f.length){c.length&&d.element.queue("tabs",function(){r(b,c)});d.element.queue("tabs",function(){q(b,f)});d.load(d.anchors.index(this))}else throw"jQuery UI Tabs: Mismatching fragment identifier.";a.browser.msie&&this.blur()});this.anchors.bind("click.tabs",function(){return false})},destroy:function(){var b=this.options;this.abort();
this.element.unbind(".tabs").removeClass("ui-tabs ui-widget ui-widget-content ui-corner-all ui-tabs-collapsible").removeData("tabs");this.list.removeClass("ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all");this.anchors.each(function(){var b=a.data(this,"href.tabs");b&&(this.href=b);var d=a(this).unbind(".tabs");a.each(["href","load","cache"],function(a,b){d.removeData(b+".tabs")})});this.lis.unbind(".tabs").add(this.panels).each(function(){a.data(this,"destroy.tabs")?
...
b)return!1;b?(this.helper=b,a("#s-save-panel div.s-dropdown").show()):(this.helper="",a("#s-save-panel div.s-dropdown").hide())},dispatch:function(b){void 0==b&&(b=window.location.hash);if(b=b.replace(/^[^#]*#\/*/,""))if(b=b.split("/"),b[0]){for(var c="",e=b.length,f=0;f<b.length;f++){var d=b[f];if(2>f)if(0===f)c=d;else if("files"==c){e=f;break}else if(parseInt(d,10)!=d&&-1==d.indexOf("="))c+=d.substr(0,1).toUpperCase()+d.substr(1);else{e=f;break}else{e=f;break}}e=b.slice(e);this[c+"Action"]?(this[c+
"Action"].apply(this,e),a.storage.set("site/"+this.domain+"/hash",b.join("/"))):console&&console.log("Invalid action name:",c+"Action")}else this.defaultAction();else this.defaultAction()},defaultAction:function(){var b=a("div.s-sidebar ul.s-links a:first").attr("href");a.wa.setHash(b)},pagesAction:function(b){a("#wa-page-container").length?waLoadPage(b):(a("#s-save-panel input").replaceWith('<input id="wa-page-button" type="button" class="button green" value="'+$_("Save")+'">'),a("#s-content").load("?module=pages",
"domain_id="+this.domain+(b?"&id="+b:""),function(){a(".s-scrollable-part").scrollTop(0);a.wa.site.savePanel(!0,"s-page-editor");a.wa.site.active(a("#s-link-pages"));a("#wa-page-button").click(function(){a("#wa-page-form").submit()})}))},designAction:function(b){a("#wa-design-container").length?(waDesignLoad(void 0===b?"":b),a.wa.site.savePanel(!b||-1==b.indexOf("action=")),a("#wa-design-button").removeClass("yellow").addClass("green")):(this.parseParams(b),a("#s-save-panel input").replaceWith('<input id="wa-design-button" type="button" class="button green" value="'+
$_("Save")+'">'),a("#s-content").load("?module=design","domain_id="+this.domain,function(){a(".s-scrollable-part").scrollTop(0);a.wa.site.savePanel(!b||-1==b.indexOf("action="));a.wa.site.active(a("#s-link-design"));a("#wa-design-button").click(function(){a("#wa-design-form").submit()});waDesignLoad(void 0===b?"":b)}))},themesAction:function(){this.savePanel(!1);a("#wa-design-container").length?waDesignLoad():a("#s-content").load("?module=design","domain_id="+this.domain,function(){a(".s-scrollable-part").scrollTop(0);
a.wa.site.active(a("#s-link-design"));waDesignLoad()})},designAddAction:function(a){this.designAction(a+"&file=")},filesAction:function(b,c){this.savePanel(!1);if(!0===b)var e=c||this.filesPath();else e=Array.prototype.join.call(arguments,"/"),b=!1;var f=function(){a.wa.site.active(a("#s-link-files"));a("#s-files-tree li.selected").removeClass("selected");if(e){a("a.s-baseurl").removeClass("selected");a("#s-folder-actions-li").show();var b=a("#s-files-tree a[href='#/files/"+e+"']");b.parent().addClass("selected");
for(b=b.parent();b.length;){var c=b.find("> i.overhanging");c.hasClass("rarr")&&c.click();b=b.parent("ul").parent("li")}}else a("#s-folder-actions-li").hide(),a("a.s-baseurl").addClass("selected");a.wa.site.filesList(e);a("#s-upload-path").val(e||"");a("#s-current-path").html("/"+(e||""));a("#s-files-count").html("0");a("#s-files-grid input.all").removeAttr("checked")};a("#s-files-tree").length&&!b?f():a("#s-content").load("?module=files","domain_id="+this.domain,function(){a(".s-scrollable-part").scrollTop(0);
a("#s-files-tree i.overhanging").click(function(){var b=a(this);b.hasClass("rarr")?b.removeClass("rarr").addClass("darr").parent().children("ul").show():b.removeClass("darr").addClass("rarr").parent().children("ul").hide()});!0===b&&c?a.wa.setHash("#/files/"+c):f()})},filesList:function(b){b||(b=this.filesPath());a.post("?module=files&action=list",{path:b},function(b){a("#s-files-grid tr.s-file").remove();for(var e=0;e<b.data.length;e++){var f='<tr class="s-file"><td class="min-width"><input type="checkbox" value="'+
b.data[e].file+'" /></td><td><ul class="menu-h dropdown clickable"><li><a href="#"><i class="icon16 '+b.data[e].type+'"></i> '+b.data[e].file+' <i class="icon10 darr no-overhanging s-file-actions"></i></a></li></ul></td><td>'+b.data[e].datetime+'</td><td><span class="float-right">'+a.wa.site.getFileSize(b.data[e].size)+"</span></td></tr>";a("#s-files-grid").append(f)}},"json")},getFileSize:function(a){return 1024>a?a+" B":1048576>a?Math.round(a/1024)+" KB":1073741824>a?Math.round(a/1048576)+" MB":
Math.round(a/1073741824)+" GB"},checkFileType:function(a){return"image"==a||"text"==a||"script-css"==a||"script-js"==a},getFileMenu:function(b){var c=a("#s-domain").attr("href")+"wa-data/public/site/"+a.wa.site.filesPath()+b,e=a('<ul class="menu-v width-icons" style="display:block"></ul>');".php"!=b.substr(-4)&&(".phtml"!=b.substr(-6)&&"."!=b.substr(0,1))&&e.append('<li><i class="icon16 globe"></i>'+$_("File URL")+': <a href="'+c+'" target="_blank" class="bold">'+c+'<i class="icon10 new-window"></i></a></li>');
".php"!=b.substr(-4)&&".phtml"!=b.substr(-6)&&e.append('<li><a href="?module=files&action=download&path='+a.wa.site.filesPath()+"&file="+b+'"><i class="icon16 download"></i>'+$_("Download")+"</a></li>");e.append(a("<li></li>").append('<a href="#"><i class="icon16 edit"></i>'+$_("Rename")+"</a>").click(function(){a("#s-rename-dialog").waDialog({disableButtonsOnSubmit:!0,onLoad:function(){a("#s-name").val(b).focus().select();a(this).find("span").html(a.wa.site.filesPath(!0))},onSubmit:function(){var c=
...
$_("Save")+'">');a("#s-content").load("?module=blocks",b,function(){a(".s-scrollable-part").scrollTop(0);waEditorCodeMirrorInit({id:"content",save_button:"s-editor-save-button"});a("#s-editor-save-button").click(function(){a("#site-form").submit()});a.wa.site.savePanel(!0);a.wa.site.setHelper("app=");a.wa.site.active(a("#s-link-blocks"))})},blocksAddAction:function(){this.blocksAction("id=")},active:function(b){a(".sidebar a.selected").removeClass("selected");a("ul.s-links li.selected").removeClass("selected");
b&&b.length&&b.addClass("selected")},routingAction:function(b){this.savePanel(!1);a("#s-content").load("?module=routing","domain_id="+this.domain,function(){a.wa.site.active(a("#s-link-routing"));a("tr#route-"+b+" .s-route-settings").click()})},parseParams:function(a){if(!a)return{};var a=a.split("&"),c={};for(i=0;i<a.length;i++){var e=a[i].split("=");c[e[0]]=1<e.length?e[1]:""}return c},initEditor:function(b,c){if(!a("#"+b).length)return!1;var e=a("#"+b).attr("data-type");this.savePanel(!0);var f=
a("div.s-editor.s-white").height()-a("div.s-editor.s-white .s-grey-toolbar").height()-50;300>f&&(f=300);wa_editor=CodeMirror.fromTextArea(document.getElementById(b),{mode:e?"text/"+e:"text/html",tabMode:"indent",height:"dynamic",lineWrapping:!0,onKeyEvent:function(a,b){var c=jQuery.Event(b);"keydown"==c.type?waEditorKeyCallback(!1,{save_button:"s-editor-save-button"})(b):(c.type="keypress")&&waEditorKeyCallback(!0,{save_button:"s-editor-save-button"})(b)}});a(".CodeMirror-scroll").css("min-height",
f+"px");this.setHelper(c||!1)},savePanel:function(b,c){b?(a("#s-save-panel").show(),a("#wa div.s-scrollable-part").removeClass("s-no-editor"),a("#s-save-panel input").removeClass("yellow").addClass("green"),a("#wa-editor-status").empty(),c?a("#s-save-panel .s-bottom-fixed-bar-content-offset").addClass(c):a("#s-save-panel .s-bottom-fixed-bar-content-offset").attr("class","s-bottom-fixed-bar-content-offset")):(a("#s-save-panel").hide(),a("#wa div.s-scrollable-part").addClass("s-no-editor"))},getTreeHTML:function(a,
c,e){for(var e=e||"",c="<ul"+(c?"":' style="display:none"')+' class="menu-v with-icons'+(c?" "+c:"")+'">',f="",d=0;d<a.length;d++)f="string"==typeof a[d]?a[d]:a[d].id,c+="<li>","string"!=typeof a[d]&&(c+='<i class="icon16 rarr overhanging"></i>'),c+='<a href="#/files/'+e+f+'/"><i class="icon16 folder"></i><b>'+f+"</b></a>","string"!=typeof a[d]&&(c+=this.getTreeHTML(a[d].childs,!1,e+f+"/")),c+="</li>";return c+"</ul>"},filesPath:function(b){b=b?"wa-data/public/site/":"";return a("#s-files-tree li.selected").length?
b+a("#s-files-tree li.selected a").attr("href").substr(8):b},filesPathOptions:function(b,c,e){var c=c||"",f="";""==c&&(f='<option value="">wa-data/public/site</a>',c="&nbsp;&nbsp;&nbsp;");e=e||!1;b.children("li").each(function(){var b=e&&a(this).find("> ul > li.selected").length||!e&&a(this).hasClass("selected")?true:false,g=a(this).children("a");f=f+("<option "+(b?'selected="selected"':"")+' value="'+g.attr("href").substr(8)+'">'+c+g.children("b").html()+"</option>");if(a(this).children("ul").length&&
(!e||!a(this).hasClass("selected")))f=f+a.wa.site.filesPathOptions(a(this).children("ul"),c+"&nbsp;&nbsp;&nbsp;",e)});return f}}})(jQuery);
$(function(){$(".s-add-new-site").live("click",function(){$("#addsite-dialog").waDialog({onSubmit:function(){var a=$(this);$.post(a.attr("action"),a.serialize(),function(a){"ok"==a.status&&(location.href="?domain_id="+a.data.id+"#/settings/")},"json");return!1}});return!1});$("#s-helper-link").click(function(){if($("#s-helper").is(":visible"))return $("#s-helper").hide(),!1;$("#s-helper").load("?module=helper",$.wa.site.helper,function(){$(this).show();var a=function(b){if("s-helper"==$(b.target).attr("id")||
$(b.target).parents("#s-helper").length)$(document).one("click",a);else $("#s-helper").hide()};$(document).one("click",a)});return!1});$("#s-helper div.fields a.inline-link").live("click",function(){var a=$(this).find("i");a.children("b").length&&(a=a.children("b"));if($(".el-rte").length&&$(".el-rte").is(":visible"))try{$("#content").elrte()[0].elrte.selection.insertHtml(a.text())}catch(b){}else wa_editor.replaceSelection(a.text());return!1});$("#wa-app > div.s-sidebar a, #wa-header a").live("click",
function(){if($("#s-save-panel").is(":visible")&&$("#s-save-panel input:button").hasClass("yellow"))return confirm($_("Unsaved changes will be lost if you leave this page now. Are you sure?"))})});
