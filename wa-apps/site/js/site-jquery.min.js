...
0).keydown(function(e){if(d.closeOnEscape&&e.keyCode&&e.keyCode===a.ui.keyCode.ESCAPE){b.close(e);e.preventDefault()}}).attr({role:"dialog","aria-labelledby":c}).mousedown(function(a){b.moveToTop(false,a)});b.element.show().removeAttr("title").addClass("ui-dialog-content ui-widget-content").appendTo(h);var k=(b.uiDialogTitlebar=a("<div></div>")).addClass("ui-dialog-titlebar ui-widget-header ui-corner-all ui-helper-clearfix").prependTo(h),l=a('<a href="#"></a>').addClass("ui-dialog-titlebar-close ui-corner-all").attr("role",
"button").hover(function(){l.addClass("ui-state-hover")},function(){l.removeClass("ui-state-hover")}).focus(function(){l.addClass("ui-state-focus")}).blur(function(){l.removeClass("ui-state-focus")}).click(function(a){b.close(a);return false}).appendTo(k);(b.uiDialogTitlebarCloseText=a("<span></span>")).addClass("ui-icon ui-icon-closethick").text(d.closeText).appendTo(l);a("<span></span>").addClass("ui-dialog-title").attr("id",c).html(e).prependTo(k);a.isFunction(d.beforeclose)&&!a.isFunction(d.beforeClose)&&
...
j){h="auto"===e.height?"auto":a(this).height();a(this).height(a(this).height()).addClass("ui-dialog-dragging");d._trigger("dragStart",c,b(j))},drag:function(a,e){d._trigger("drag",a,b(e))},stop:function(k,l){e.position=[l.position.left-c.scrollLeft(),l.position.top-c.scrollTop()];a(this).removeClass("ui-dialog-dragging").height(h);d._trigger("dragStop",k,b(l));a.ui.dialog.overlay.resize()}})},_makeResizable:function(f){function d(a){return{originalPosition:a.originalPosition,originalSize:a.originalSize,
...
e){a(b).closest("li").addClass("ui-tabs-selected ui-state-active");e.removeClass("ui-tabs-hide");d._trigger("show",null,d._ui(b,e[0]))},r=l?function(a,b){b.animate(l,l.duration||"normal",function(){d.lis.removeClass("ui-tabs-selected ui-state-active");b.addClass("ui-tabs-hide");c(b,l);d.element.dequeue("tabs")})}:function(a,b){d.lis.removeClass("ui-tabs-selected ui-state-active");b.addClass("ui-tabs-hide");d.element.dequeue("tabs")};this.anchors.bind(g.event+".tabs",function(){var b=this,e=a(this).closest("li"),
...
"&file=")},filesPage:function(a){a||(a=location.hash);a=a.split("/");if((a=a[a.length-1])&&"?"==a.substr(0,1))if(a=a.substr(1).split("="),"page"==a[0])return a[1];return 1},filesAction:function(b,c){this.savePanel(!1);var e=1;c&&"?"==c.substr(0,1)&&(c=c.substr(1).split("="),"page"==c[0]&&(e=c[1]),c="");if(!0===b)var f=c||this.filesPath();else f=Array.prototype.join.call(arguments,"/"),b=!1;var d=function(){a.wa.site.active(a("#s-link-files"));a("#s-files-tree li.selected").removeClass("selected");
if(f){a("a.s-baseurl").removeClass("selected");a("#s-folder-actions-li").show();var b=a("#s-files-tree a[href='#/files/"+f+"']");b.parent().addClass("selected");for(b=b.parent();b.length;){var c=b.find("> i.overhanging");c.hasClass("rarr")&&c.click();b=b.parent("ul").parent("li")}}else{a("#s-folder-actions-li").hide();a("a.s-baseurl").addClass("selected")}a.wa.site.filesList(f,e);a("#s-upload-path").val(f||"");a("#s-current-path").html("/"+(f||""));a("#s-files-count").html("0");a("#s-files-grid input.all").removeAttr("checked")};
a("#s-files-tree").length&&!b?d():a("#s-content").load("?module=files","domain_id="+this.domain,function(){a(".s-scrollable-part").scrollTop(0);a("#s-files-tree i.overhanging").click(function(){var b=a(this);b.hasClass("rarr")?b.removeClass("rarr").addClass("darr").parent().children("ul").show():b.removeClass("darr").addClass("rarr").parent().children("ul").hide()});b===true&&c?a.wa.setHash("#/files/"+c):d()})},filesList:function(b,c){b||(b=this.filesPath());c||(c=this.filesPage());a.post("?module=files&action=list&page="+
c,{path:b},function(e){a("#s-files-grid tr.s-file").remove();a("div.s-pagination").empty();for(var f=0;f<e.data.files.length;f++){var d=e.data.files[f],d='<tr class="s-file"><td class="min-width"><input type="checkbox" value="'+d.file+'" /></td><td><ul class="menu-h dropdown clickable"><li><a href="#"><i class="icon16 '+d.type+'"></i> '+d.file+' <i class="icon10 darr no-overhanging s-file-actions"></i></a></li></ul></td><td>'+d.datetime+'</td><td><span class="float-right">'+a.wa.site.getFileSize(d.size)+
"</span></td></tr>";a("#s-files-grid").append(d)}if(1<e.data.pages){d='<ul class="menu-h">';for(f=1;f<=e.data.pages;f++)d+="<li"+(f==c?' class="selected"':"")+'><a href="#/files/'+b+"?page="+f+'">'+f+"</a></li>";a("div.s-pagination").html(d+"</ul>").show()}},"json")},getFileSize:function(a){return 1024>a?a+" B":1048576>a?Math.round(a/1024)+" KB":1073741824>a?Math.round(a/1048576)+" MB":Math.round(a/1073741824)+" GB"},checkFileType:function(a){return"image"==a||"text"==a||"script-css"==a||"script-js"==
a},getFileMenu:function(b){var c=a("#s-domain").attr("href")+"wa-data/public/site/"+a.wa.site.filesPath()+b,e=a('<ul class="menu-v width-icons" style="display:block"></ul>');".php"!=b.substr(-4)&&(".phtml"!=b.substr(-6)&&"."!=b.substr(0,1))&&e.append('<li><i class="icon16 globe"></i>'+$_("File URL")+': <a href="'+c+'" target="_blank" class="bold">'+c+'<i class="icon10 new-window"></i></a></li>');".php"!=b.substr(-4)&&".phtml"!=b.substr(-6)&&e.append('<li><a href="?module=files&action=download&path='+
a.wa.site.filesPath()+"&file="+b+'"><i class="icon16 download"></i>'+$_("Download")+"</a></li>");e.append(a("<li></li>").append('<a href="#"><i class="icon16 edit"></i>'+$_("Rename")+"</a>").click(function(){a("#s-rename-dialog").waDialog({disableButtonsOnSubmit:!0,onLoad:function(){a("#s-name").val(b).focus().select();a(this).find("span").html(a.wa.site.filesPath(!0))},onSubmit:function(){var c=a("#s-name").val();a.post("?module=files&action=rename",{path:a.wa.site.filesPath(),name:c,file:b},function(b){"ok"==
...
parseParams:function(a){if(!a)return{};var a=a.split("&"),c={};for(i=0;i<a.length;i++){var e=a[i].split("=");c[e[0]]=1<e.length?e[1]:""}return c},savePanel:function(b,c){b?(a("#s-save-panel").show(),a("#wa div.s-scrollable-part").removeClass("s-no-editor"),a("#s-save-panel input").removeClass("yellow").addClass("green"),a("#wa-editor-status").empty(),c?a("#s-save-panel .s-bottom-fixed-bar-content-offset").addClass(c):a("#s-save-panel .s-bottom-fixed-bar-content-offset").attr("class","s-bottom-fixed-bar-content-offset")):
(a("#s-save-panel").hide(),a("#wa div.s-scrollable-part").addClass("s-no-editor"))},getTreeHTML:function(a,c,e){for(var e=e||"",c="<ul"+(c?"":' style="display:none"')+' class="menu-v with-icons'+(c?" "+c:"")+'">',f="",d=0;d<a.length;d++)f="string"==typeof a[d]?a[d]:a[d].id,c+="<li>","string"!=typeof a[d]&&(c+='<i class="icon16 rarr overhanging"></i>'),c+='<a href="#/files/'+e+f+'/"><i class="icon16 folder"></i><b>'+f+"</b></a>","string"!=typeof a[d]&&(c+=this.getTreeHTML(a[d].childs,!1,e+f+"/")),
c+="</li>";return c+"</ul>"},filesPath:function(b){b=b?"wa-data/public/site/":"";return a("#s-files-tree li.selected").length?b+a("#s-files-tree li.selected a").attr("href").substr(8):b},filesPathOptions:function(b,c,e){var c=c||"",f="";""==c&&(f='<option value="">wa-data/public/site</a>',c="&nbsp;&nbsp;&nbsp;");e=e||!1;b.children("li").each(function(){var b=e&&a(this).find("> ul > li.selected").length||!e&&a(this).hasClass("selected")?true:false,g=a(this).children("a");f=f+("<option "+(b?'selected="selected"':
"")+' value="'+g.attr("href").substr(8)+'">'+c+g.children("b").html()+"</option>");if(a(this).children("ul").length&&(!e||!a(this).hasClass("selected")))f=f+a.wa.site.filesPathOptions(a(this).children("ul"),c+"&nbsp;&nbsp;&nbsp;",e)});return f}}})(jQuery);
