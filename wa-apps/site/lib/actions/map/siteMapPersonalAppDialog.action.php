...
class siteMapPersonalAppDialogAction extends sitePersonalAction
{
    public function execute()
    {
        ...
        $this->view->assign([
            'items' => $this->getItems($app_id),
            'app' => $app,
            'domain_url' => 'http://'.$domain,
            'settled'    => $routes ? true: false,
            'enabled'    => !isset($domain_config['personal'][$app_id]) || $domain_config['personal'][$app_id],
        ]);
