...
class siteCustomGallery3BlockType extends siteBlockType {
    ...
    public function __construct(array $options = []) {
        ...
        $options['type'] = 'site.CustomGallery3';
    ...
    public function getHeaderColumn(): siteBlockData {
        ...
        $vseq->addChild($this->createParagraph(
            'Res et accessoria ad vitam activam destinata — simplicitas, functionalitas et energia naturalis.',
            [
                'align'         => 't-c',
                'font-header'   => 't-rgl',
        ...
        return $this->createColumn([
            'column' => 'st-12 st-9-lp st-9-tb st-12-mb',
            'block_props' => [
    ...
    public function getFooterColumn(): siteBlockData {
        $vseq = $this->createSequence();
        $vseq->addChild($this->createParagraph(
            'Consilium modernum, materiae durabiles et attentio ad singula adiuvant te cotidie in motu manere.',
            [
                'align'         => 't-c',
                'font-header'   => 't-rgl',
                'font-size'     => ['name' => 'Size #6', 'value' => 't-6', 'unit' => 'px', 'type' => 'library'],
        ...
        $vseq->addChild($this->getBtn('Collectionem Inspicere', [
            'border-radius' => 'b-r-r',
        ...
        return $this->createColumn([
                'column' => 'st-12 st-6-lp st-9-tb st-12-mb',
                'block_props' => [
                    $this->column_elements['main'] => [
                        'flex-align-vertical' => 'a-c-c',
                        'padding-top'    => 'p-t-16',
    ...
    private function createGalleryColumn (siteBlockData $content): siteBlockData {
        $block_props = [
            $this->column_elements['main']    => [
                'padding-top'    => 'p-t-12',
                'padding-right'  => 'p-r-clm',
        ...
        return $this->createColumn([
            'column' => 'st-4 st-4-lp st-4-tb st-12-mb',
    ...
    private function getGalleryData() {
        ...
        return [
            $image_url . 'fitness-1.jpg',
            $image_url . 'fitness-2.jpg',
            $image_url . 'fitness-3.jpg',
            $image_url . 'fitness-4.jpg',
            $image_url . 'fitness-5.jpg',
            $image_url . 'fitness-6.jpg',
        ];
    }
