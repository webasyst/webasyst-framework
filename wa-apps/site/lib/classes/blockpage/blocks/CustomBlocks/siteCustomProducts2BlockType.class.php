...
class siteCustomProducts2BlockType extends siteBlockType {
    ...
    public function __construct(array $options = []) {
        ...
        $options['type'] = 'site.CustomProducts2';
    ...
    private function getExampleCards(): array {
        ...
        return [
            [
                'image_url'   => $base_url . 'product-08.jpg',
                'title'       => 'Etiam pulvinar purus',
                'description' => 'Lobortis ante, sed hendrerit mauris scelerisque quis finibus arcu.',
                'btn_text'    => 'Sollicitudin lacus',
            ],
            [
                'image_url'   => $base_url . 'product-05.jpg',
                'title'       => 'Mauris consequat tellus',
