...
class siteCustomDivider6BlockType extends siteBlockType {
    ...
    public function __construct(array $options = []) {
        ...
        $options['type'] = 'site.CustomDivider6';
    ...
    public function getColumn(): siteBlockData {
        ...
        $image->data = [
            'image' => [
                ...
                'type'     => 'svg',
                'fill' => 'removed',
                'svg_html' => '<svg xmlns="http://www.w3.org/2000/svg" style="margin-top: -1px" width="5120" height="auto" viewBox="0 0 5120 609" fill="var(--bw-2)"><path d="M0 0H5120V4L0 609V0Z"></path></svg>',
            ],
            'block_props' => [
                'margin-top' => 'm-t-0',
                'margin-bottom' => 'm-b-0',
