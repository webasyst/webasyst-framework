...
class siteCustomMailerSubscribe2BlockType extends siteBlockType
{
    ...
    public function __construct(array $options = []) {
        $options['type'] = 'site.CustomMailerSubscribe2';
    ...
    private function getContent() {
        ...
        return $this->createFormColumn('st-7 st-6-lp st-9-tb st-12-mb', $vseq);
    }
    ...
    private function getForm()
    {
        ...
        return $this->createFormColumn('st-5 st-6-lp st-9-tb st-12-mb', $vseq);
    }

    public function createFormColumn(string $column, siteBlockData $vseq)
    {
