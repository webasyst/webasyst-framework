...
class siteCustomContactsReverseBlockType extends siteBlockType
{
    ...
    public function __construct(array $options = []) {
        ...
        $options['type'] = 'site.CustomContactsReverse';
    ...
    private function getInfoColumn(): siteBlockData {
        ...
        $vseq->addChild($this->createHeadingBlock(
            '<font color="" class="tx-bw-3">Roma, Via Augusta, dom. 10, ins. 5.</font>',
            'h1',
            [
        ...
        $vseq->addChild($this->createHeadingBlock(
            '<font color="" class="tx-bw-3">Marcus Cornelius Felix</font>',
            'h1',
            [
                'font-size'     => ['name' => 'Size #6', 'value' => 't-6', 'unit' => 'px', 'type' => 'library'],
                'margin-bottom' => 'm-b-14',
        ...
        $vseq->addChild($this->getIconLinks());

        return $this->createColumn('st-4 st-5-lp st-6-tb st-12-mb', [
