 ...
 */
class siteMenuContactsT4BlockType extends siteBlockType
{
    public $elements = [   
    ...
    public function getExampleBlockData()
    {
        ...
        $menu_item->data["block_props"]["visibility"] = "d-n-mb d-n-tb d-n-lp";
        $menu_item->data["block_props"]['button-style'] = ["name" => "Palette", "value" => "btn-wht-lnk", "type" => "palette"];
