 ...
 */
class siteMenuT3BlockType extends siteBlockType
{
    public $elements = [   
    ...
    public function getExampleBlockData()
    {
        ...
        $columns_arr = array();
        $logo_column = (new siteMenuLogoT3BlockType())->getExampleBlockData();
        $logo_column->data['column'] = 'st-8-mb st-6-tb st-4 st-4-lp';
        $contacts_column = (new siteMenuContactsT3BlockType())->getExampleBlockData();
        ...
        $hseq->addChild($burger_column, 'col3');

        $result = $this->getEmptyBlockData();
        $result->addChild($hseq, '');

        $column_props = array();
        $column_props[$this->elements['main']] = ['padding-top' => "p-t-0", 'padding-bottom' => "p-b-0", 'background' => ["name" => "grey shades","value" => "bg-bw-2", "type" => "palette","uuid" => 1, "layers" => [["name" => "grey shades", "value" => "bg-bw-2", "type" => "palette", "uuid" => 1]]]];
