...
class siteMenuContactsT1BlockType extends siteBlockType
{
    ...
    public function getExampleBlockData()
    {
        ...
        $menu_item1->data = ['html' => 'Malesuada', 'tag' => 'a', 'block_props' => ['visibility' => 'd-n-tb d-n-mb', 'width' => 'cnt-w', 'border-radius' => "b-r-r", 'button-style' => ["name" => "Palette", "value" => "btn-blc-lnk", "type" => "palette"], 'button-size' => 'inp-s p-l-10 p-r-10']];
        $menu_item2->data = ['html' => 'Quisque mauris', 'tag' => 'a', 'block_props' => ['visibility' => 'd-n-tb d-n-mb','width' => 'cnt-w', 'border-radius' => "b-r-r", 'button-style' => ["name" => "Palette", "value" => "btn-blc-lnk", "type" => "palette"], 'button-size' => 'inp-s p-l-10 p-r-10']];
        $menu_item3->data = ['html' => 'Ullamcorper', 'tag' => 'a', 'block_props' => ['visibility' => 'd-n-tb d-n-mb','width' => 'cnt-w', 'border-radius' => "b-r-r", 'button-style' => ["name" => "Palette", "value" => "btn-blc-lnk", "type" => "palette"], 'button-size' => 'inp-s p-l-10 p-r-10']];
        $menu_item4->data = ['html' => 'Turpis netus', 'tag' => 'a', 'block_props' => ['visibility' => 'd-n-tb d-n-mb','width' => 'cnt-w', 'border-radius' => "b-r-r", 'button-style' => ["name" => "Palette", "value" => "btn-blc-lnk", "type" => "palette"], 'button-size' => 'inp-s p-l-10 p-r-10']];
