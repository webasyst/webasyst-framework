 ...
 */
class siteMenuLogoT2BlockType extends siteBlockType
{
    public $elements = [
    ...
    public function getExampleBlockData()
    {
        ...
        $header->data = ["html" => "Turpis egestas","tag" => "h1","block_props" => ['button-style' => ["name" => "Palette", "value" => "btn-blc-lnk", "type" => "palette"], "font-header" => "t-hdn","margin-top" => "m-t-4","margin-bottom" => "m-b-0","align" => "t-l", 'button-size' => 'inp-s p-l-12 p-r-12' ]];
        $paragraph->data = ["html" => "Lobortis ante fames", "block_props" => ['button-style' => ["name" => "Palette", "value" => "btn-blc-lnk", "type" => "palette"], "font-header" => "t-rgl","margin-top" => "m-t-0","margin-bottom" => "m-b-0","align" => "t-l", 'button-size' => 'inp-xs p-l-11 p-r-11' ]];
