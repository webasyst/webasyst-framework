 ...
 */
class siteFooterBottom2BlockType extends siteBlockType
{
    public $elements = [
    ...
    public function __construct(array $options=[])
    {
        ...
        $options['type'] = 'site.FooterBottom2.'.$options['columns'];
    ...
    public function getExampleBlockData()
    {
        ...
        $menu_item->data = ['html' => 'Tempor', 'tag' => 'a', 'block_props' => ["margin-top" => "m-t-8", "margin-bottom" => "m-b-8", 'width' => 'cnt-w', 'button-style' => ["name" => "Palette", "value" => "btn-wht-lnk", "type" => "palette"], 'button-size' => 'inp-s p-l-12 p-r-12']];
        $menu_item1 = (new siteMenuItemBlockType())->getExampleBlockData();
        $menu_item1->data = ['html' => 'Consequat', 'tag' => 'a', 'block_props' => ["margin-top" => "m-t-8", "margin-bottom" => "m-b-8", 'width' => 'cnt-w', 'button-style' => ["name" => "Palette", "value" => "btn-wht-lnk", "type" => "palette"], 'button-size' => 'inp-s p-l-12 p-r-12']];
        ...
        $column_props = array();
        $column_props[$this->elements['main']] = ['padding-top' => "p-t-10", 'padding-bottom' => "p-b-10", 'padding-left' => "p-l-blc", 'padding-right' => "p-r-blc", 'background' => ["name" => "grey shades","value" => "bg-bw-2", "type" => "palette","uuid" => 1, "layers" => [["name" => "grey shades", "value" => "bg-bw-2", "type" => "palette", "uuid" => 1]]]];
