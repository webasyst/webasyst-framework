 ...
 */
class siteFooterBottom3BlockType extends siteBlockType
{
    public $elements = [
    ...
    public function __construct(array $options=[])
    {
        ...
        $options['type'] = 'site.FooterBottom3.'.$options['columns'];
    ...
    public function getExampleBlockData()
    {
        ...
        $column_left->data['column'] = "st-12-mb st-7-lp st-8 st-7-tb";
        ...
        $column_right->data['column'] = "st-12-mb st-5-lp st-4 st-5-tb";
