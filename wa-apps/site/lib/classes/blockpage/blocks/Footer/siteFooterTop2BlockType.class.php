...
class siteFooterTop2BlockType extends siteBlockType
{
    ...
    public function getExampleBlockData()
    {
        ...
        $menu_item_bold->data = ['html' => 'Morbi convallis', 'tag' => 'a', 'block_props' => ["font-header" => "t-hdn", 'width' => 'cnt-w', 'border-radius' => "b-r-r", 'button-style' => ["name" => "Palette", "value" => "btn-blc-lnk", "type" => "palette"], 'button-size' => 'inp-m p-l-10 p-r-10']];
        $menu_item = (new siteMenuItemBlockType())->getExampleBlockData();
        $menu_item->data = ['html' => 'Tempor sapien', 'tag' => 'a', 'block_props' => ['width' => 'cnt-w', 'border-radius' => "b-r-r", 'button-style' => ["name" => "Palette", "value" => "btn-blc-lnk", "type" => "palette"], 'button-size' => 'inp-s p-l-10 p-r-10']];
        $menu_item2 = (new siteMenuItemBlockType())->getExampleBlockData();
        $menu_item2->data = ['html' => 'Consequat molestie', 'tag' => 'a', 'block_props' => ['width' => 'cnt-w', 'border-radius' => "b-r-r", 'button-style' => ["name" => "Palette", "value" => "btn-blc-lnk", "type" => "palette"], 'button-size' => 'inp-s p-l-10 p-r-10']];
        $menu_item3 = (new siteMenuItemBlockType())->getExampleBlockData();
        $menu_item3->data = ['html' => 'Etiam pulvinar', 'tag' => 'a', 'block_props' => ['width' => 'cnt-w', 'border-radius' => "b-r-r", 'button-style' => ["name" => "Palette", "value" => "btn-blc-lnk", "type" => "palette"], 'button-size' => 'inp-s p-l-10 p-r-10']];
        ...
        /* 3 column */
        $menu_item_bold = (new siteMenuItemBlockType())->getExampleBlockData();
        $menu_item_bold->data = ['html' => 'Malesuada', 'tag' => 'a', 'block_props' => ["font-header" => "t-hdn", 'width' => 'cnt-w', 'button-style' => ["name" => "Palette", "value" => "btn-blc-lnk", "type" => "palette"], 'button-size' => 'inp-m p-l-10 p-r-10']];
        $menu_item = (new siteMenuItemBlockType())->getExampleBlockData();
        $menu_item->data = ['html' => 'Mauris consequat', 'tag' => 'a', 'block_props' => ['width' => 'cnt-w', 'button-style' => ["name" => "Palette", "value" => "btn-blc-lnk", "type" => "palette"], 'button-size' => 'inp-s p-l-10 p-r-10']];
        $menu_item2 = (new siteMenuItemBlockType())->getExampleBlockData();
        $menu_item2->data = ['html' => 'Sed vitae nec', 'tag' => 'a', 'block_props' => ['width' => 'cnt-w', 'button-style' => ["name" => "Palette", "value" => "btn-blc-lnk", "type" => "palette"], 'button-size' => 'inp-s p-l-10 p-r-10']];
        $menu_item3 = (new siteMenuItemBlockType())->getExampleBlockData();
        $menu_item3->data = ['html' => '"Duis felis ante', 'tag' => 'a', 'block_props' => ['width' => 'cnt-w', 'button-style' => ["name" => "Palette", "value" => "btn-blc-lnk", "type" => "palette"], 'button-size' => 'inp-s p-l-10 p-r-10']];
        ...
        /* 4 column */
        $menu_item_bold = (new siteMenuItemBlockType())->getExampleBlockData();
        $menu_item_bold->data = ['html' => 'Nullam dictum', 'tag' => 'a', 'block_props' => ["font-header" => "t-hdn","font" => "t-7", 'width' => 'cnt-w', 'border-radius' => "b-r-r", 'button-style' => ["name" => "Palette", "value" => "btn-blc-lnk", "type" => "palette"], 'button-size' => 'inp-m p-l-10 p-r-10']];
        $menu_item = (new siteMenuItemBlockType())->getExampleBlockData();
        $menu_item->data = ['html' => 'Aenean gravida', 'tag' => 'a', 'block_props' => ['width' => 'cnt-w', 'border-radius' => "b-r-r", 'button-style' => ["name" => "Palette", "value" => "btn-blc-lnk", "type" => "palette"], 'button-size' => 'inp-s p-l-10 p-r-10']];
        $menu_item2 = (new siteMenuItemBlockType())->getExampleBlockData();
        $menu_item2->data = ['html' => 'Curabitur vel bibendum', 'tag' => 'a', 'block_props' => ['width' => 'cnt-w', 'border-radius' => "b-r-r", 'button-style' => ["name" => "Palette", "value" => "btn-blc-lnk", "type" => "palette"], 'button-size' => 'inp-s p-l-10 p-r-10']];
        $menu_item3 = (new siteMenuItemBlockType())->getExampleBlockData();
        $menu_item3->data = ['html' => 'Suspendisse ac rhoncus', 'tag' => 'a', 'block_props' => ['width' => 'cnt-w', 'border-radius' => "b-r-r", 'button-style' => ["name" => "Palette", "value" => "btn-blc-lnk", "type" => "palette"], 'button-size' => 'inp-s p-l-10 p-r-10']];
