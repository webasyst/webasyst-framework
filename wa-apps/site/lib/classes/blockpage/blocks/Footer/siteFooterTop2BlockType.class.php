 ...
 */
class siteFooterTop2BlockType extends siteBlockType
{
    public $elements = [
    ...
    public function __construct(array $options=[])
    {
        ...
        $options['type'] = 'site.FooterTop2.'.$options['columns'];
    ...
    public function getExampleBlockData()
    {
        ...
        $menu_item_bold->data = ['html' => '<font color="" class="tx-bw-1">De Societate</font>', 'tag' => 'h4', 'block_props' => ["font-header" => "t-hdn", 'margin-top' => 'm-t-0', 'margin-bottom' => 'm-b-10', 'font-size' => ['name' => "Size #6", 'type' => "library", 'value' => 't-6', 'unit' => 'px']]];
        $menu_item = (new siteMenuItemBlockType())->getExampleBlockData();
        $menu_item->data = ['html' => 'De nobis', 'tag' => 'a', 'block_props' => ['width' => 'cnt-w', 'border-radius' => "b-r-r", 'button-style' => ["name" => "Palette", "value" => "btn-blc-lnk", "type" => "palette"], 'button-size' => 'inp-s p-l-12 p-r-12', 'margin-top' => 'm-t-4', 'margin-bottom' => 'm-b-4', 'font-header' => 't-hdn', 'nobutton' => 'nobutton']];
        ...
        /* 3 column */
        $menu_item_bold = (new siteHeadingBlockType())->getExampleBlockData();
        $menu_item_bold->data = ['html' => '<font color="" class="tx-bw-1">Auxilium</font>', 'tag' => 'h4', 'block_props' => ["font-header" => "t-hdn", 'margin-top' => 'm-t-0', 'margin-bottom' => 'm-b-10', 'font-size' => ['name' => "Size #6", 'type' => "library", 'value' => 't-6', 'unit' => 'px']]];
        $menu_item = (new siteMenuItemBlockType())->getExampleBlockData();
        $menu_item->data = ['html' => 'De nobis', 'tag' => 'a', 'block_props' => ['width' => 'cnt-w', 'button-style' => ["name" => "Palette", "value" => "btn-blc-lnk", "type" => "palette"], 'button-size' => 'inp-s p-l-12 p-r-12', 'margin-top' => 'm-t-4', 'margin-bottom' => 'm-b-4', 'font-header' => 't-hdn', 'nobutton' => 'nobutton']];
        $menu_item2 = (new siteMenuItemBlockType())->getExampleBlockData();
        ...
        /* 4 column */
        $menu_item_bold = (new siteHeadingBlockType())->getExampleBlockData();
        $menu_item_bold->data = ['html' => '<font color="" class="tx-bw-1">Commercium</font>', 'tag' => 'h4', 'block_props' => ["font-header" => "t-hdn", 'margin-top' => 'm-t-0', 'margin-bottom' => 'm-b-10', 'font-size' => ['name' => "Size #6", 'type' => "library", 'value' => 't-6', 'unit' => 'px']]];
        $menu_item = (new siteMenuItemBlockType())->getExampleBlockData();
        $menu_item->data = ['html' => 'Responsio clientum', 'tag' => 'a', 'block_props' => ['width' => 'cnt-w', 'border-radius' => "b-r-r", 'button-style' => ["name" => "Palette", "value" => "btn-blc-lnk", "type" => "palette"], 'button-size' => 'inp-s p-l-12 p-r-12', 'margin-top' => 'm-t-4', 'margin-bottom' => 'm-b-4', 'font-header' => 't-hdn', 'nobutton' => 'nobutton']];
        $menu_item2 = (new siteMenuItemBlockType())->getExampleBlockData();
        ...
        $column_props = array();
        $column_props[$this->elements['main']] = ['padding-top' => "p-t-10", 'padding-bottom' => "p-b-10", 'padding-left' => "p-l-blc", 'padding-right' => "p-r-blc", 'background' => ["name" => "grey shades","value" => "bg-bw-7", "type" => "palette","uuid" => 1, "layers" => [["name" => "grey shades", "value" => "bg-bw-7", "type" => "palette"]]]];
