 ...
 */
class siteFooterBottom4BlockType extends siteBlockType
{
    public $elements = [
    ...
    public function __construct(array $options=[])
    {
        ...
        $options['type'] = 'site.FooterBottom4.'.$options['columns'];
    ...
    {        
        ...
        $column_left->data['column'] = "st-12-mb st-5-lp st-4 st-5-tb";
        $column_left->data['block_props'] = [
            'site-block-column' => [
                "margin-left" => "m-l-0-mb",
                "margin-right" => "m-r-0-mb",
        ...
        $column_right->data['column'] = "st-12-mb st-7-lp st-8 st-7-tb";
        $column_right->data['block_props'] = [
            'site-block-column' => [
        ...
        $column_right->data['wrapper_props'] = ['justify-align' => "j-s"];
        
        
        //construct left column
        $images_data = [
            [
                'block_props' => ['margin-bottom' => "m-b-12", 'margin-right' => "m-r-12", 'margin-top' => "m-t-0"],
            ...
            [
                'block_props' => ['margin-bottom' => "m-b-12", 'margin-right' => "m-r-12", 'margin-top' => "m-t-5"],
        ...
        $row->data['block_props'] = ['margin-left' => "m-l-12-mb", 'padding-bottom' => "p-b-4", 'padding-top' => "p-t-12"];
        $row->data['wrapper_props'] = ['justify-align' => 'j-end'];
        ...
        $menu_items = ["Historia", "Artifices", "Portatio", "Colloquere"];
        $hseq_column = (new siteVerticalSequenceBlockType())->getEmptyBlockData();
        $hseq_column->data['is_horizontal'] = true;
        $hseq_column->data['is_complex'] = 'no_complex';
