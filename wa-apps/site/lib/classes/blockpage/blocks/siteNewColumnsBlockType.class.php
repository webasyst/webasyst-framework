 ...
 */
class siteNewColumnsBlockType extends siteBlockType
{
    public $elements = [   
    ...
    public function __construct(array $options=[])
    {
        ...
        $options['type'] = 'site.NewColumns.'.$options['columns'];
    ...
    public function getExampleBlockData()
    {
        ...
        $column_block_type = (new siteNewColumnBlockType())->getExampleBlockData();
        ...
        $result->data = ['block_props' => $column_props, 'wrapper_props' => ['justify-align' => "y-j-cnt", 'flex-align' => 'y-l']];
