...
class siteBlockpageLibrary {
    ...
    protected function getSiteBlocks() {
        ...
        return [
            [
                'image'    => $img_url . 'footer/footer-1.jpg',
                'image_2x' => $img_url . 'footer/footer-1@2x.jpg',
            ...
            [
                'image'    => $img_url . 'footer/footer-2.jpg',
                'image_2x' => $img_url . 'footer/footer-2@2x.jpg',
                'title'    => _w('Site footer top block'),
            ...
            [
                'image'    => $img_url . 'cta.jpg',
                'image_2x' => $img_url . 'cta@2x.jpg',
            ...
            [
                'image'    => $img_url . 'menu/menu-1.jpg',
                'image_2x' => $img_url . 'menu/menu-1@2x.jpg',
                'title' => _w('Menu type 1'),
                'data'  => (new siteMenuT1BlockType(['columns' => 3]))->getExampleBlockData(),
                'tags'  => ['category_menu'],
            ],
            [
                'image'    => $img_url . 'menu/menu-2.jpg',
                'image_2x' => $img_url . 'menu/menu-2@2x.jpg',
                'title' => _w('Menu type 2'),
                'data'  => (new siteMenuT2BlockType(['columns' => 4]))->getExampleBlockData(),
                'tags'  => ['category_menu'],
            ],
            [
            ...
            [
                'image'    => $img_url . 'faq.jpg',
                'image_2x' => $img_url . 'faq@2x.jpg',
                'title'    => _w('FAQ'),
