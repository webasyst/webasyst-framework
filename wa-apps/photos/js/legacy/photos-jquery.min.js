var $jscomp=$jscomp||{};$jscomp.scope={};$jscomp.findInternal=function(a,c,d){a instanceof String&&(a=String(a));for(var f=a.length,g=0;g<f;g++){var b=a[g];if(c.call(d,b,g,a))return{i:g,v:b}}return{i:-1,v:void 0}};$jscomp.ASSUME_ES5=!1;$jscomp.ASSUME_NO_NATIVE_MAP=!1;$jscomp.ASSUME_NO_NATIVE_SET=!1;$jscomp.SIMPLE_FROUND_POLYFILL=!1;$jscomp.ISOLATE_POLYFILLS=!1;$jscomp.FORCE_POLYFILL_PROMISE=!1;$jscomp.FORCE_POLYFILL_PROMISE_WHEN_NO_UNHANDLED_REJECTION=!1;
...
$jscomp.polyfill=function(a,c,d,f){c&&($jscomp.ISOLATE_POLYFILLS?$jscomp.polyfillIsolated(a,c,d,f):$jscomp.polyfillUnisolated(a,c,d,f))};$jscomp.polyfillUnisolated=function(a,c,d,f){d=$jscomp.global;a=a.split(".");for(f=0;f<a.length-1;f++){var g=a[f];if(!(g in d))return;d=d[g]}a=a[a.length-1];f=d[a];c=c(f);c!=f&&null!=c&&$jscomp.defineProperty(d,a,{configurable:!0,writable:!0,value:c})};
$jscomp.polyfillIsolated=function(a,c,d,f){var g=a.split(".");a=1===g.length;f=g[0];f=!a&&f in $jscomp.polyfills?$jscomp.polyfills:$jscomp.global;for(var b=0;b<g.length-1;b++){var e=g[b];if(!(e in f))return;f=f[e]}g=g[g.length-1];d=$jscomp.IS_SYMBOL_NATIVE&&"es6"===d?f[g]:null;c=c(d);null!=c&&(a?$jscomp.defineProperty($jscomp.polyfills,g,{configurable:!0,writable:!0,value:c}):c!==d&&(void 0===$jscomp.propertyToPolyfillSymbol[g]&&(d=1E9*Math.random()>>>0,$jscomp.propertyToPolyfillSymbol[g]=$jscomp.IS_SYMBOL_NATIVE?
$jscomp.global.Symbol(g):$jscomp.POLYFILL_PREFIX+d+"$"+g),$jscomp.defineProperty(f,$jscomp.propertyToPolyfillSymbol[g],{configurable:!0,writable:!0,value:c})))};$jscomp.polyfill("Array.prototype.find",function(a){return a?a:function(c,d){return $jscomp.findInternal(this,c,d).v}},"es6","es3");$.wa=$.ui?$.extend(!0,$.wa,$.ui):{};
...
d.find(".dialog-buttons-gradient").empty().append(c.buttons);d.find(".dialog-content-indent").empty().append(c.content);d.show();c.small?d.addClass("small"):d.removeClass("small");c.url&&(a=function(g){d.find(".dialog-content-indent").html(g);$.wa.waCenterDialog(d);c.onload&&c.onload.call(d[0])},c.post?$.post(c.url,c.post,a):$.get(c.url,a));this.waCenterDialog(d);var f=function(g){if(d.is(":visible"))if(g&&27==g.keyCode)c.oncancel&&"function"==typeof c.oncancel&&c.oncancel.call(d[0]),$.wa.dialogHide();
else $(document).one("keyup",f)};f();$(document).one("hashchange",$.wa.dialogHide);return d},waCenterDialog:function(a){a=$(a);a=a.find(".dialog-window");var c=a.outerWidth(!0),d=a.outerHeight(!0),f=$(window).width(),g=$(window).height();a.css({left:Math.round((f-c)/2/f*100)+"%",top:Math.round((g-d)/2/g*100)+"%"})},dialogHide:function(){$(".dialog").hide();return!1},dropdownsClose:function(){var a=$(".dropdown:not(.disabled)");a.addClass("disabled");setTimeout(function(){a.removeClass("disabled")},
600)},dropdownsCloseEnable:function(){$(document).on("click",".dropdown:not(.disabled)",this.dropdownsClickHandler)},dropdownsCloseDisable:function(){$(document).off("click",".dropdown:not(.disabled)",this.dropdownsClickHandler)},dropdownsClickHandler:function(a){var c=$(this);c.hasClass("no-click-close")||(c.addClass("disabled"),setTimeout(function(){c.removeClass("disabled")},600))},defaultInputValue:function(a,c,d){a instanceof jQuery||(a=$(a));var f=function(){var g=a.val();g&&g!=c||(a.val(c),
a.addClass(d))};f();a.blur(f);a.focus(function(){a.hasClass(d)&&(a.removeClass(d),a.val(""))})},loadFiles:function(a){$.isArray(a)||(a="object"!==typeof a||$.isArray(a)?[].slice.apply(arguments):$.map(a,function(d,f){return d?f:null}));var c=a.map(function(d){return d?"string"!=typeof d?"object"===typeof d&&"function"===typeof d.then?d:null:d.match(/\.css(\?.*)?$/)?($("<link>").appendTo("head").attr({type:"text/css",rel:"stylesheet",href:d}),null):$.ajax({cache:!0,dataType:"script",url:d}):null}).filter(function(d){return!!d});
return $.when.apply($,c)},determineTimezone:function(a,c){var d=!1;$.each(document.cookie.split(/;\s*/g),function(g,b){b=b.split("=",2);if("tz"==b[0])return d=!0,c&&c(b[1]),!1});if(!d){var f={};f[a+"wa-content/js/jstz/jstz.min.js"]=!window.jstz;$.wa.loadFiles(f).then(function(){var g=window.jstz.determine().name();document.cookie="tz="+jstz.determine().name()+"; sameSite=LAX";var b=new Date;b.setTime(b.getTime()+12096E5);document.cookie="oldtz="+g+"; expires="+b.toUTCString()+"; sameSite=LAX";c&&
c(g)})}},util:{formatFileSize:function(a){var c=-1;do a/=1024,c++;while(99<a);return Math.max(a,.01).toFixed(2)+(0<=c?" "+$_("kB MB GB TB PB EB".split(" ")[c]):"")}}});
window.wa_skip_ajax_setup||($.ajaxSetup({cache:!1}),$(document).ajaxError(function(a,c,d,f){if(502===c.status&&"abort"==f||d.url&&0<=d.url.indexOf("background_process")||d.data&&0<=d.data.indexOf("background_process"))console&&console.log&&console.log("Notice: XHR failed on load: "+d.url);else if(200!==c.status&&c.responseText){if(!$.wa.errorHandler||$.wa.errorHandler(c))-1!=c.responseText.indexOf("Exception")?$.wa.dialogCreate("ajax-error",{content:"<div>"+c.responseText+"</div>"}):(document.open("text/html"),
...
function(){a.onClose&&a.onClose.call($(this));$(this).hide()});g=["width","height","min-width","min-height"];for(d=0;d<g.length;d++)a[g[d]]&&(("height"==g[d]&&"300px">a[g[d]]||"width"==g[d]&&"400px">a[g[d]])&&c.find("div.dialog-window").css("min-"+g[d],a[g[d]]),c.find("div.dialog-window").css(g[d],a[g[d]]));a.disableButtonsOnSubmit&&c.find("input[type=submit]").removeAttr("disabled");c.parent().length||c.appendTo("body");c.show();a.url?jQuery.get(a.url,function(e){var h=$(e);h.find(".dialog-content").length||
...
document.createElement(this.nodeName),document.documentElement.insertBefore(this.element,document.getElementsByTagName("title")[0]),this.element.addBehavior("#default#userData"),this.initialized=!0}catch(d){return!1}},get:function(d){this.element.load(this.nodeName);return this.element.getAttribute(d)},set:function(d,f){this.element.setAttribute(d,f);this.element.save(this.nodeName)},del:function(d){this.element.removeAttribute(d);this.element.save(this.nodeName)},flush:function(){this.element.expires=
(new Date).toUTCString();this.element.save(this.nodeName)}},windowName:{ident:"$.store.drivers.windowName",scope:"window",cache:{},encodes:!0,available:function(){return!0},init:function(){this.load()},save:function(){window.name=a.store.serializers.json.encode(this.cache)},load:function(){try{this.cache=a.store.serializers.json.decode(window.name+""),"object"!=typeof this.cache&&(this.cache={})}catch(d){this.cache={},window.name="{}"}},get:function(d){return this.cache[d]},set:function(d,f){this.cache[d]=
f;this.save()},del:function(d){try{delete this.cache[d]}catch(f){this.cache[d]=c}this.save()},flush:function(){window.name="{}"}}};a.store.serializers={json:{ident:"$.store.serializers.json",init:function(d,f){d.push("json");f.push("json")},encode:"object"==typeof JSON?JSON.stringify:a.JSON.stringify,decode:"object"==typeof JSON?JSON.parse:a.JSON.parse},xml:{ident:"$.store.serializers.xml",init:function(d,f){d.unshift("xml");f.push("xml")},isXML:function(d){return(d=(d?d.ownerDocument||d:0).documentElement)?
"html"!==d.nodeName.toLowerCase():!1},encode:function(d){if(!d||d._serialized||!this.isXML(d))return d;var f={_serialized:this.ident,value:d};try{return f.value=(new XMLSerializer).serializeToString(d),f}catch(g){try{return f.value=d.xml,f}catch(b){}}return d},decode:function(d){if(!d||!d._serialized||d._serialized!=this.ident)return d;var f="DOMParser"in window&&(new DOMParser).parseFromString;!f&&window.ActiveXObject&&(f=function(g){var b=new ActiveXObject("Microsoft.XMLDOM");b.async="false";b.loadXML(g);
return b});if(!f)return c;d.value=f.call("DOMParser"in window&&new DOMParser||window,d.value,"text/xml");return this.isXML(d.value)?d.value:c}}}})(jQuery);(function(a){function c(f,g){this.path=f;"undefined"!==typeof g&&null!==g?(this.at_2x_path=g,this.perform_check=!1):(this.at_2x_path=f.replace(/\.\w+$/,function(b){return"@2x"+b}),this.perform_check=!0)}function d(f){if(!/@2x\.\w+$/.test(a(f).attr("src"))){this.el=f;this.path=new c(a(f).attr("src"),a(f).attr("data-at2x"));var g=this;this.path.check_2x_variant(function(b){b&&g.swap()})}}a.fn.retina=function(f){if(a.Retina.isRetina())return a.Retina.opts=a.extend(a.Retina.opts,f),this.each(function(){a(this).is("img")&&
...
function(f){var g=this;if(this.is_external()||!this.perform_check&&"undefined"!==typeof this.at_2x_path&&null!==this.at_2x_path||this.at_2x_path in c.confirmed_paths)return f(!0);var b=new XMLHttpRequest;b.open("HEAD",this.at_2x_path);b.onreadystatechange=function(){if(4==b.readyState&&200<=b.status&&399>=b.status){if(a.Retina.opts.check_mime_type){var e=b.getResponseHeader("Content-Type");if(null===e||!e.match(/^image/i))return f(!1)}c.confirmed_paths.push(g.at_2x_path);return f(!0)}return f(!1)};
b.send()};a.RetinaImage=d;d.prototype.swap=function(f){function g(){if(b.el.complete){a.Retina.opts.force_original_dimensions&&(b.el.setAttribute("width",b.el.offsetWidth),b.el.setAttribute("height",b.el.offsetHeight));var e=b.el.src;b.el.setAttribute("src",f);a(b.el).one("error",function(){b.el.setAttribute("src",e)})}else setTimeout(g,5)}"undefined"==typeof f&&(f=this.path.at_2x_path);var b=this;g()}})(jQuery);(function(a){var c=[],d=[];a.fn.doAutosize=function(f){var g=a(this).data("minwidth"),b=a(this).data("maxwidth"),e="",h=a(this),k=a("#"+a(this).data("tester_id"));e!==(e=h.val())&&(e=e.replace(/&/g,"&").replace(/\s/g," ").replace(/</g,"<").replace(/>/g,">"),k.html(e),k=k.width(),f=k+f.comfortZone>=g?k+f.comfortZone:g,k=h.width(),(f<k&&f>=g||f>g&&f<b)&&h.width(f))};a.fn.resetAutosize=function(f){var g=a(this).data("minwidth")||f.minInputWidth||a(this).width();f=a(this).data("maxwidth")||f.maxInputWidth||
a(this).closest(".tagsinput").width()-f.inputPadding;var b=a(this),e=a("<tester/>").css({position:"absolute",top:-9999,left:-9999,width:"auto",fontSize:b.css("fontSize"),fontFamily:b.css("fontFamily"),fontWeight:b.css("fontWeight"),letterSpacing:b.css("letterSpacing"),whiteSpace:"nowrap"}),h=a(this).attr("id")+"_autosize_tester";0< !a("#"+h).length&&(e.attr("id",h),e.appendTo("body"));b.data("minwidth",g);b.data("maxwidth",f);b.data("tester_id",h);b.css("width",g)};a.fn.addTag=function(f,g){g=jQuery.extend({focus:!1,
callback:!0},g);this.each(function(){var b=a(this).attr("id"),e=a(this).val().split(c[b]);""==e[0]&&(e=[]);f=jQuery.trim(f);if(g.unique){var h=a(e).tagExist(f);1==h&&a("#"+b+"_tag").addClass("not_valid")}else h=!1;if(""!=f&&1!=h&&(a("<span>").addClass("tag").append(a("<span>").text(f).append("\u00a0\u00a0"),a("<a>",{href:"#",title:"Removing tag",text:"x"}).click(function(){return a("#"+b).removeTag(escape(f))})).insertBefore("#"+b+"_addTag"),e.push(f),a("#"+b+"_tag").val(""),g.focus?a("#"+b+"_tag").focus():
a("#"+b+"_tag").blur(),a.fn.tagsInput.updateTagsField(this,e),g.callback&&d[b]&&d[b].onAddTag&&(h=d[b].onAddTag,h.call(this,f)),d[b]&&d[b].onChange)){var k=e.length;h=d[b].onChange;h.call(this,a(this),e[k-1])}});return!1};a.fn.removeTag=function(f){f=unescape(f);this.each(function(){var g=a(this).attr("id"),b=a(this).val().split(c[g]);a("#"+g+"_tagsinput .tag").remove();str="";for(var e=0;e<b.length;e++)b[e]!=f&&(str=str+c[g]+b[e]);a.fn.tagsInput.importTags(this,str);d[g]&&d[g].onRemoveTag&&d[g].onRemoveTag.call(this,
f)});return!1};a.fn.tagExist=function(f){return 0<=jQuery.inArray(f,a(this))};a.fn.importTags=function(f){id=a(this).attr("id");a("#"+id+"_tagsinput .tag").remove();a.fn.tagsInput.importTags(this,f)};a.fn.tagsInput=function(f){var g=jQuery.extend({interactive:!0,defaultText:"add a tag",minChars:0,width:"300px",height:"100px",autocomplete:{selectFirst:!1},hide:!0,delimiter:",",unique:!0,removeWithBackspace:!0,placeholderColor:"#666666",autosize:!0,comfortZone:20,inputPadding:12},f);this.each(function(){g.hide&&
a(this).hide();var b=a(this).attr("id"),e=jQuery.extend({pid:b,real_input:"#"+b,holder:"#"+b+"_tagsinput",input_wrapper:"#"+b+"_addTag",fake_input:"#"+b+"_tag"},g);c[b]=e.delimiter;if(g.onAddTag||g.onRemoveTag||g.onChange)d[b]=[],d[b].onAddTag=g.onAddTag,d[b].onRemoveTag=g.onRemoveTag,d[b].onChange=g.onChange;var h='<div id="'+b+'_tagsinput" class="tagsinput"><div id="'+b+'_addTag">';g.interactive&&(h=h+'<input id="'+b+'_tag" value="" data-default="'+g.defaultText+'" />');a(h+'</div><div class="tags_clear"></div></div>').insertAfter(this);
a(e.holder).css("width",g.width);a(e.holder).css("height",g.height);""!=a(e.real_input).val()&&a.fn.tagsInput.importTags(a(e.real_input),a(e.real_input).val());if(g.interactive){a(e.fake_input).val(a(e.fake_input).attr("data-default"));a(e.fake_input).css("color",g.placeholderColor);a(e.fake_input).resetAutosize(g);a(e.holder).bind("click",e,function(k){a(k.data.fake_input).focus()});a(e.fake_input).bind("focus",e,function(k){a(k.data.fake_input).val()==a(k.data.fake_input).attr("data-default")&&
a(k.data.fake_input).val("");a(k.data.fake_input).css("color","#000000")});if(void 0!=g.autocomplete_url){autocomplete_options={source:g.autocomplete_url};for(attrname in g.autocomplete)autocomplete_options[attrname]=g.autocomplete[attrname];void 0!==jQuery.Autocompleter?(a(e.fake_input).autocomplete(g.autocomplete_url,g.autocomplete),a(e.fake_input).bind("result",e,function(k,l,m){l&&a("#"+b).addTag(l[0]+"",{focus:!0,unique:g.unique})})):void 0!==jQuery.ui.autocomplete&&(a(e.fake_input).autocomplete(autocomplete_options),
a(e.fake_input).bind("autocompleteselect",e,function(k,l){a(k.data.real_input).addTag(l.item.value,{focus:!0,unique:g.unique});return!1}))}else a(e.fake_input).bind("blur",e,function(k){var l=a(this).attr("data-default");""!=a(k.data.fake_input).val()&&a(k.data.fake_input).val()!=l?k.data.minChars<=a(k.data.fake_input).val().length&&(!k.data.maxChars||k.data.maxChars>=a(k.data.fake_input).val().length)&&a(k.data.real_input).addTag(a(k.data.fake_input).val(),{focus:!0,unique:g.unique}):(a(k.data.fake_input).val(a(k.data.fake_input).attr("data-default")),
a(k.data.fake_input).css("color",g.placeholderColor));return!1});a(e.fake_input).bind("keypress",e,function(k){if(k.which==k.data.delimiter.charCodeAt(0)||13==k.which)return k.preventDefault(),k.data.minChars<=a(k.data.fake_input).val().length&&(!k.data.maxChars||k.data.maxChars>=a(k.data.fake_input).val().length)&&a(k.data.real_input).addTag(a(k.data.fake_input).val(),{focus:!0,unique:g.unique}),a(k.data.fake_input).resetAutosize(g),!1;k.data.autosize&&a(k.data.fake_input).doAutosize(g)});e.removeWithBackspace&&
a(e.fake_input).bind("keydown",function(k){if(8==k.keyCode&&""==a(this).val()){k.preventDefault();k=a(this).closest(".tagsinput").find(".tag:last").text();var l=a(this).attr("id").replace(/_tag$/,"");k=k.replace(/[\s]+x$/,"");a("#"+l).removeTag(escape(k));a(this).trigger("focus")}});a(e.fake_input).blur();e.unique&&a(e.fake_input).keydown(function(k){(8==k.keyCode||String.fromCharCode(k.which).match(/\w+|[\u00e1\u00e9\u00ed\u00f3\u00fa\u00c1\u00c9\u00cd\u00d3\u00da\u00f1\u00d1,\/]+/))&&a(this).removeClass("not_valid")})}return!1});
return this};a.fn.tagsInput.updateTagsField=function(f,g){var b=a(f).attr("id");a(f).val(g.join(c[b]))};a.fn.tagsInput.importTags=function(f,g){a(f).val("");var b=a(f).attr("id");g=g.split(c[b]);for(var e=0;e<g.length;e++)a(f).addTag(g[e],{focus:!1,callback:!1});d[b]&&d[b].onChange&&d[b].onChange.call(f,f,g[e])}})(jQuery);(function(a){a.fn.extend({autocomplete:function(c,d){var f="string"==typeof c;d=a.extend({},a.Autocompleter.defaults,{url:f?c:null,data:f?null:c,delay:f?a.Autocompleter.defaults.delay:10,max:d&&!d.scroll?10:150},d);d.highlight=d.highlight||function(g){return g};d.formatMatch=d.formatMatch||d.formatItem;return this.each(function(){new a.Autocompleter(this,d)})},result:function(c){return this.bind("result",c)},search:function(c){return this.trigger("search",[c])},flushCache:function(){return this.trigger("flushCache")},
setOptions:function(c){return this.trigger("setOptions",[c])},unautocomplete:function(){return this.trigger("unautocomplete")}});a.Autocompleter=function(c,d){function f(){var w=x.selected();if(!w)return!1;var y=w.result;q=y;if(d.multiple){var B=b(p.val());if(1<B.length){var z=d.multipleSeparator.length,E=a(c).selection().start,C,D=0;a.each(B,function(G,F){D+=F.length;if(E<=D)return C=G,!1;D+=z});B[C]=y;y=B.join(d.multipleSeparator)}y+=d.multipleSeparator}p.val(y);h();p.trigger("result",[w.data,w.value]);
return!0}function g(w,y){if(r==m.DEL)x.hide();else if(w=p.val(),y||w!=q)q=w,w=e(w),w.length>=d.minChars?(p.addClass(d.loadingClass),d.matchCase||(w=w.toLowerCase()),l(w,k,h)):(p.removeClass(d.loadingClass),x.hide())}function b(w){return w?d.multiple?a.map(w.split(d.multipleSeparator),function(y){return a.trim(w).length?a.trim(y):null}):[a.trim(w)]:[""]}function e(w){if(!d.multiple)return w;var y=b(w);if(1==y.length)return y[0];y=a(c).selection().start;y=y==w.length?b(w):b(w.replace(w.substring(y),
...
F&&(F=F.split("|"),D[D.length]={data:F,value:F[0],result:d.formatResult&&d.formatResult(F,F[0])||F[0]})}}t.add(w,D);y(w,D)}})}else x.emptyList(),B(w)}var m={UP:38,DOWN:40,DEL:46,TAB:9,RETURN:13,ESC:27,COMMA:188,PAGEUP:33,PAGEDOWN:34,BACKSPACE:8},p=a(c).attr("autocomplete","off").addClass(d.inputClass),n,q="",t=a.Autocompleter.Cache(d),u=0,r,v={mouseDownOnSelect:!1},x=a.Autocompleter.Select(d,c,f,v),A;a.browser.opera&&a(c.form).bind("submit.autocomplete",function(){if(A)return A=!1});p.bind((a.browser.opera?
"keypress":"keydown")+".autocomplete",function(w){u=1;r=w.keyCode;switch(w.keyCode){case m.UP:w.preventDefault();x.visible()?x.prev():g(0,!0);break;case m.DOWN:w.preventDefault();x.visible()?x.next():g(0,!0);break;case m.PAGEUP:w.preventDefault();x.visible()?x.pageUp():g(0,!0);break;case m.PAGEDOWN:w.preventDefault();x.visible()?x.pageDown():g(0,!0);break;case d.multiple&&","==a.trim(d.multipleSeparator)&&m.COMMA:case m.TAB:case m.RETURN:if(f())return w.preventDefault(),A=!0,!1;break;case m.ESC:x.hide();
break;default:clearTimeout(n),n=setTimeout(g,d.delay)}}).focus(function(){u++}).blur(function(){u=0;v.mouseDownOnSelect||(clearTimeout(n),n=setTimeout(h,200))}).click(function(){1<u++&&!x.visible()&&g(0,!0)}).bind("search",function(){function w(B,z){if(z&&z.length)for(var E=0;E<z.length;E++)if(z[E].result.toLowerCase()==B.toLowerCase()){var C=z[E];break}"function"==typeof y?y(C):p.trigger("result",C&&[C.data,C.value])}var y=1<arguments.length?arguments[1]:null;a.each(b(p.val()),function(B,z){l(z,
...
width:0,multiple:!1,multipleSeparator:", ",highlight:function(c,d){return c.replace(new RegExp("(?![^&;]+;)(?!<[^<>]*)("+d.replace(/([\^\$\(\)\[\]\{\}\*\.\+\?\|\\])/gi,"\\$1")+")(?![^<>]*>)(?![^&;]+;)","gi"),"<strong>$1</strong>")},scroll:!0,scrollHeight:180};a.Autocompleter.Cache=function(c){function d(k,l){c.matchCase||(k=k.toLowerCase());var m=k.indexOf(l);"word"==c.matchContains&&(m=k.toLowerCase().search("\\b"+l.toLowerCase()));return-1==m?!1:0==m||c.matchContains}function f(k,l){h>c.cacheLength&&
b();e[k]||h++;e[k]=l}function g(){if(!c.data)return!1;var k={},l=0;c.url||(c.cacheLength=1);k[""]=[];for(var m=0,p=c.data.length;m<p;m++){var n=c.data[m];n="string"==typeof n?[n]:n;var q=c.formatMatch(n,m+1,c.data.length);if(!1!==q){var t=q.charAt(0).toLowerCase();k[t]||(k[t]=[]);n={value:q,data:n,result:c.formatResult&&c.formatResult(n)||q};k[t].push(n);l++<c.max&&k[""].push(n)}}a.each(k,function(u,r){c.cacheLength++;f(u,r)})}function b(){e={};h=0}var e={},h=0;setTimeout(g,25);return{flush:b,add:f,
populate:g,load:function(k){if(!c.cacheLength||!h)return null;if(!c.url&&c.matchContains){var l=[],m;for(m in e)if(0<m.length){var p=e[m];a.each(p,function(n,q){d(q.value,k)&&l.push(q)})}return l}if(e[k])return e[k];if(c.matchSubset)for(m=k.length-1;m>=c.minChars;m--)if(p=e[k.substr(0,m)])return l=[],a.each(p,function(n,q){d(q.value,k)&&(l[l.length]=q)}),l;return null}}};a.Autocompleter.Select=function(c,d,f,g){function b(){q&&(t=a("<div/>").hide().addClass(c.resultsClass).css("position","absolute").appendTo(document.body),
u=a("<ul/>").appendTo(t).mouseover(function(r){e(r).nodeName&&"LI"==e(r).nodeName.toUpperCase()&&(m=a("li",u).removeClass(k.ACTIVE).index(e(r)),a(e(r)).addClass(k.ACTIVE))}).click(function(r){a(e(r)).addClass(k.ACTIVE);f();d.focus();return!1}).mousedown(function(){g.mouseDownOnSelect=!0}).mouseup(function(){g.mouseDownOnSelect=!1}),0<c.width&&t.css("width",c.width),q=!1)}function e(r){for(r=r.target;r&&"LI"!=r.tagName;)r=r.parentNode;return r?r:[]}function h(r){l.slice(m,m+1).removeClass(k.ACTIVE);
...
d):this.selectionStart&&(this.selectionStart=c,this.selectionEnd=d)});var f=this[0];if(f.createTextRange){var g=document.selection.createRange(),b=f.value,e=g.text.length;g.text="<->";g=f.value.indexOf("<->");f.value=b;this.selection(g,g+e);return{start:g,end:g+e}}if(void 0!==f.selectionStart)return{start:f.selectionStart,end:f.selectionEnd}}})(jQuery);(function(a){a.photos_sidebar={width:200,options:{},init:function(c){var d=this;this.options=c||{};c.width&&(this.width=c.width);this.initCollapsible();this.initHandlers();this.initView();setTimeout(function(){d.initFixedSidebar()},1E3)},initFixedSidebar:function(){var c=a(window),d=a("#wa-app"),f=d.find(".p-sidebar-wrapper"),g=f.find(".p-sidebar-block"),b=c.height(),e=g.offset().top,h=!1,k=!1,l=!1,m=0;c.on("scroll",function(){var p=c.scrollTop(),n=g.outerHeight(),q=d.height(),t=g.offset().top,u=
m>p?1:-1,r=p-e,v=g.width(),x=n+parseInt(f.css("padding-top"))+parseInt(f.css("padding-bottom"))>=q;if(q>b&&!x)if(n<b)0<r?((h||!k||l)&&g.removeAttr("style").width(v).addClass("fixed-to-top"),l=!0):g.removeAttr("style").removeClass("fixed-to-bottom").removeClass("fixed-to-top");else if(p<=e){if(h||k||l)g.removeAttr("style").removeClass("fixed-to-bottom").removeClass("fixed-to-top"),h=k=l=!1}else if(p<=t&&t>=e)if(0<u){if(h||!l||k)g.removeAttr("style").width(v).removeClass("fixed-to-bottom").addClass("fixed-to-top"),
h=k=!1,l=!0}else{if(!h||l||k)g.css("top",t-e).removeClass("fixed-to-top").removeClass("fixed-to-bottom"),h=!0,l=k=!1}else if(p+b>=t+n)if(0<u){if(!h||l||k)g.css("top",t-e).removeClass("fixed-to-top").removeClass("fixed-to-bottom"),h=!0,l=k=!1}else{if(h||l||!k)g.removeAttr("style").width(v).removeClass("fixed-to-top").addClass("fixed-to-bottom"),h=l=!1,k=!0}else{if(!h||l||k)g.css("top",t-e).removeClass("fixed-to-top").removeClass("fixed-to-bottom"),h=!0,l=k=!1}else if(h||l||k)g.removeAttr("style").removeClass("fixed-to-bottom").removeClass("fixed-to-top"),
h=l=k=!1;m=p})},initView:function(){var c=a("#p-sidebar"),d=a("#p-sidebar-width-control");d.find("a.arrow").unbind("click").bind("click",function(){var f=c.attr("class"),g=0,b=f.match(/left([\d]{2,3})px/);if(b&&b[1]&&(g=parseInt(b[1]))&&(b=g+(a(this).is(".right")?50:-50),b=Math.max(Math.min(b,400),200),b!=g)){d.css({width:b.toString()+"px"});g=["left"+g+"px","left"+b+"px"];c.attr("class",f.replace(g[0],g[1]));c.css("width","");var e=a("#p-content");e.length&&(f=e.attr("class"),e.attr("class",f.replace(g[0],
g[1])),e.css("margin-left",""));a.photos_sidebar.width=b;a.post("?action=sidebarSaveWidth",{width:b},"json")}return!1})},initCollapsible:function(){a("#p-sidebar").off("click",".collapse-handler").on("click",".collapse-handler",function(){a.photos_sidebar._collapseSidebarSection(this,"toggle")});a("#p-sidebar .collapse-handler").each(function(){a.photos_sidebar._collapseSidebarSection(this,"restore")});a("#album-list-container").die("uncollapse_section").live("uncollapse_section",function(c,d){d=
a(d);c=a(this).find(">.collapse-handler");var f=d.find(">i.collapse-handler");a.photos_sidebar._collapseSidebarSection(f,"uncollapse");for(d=d.parent().parent();d.length&&d.get(0)!=this;){f=d.find(">i.collapse-handler");if(!f.length)break;a.photos_sidebar._collapseSidebarSection(f,"uncollapse");d=d.parent().parent()}a.photos_sidebar._collapseSidebarSection(c,"uncollapse")})},initHandlers:function(){a("#p-upload-link").click(function(){a.photos.uploadDialog();return!1});a("#album-list-container").off("click",
".p-new-album").on("click",".p-new-album",function(){var c=a(this),d=0;c.is("#p-new-album")||(d=parseInt(c.parents("li:first").attr("rel"),10)||0);c=a("#album-create-dialog-acceptor");c.length||(c=a("<div id='album-create-dialog-acceptor'></div>"),a("body").append(c));c.load("?module=dialog&action=createAlbum&parent_id="+d,function(){a("#album-create-dialog").waDialog({onLoad:function(f){a(this).find("input[type=text]").val("")},onSubmit:function(f){var g=a(this);a.post(g.attr("action"),g.serialize(),
function(b){"ok"==b.status&&(a.photos.onCreateAlbum(b.data,d),f.trigger("close"),b.data.id&&a.photos.goToHash("/album/"+b.data.id))},"json");return!1}})});return!1})},countSubtree:function(c){var d=c.find(">.count:not(.subtree)"),f=c.find(">.subtree");f.length||(f=d.clone().addClass("subtree").hide(),d.after(f));var g=parseInt(d.text(),10)||0;c.find("li.static>.count:not(.subtree)").each(function(){var b=parseInt(a(this).text(),10)||0;g+=b});f.hasClass("never-recount")||f.text(g);f.show();d.hide();
return g},countItem:function(c){var d=c.find(">.count:not(.subtree)").show();c.find(">.subtree").hide();return parseInt(d.text(),10)||0},_collapseSidebarSection:function(c,d){d||(d="coollapse");c=a(c);if(c.length){var f=c.hasClass("darr")||c.hasClass("rarr")?c:c.find(".darr, .rarr");if(f.length){var g=c.parent(),b=g.find(".hierarchical:first");b.length||(b=g.find(".collapsible-content:first"));b.length||(b=g.find("ul:first"));var e;c=c.attr("id")||c.parent().attr("id");var h=f.hasClass("darr")?"shown":
"hidden",k=function(){b.hide();f.removeClass("darr").addClass("rarr");a.photos_sidebar.countSubtree(g);e="hidden"},l=function(){b.show();f.removeClass("rarr").addClass("darr");a.photos_sidebar.countItem(g);e="shown"};switch(d){case "toggle":"shown"==h?k():l();break;case "restore":c&&("hidden"==a.storage.get("photos/collapsible/"+c)?k():l());break;case "uncollapse":l();break;default:k()}c&&e&&a.storage.set("photos/collapsible/"+c,e)}}}}})(jQuery);(function(a){function c(){var f=a.photos.getAlbum();return f&&f.type===Album.TYPE_STATIC&&!1!==f.edit_rights?!0:!1}function d(){a("#hint-menu-block").hide().children().hide()}a.photos_dragndrop={helper_shift:20,init:function(){this._extendJqueryUIDragAndDrop();this._initDragPhotos();this._initDropPhotos();this._initDragAlbums();this._initDropAlbums()},_initDragPhotos:function(){var f={opacity:.75,zIndex:9999,distance:5,appendTo:"body",cursor:"move",refreshPositions:!0,start:function(e,h){document.ondragstart=
function(){return!1};h.helper.data("scrollTop",a(document).scrollTop());a(document).bind("scroll",a.photos_dragndrop._scrolHelper);a("#album-list-container").addClass("p-drag-active")},stop:function(e,h){document.ondragstart=null;a(document).unbind("scroll",a.photos_dragndrop._scrolHelper);a("#album-list-container").removeClass("p-drag-active");d()},drag:function(e,h){e=e.originalEvent;h.position.left=e.pageX-a.photos_dragndrop.helper_shift;h.position.top=e.pageY}},g=f.start,b=f.stop;a("img",a("#photo-list")).liveDraggable(a.extend({},
f,{containment:[0,0,a(window).width(),{toString:function(){return a(document).height()}}],helper:function(e){e=a(this).parents("li:first");var h=a("#photo-list li.selected"),k=h.length?h.length:1,l=[e.attr("data-photo-id")],m=!1,p=e.get(0);h.each(function(){this!=p?l.push(a(this).attr("data-photo-id")):m=!0});!m&&h.length&&(e.addClass("selected").find("input:first").trigger("select",!0),++k);e.data("photo_ids",l);return'<div id="helper"><span class="indicator red">'+k+'</span><i class="icon10 no-bw" style="display:none;"></i></div>'},
handle:".p-image",start:function(e,h){g.apply(this,[e,h]);e=a(this).parents("li:first");1==e.data("photo_ids").length&&e.addClass("selected")},stop:function(e,h){b.apply(this,[e,h]);e=a(this).parents("li:first");1==e.data("photo_ids").length&&e.removeClass("selected")}}));a("#photo").liveDraggable(a.extend({},f,{containment:"body",start:function(e,h){if(!a(e.target).hasClass("ui-draggable"))return!1},helper:function(){return'<div id="helper"><span class="indicator red">1</span><i class="icon10 no-bw" style="display:none;"></i></div>'}}))},
_initDropPhotos:function(){a("li",a("#photo-list")).liveDroppable({disabled:!1,greedy:!0,tolerance:"pointer",over:function(f,g){if(g.draggable.hasClass("dr"))return!1;if(c())d();else if(f=a.photos.getOption("sort_method"))g=a("#hint-menu-block").show(),g.children().hide(),g.find("."+f).show();a.photos_dragndrop._activatePhotoListItem.call(this)},out:function(f,g){a.photos_dragndrop._unactivatePhotoListItem.call(this)},drop:function(f,g){f=c();var b=a.photos.getAlbum();g=g.draggable.parents("li:first");
var e=a(this);if(g.get(0)==this||e.hasClass("selected"))return a.photos_dragndrop._unactivatePhotoListItem.call(this),!1;var h=a("#photo-list li.selected");h.length||(h=g);a.photos_dragndrop._unactivatePhotoListItem.call(this);a.photos_dragndrop._unactivatePhotoListItem.call(g);if(!f)return!1;var k=parseInt(e.attr("data-photo-id"));e.hasClass("last")?(k=null,e.after(h),e.removeClass("last"),a("#photo-list li:last").addClass("last")):(e.before(h),g.hasClass("last")&&(g.removeClass("last"),a("#photo-list li:last").addClass("last")));
h.trigger("select",!1);var l=[];h.each(function(){l.push(parseInt(a(this).attr("data-photo-id")))});a.post("?module=album&action=photoMove",{photo_id:l,album_id:b.id,before_id:k},function(m){"ok"==m.status&&a.photos.photo_stream_cache.move(l,k)},"json")}})},_initDragAlbums:function(){var f=a("#wa-app > .sidebar"),g=f.position(),b=f.width();f=f.height();a("li.dr",a("#album-list")).liveDraggable({containment:[g.left,g.top,g.left+b+.25*b,g.top+f],refreshPositions:!0,revert:"invalid",helper:function(){var e=
...
a("#album-list")).liveDroppable({accept:"li.dr",greedy:!0,tolerance:"pointer",over:function(f,g){if("IMG"==g.draggable.get(0).tagName)return!1;a(this).addClass("active").parent().parent().addClass("drag-active")},out:function(f,g){a(this).removeClass("active").parent().parent().removeClass("drag-active")},deactivate:function(f,g){var b=a(this);(b.is(":animated")||b.hasClass("dragging"))&&b.stop().animate({height:"0px"},300,null,function(){b.removeClass("dragging")});a(this).removeClass("active").parent().parent().removeClass("drag-active")},
drop:function(f,g){if("IMG"==g.draggable.get(0).tagName)return!1;var b=a(this).parent("ul");g=a(g.draggable);f=g.attr("rel");var e=a(this).prev("li");if(e.length&&e.attr("rel")==f&&!e.hasClass("ui-draggable")||this==g.next().get(0))return!1;b=b.parent("li").length?b.parent("li").attr("rel"):0;e=a(this).next();var h=null;e.length&&(h=e.attr("rel"));a.post("?module=album&action=move",{id:f,before_id:h,parent_id:b},function(k){var l=a.photos.getAlbum(),m=k.data.album,p=k.data.counters;0>=m.status&&a.photos_dragndrop.privateDescendants(m.id)&&
a.photos.dispatch("album/"+m.id+"/");l&&l.id==m.id&&((k=k.data.frontend_link)&&a("#photo-list-frontend-link").attr("href",k).text(k),m.type==Album.TYPE_DYNAMIC&&a.photos.load("?module=album&action=photos&id="+m.id,a.photos.onLoadPhotoList));if(!a.isEmptyObject(p))for(var n in p)p.hasOwnProperty(n)&&album_list.find("li[rel="+n+"]").find(".count:first").text(p[n])},"json");b=g.parent("ul");f=b.children("li.dr[rel!="+f+"]").length;g.next().insertAfter(a(this));g.insertAfter(a(this));f||(b.parent("li").children("i").remove(),
b.remove())}})},privateDescendants:function(f,g){g="boolean"===typeof g?g:!0;f=a("#album-list").find("li[rel="+f+"]");g=g?f:a();changed=!1;g.add(f.find("li.dr")).each(function(){var b=a(this).find(">a");if(!b.find("i.lock-bw").length){var e=b.find(".pictures").next();e.length?(changed=!0,e.before('<i class="icon10 lock-bw no-overhanging"></i>')):b.append('<i class="icon10 lock-bw no-overhanging"></i>')}});return changed},_initDropInsideAlbums:function(){a("li.dr a",a("#album-list")).liveDroppable({accept:function(f){return f.is("li.dr, img#photo")||
f.closest("li[data-photo-id]").length?!0:!1},tolerance:"custom",greedy:!0,out:function(f,g){a(this).parent().removeClass("drag-newparent");g.helper.find("span").show().end().find("i").hide()},over:function(f,g){f=a(this).parent();var b=!1;g.draggable=a.photos_dragndrop._fixUiDraggable(g.draggable);if(g.draggable.parents("#photo-list").length||g.draggable.is("#photo"))f.hasClass("static")?g.helper.find("span").show().end().find("i").hide():g.helper.find("span").hide().end().find("i").show(),b=!0;f.addClass("drag-newparent");
if(b)return!1;if(g.draggable.hasClass("static")&&!f.hasClass("static"))return g.helper.find("i.no-bw").show(),!1;g.helper.find("i.no-bw").hide();var e='.dr[rel!="'+a(g.draggable).attr("rel")+'"]',h=a(),k=function(m,p){if(0>=p.length)return m;m=m.add(p.nextUntil(e).filter("li.drag-newposition"));return 0<p.nextAll(e).length?m:k(m,p.parent().closest("li"))};g=f.prevAll(e).first();0<g.length?(b=g.find(e),h=0<b.length?k(h,b.last()):k(h,g)):h=h.add(f.prevUntil(e).filter("li.drag-newposition"));h=0<f.children("ul").children(e).length?
h.add(f.children("ul").children("li.drag-newposition:first")):k(h,f);var l=a(".drag-newposition:animated, .drag-newposition.dragging").not(h);l.stop().animate({height:"0px"},300,null,function(){l.removeClass("dragging")});h.stop().animate({height:"10px"},300,null,function(){h.addClass("dragging")})},drop:function(f,g){f=a(this).parent().removeClass("drag-newparent");g.draggable=a.photos_dragndrop._fixUiDraggable(g.draggable);if(g.draggable.parents("#photo-list").length||g.draggable.is("#photo")){var b=
this.href.match(/.*#\/album\/([\d]+)/);if(null===b||!parseInt(b[1],10)){console&&console.log("Link: "+this.href+" is not correct");return}b=parseInt(b[1],10);var e=null;f.hasClass("static")&&(e=g.draggable.is("#photo")?[a.photos.photo_stream_cache.getCurrent().id]:g.draggable.data("photo_ids"));e&&(a.photos.addToAlbums({photo_id:e,album_id:b}),a("#photo-list li.selected").trigger("select",!1));return!1}if(g.draggable.hasClass("static")&&!f.hasClass("static"))return!1;b=a(g.draggable);if(f.attr("rel")==
b.attr("rel"))return!1;f.hasClass("drag-newposition")?g=f.parent("ul"):f.children("ul").length?g=f.children("ul"):(g=a('<ul class="menu-v with-icons dr"><li class="drag-newposition"></li></ul>').appendTo(f),g.find(".drag-newposition").mouseover(),a('<i class="icon16 darr overhanging"></i>').insertBefore(f.children("a")));e=b.attr("rel");f=f.attr("rel");if(f==b.parent("ul").parent("li.dr").attr("rel"))return!1;a.post("?module=album&action=move",{id:e,parent_id:f},function(k){var l=a.photos.getAlbum(),
m=k.data.album,p=k.data.counters;0>=m.status&&a.photos_dragndrop.privateDescendants(m.id)&&a.photos.dispatch("album/"+m.id+"/");l&&l.id==m.id&&((k=k.data.frontend_link)&&a("#photo-list-frontend-link").attr("href",k).text(k),m.type==Album.TYPE_DYNAMIC&&a.photos.load("?module=album&action=photos&id="+m.id,a.photos.onLoadPhotoList));m=a("#album-list");if(!a.isEmptyObject(p))for(var n in p)p.hasOwnProperty(n)&&m.find("li[rel="+n+"]").find(".count:first").text(p[n])},"json");f=b.parent("ul");e=f.children("li.dr[rel!="+
e+"]").length;var h=b.next();b.appendTo(g);h.appendTo(g);e||(f.parent("li").children("i").remove(),f.remove())}})},_scrolHelper:function(f){f=a("#helper");var g=f.data("scrollTop"),b=a(document).scrollTop();g=g?b-g:50;f.css("top",f.position().top+g+"px");f.data("scrollTop",b)},_dropAnimation:function(f,g){var b=[];f.each(function(){var e=a(this),h=e.offset(),k=e.clone().css({"z-index":10,position:"absolute",top:h.top,left:h.left}).insertAfter(e);e.css({opacity:0});b.push(e.hide(300).promise());b.push(k.animate({top:h.top,
left:h.left},300).promise().done(function(){a(this).remove()}))});a.when.apply(a,b).done(function(){"function"===typeof g&&g()})},_shiftToLeft:function(f){if("left"!==f.data("shifted")){var g=f.find(".p-wrapper");if(!g.length){var b=f.children();g=a("<div class='p-wrapper' style='position:relative;'></div>").appendTo(f);g.append(b)}g.stop().animate({left:-15},200);f.data("shifted","left")}},_shiftToRight:function(f){if("right"!==f.data("shifted")){var g=f.find(".p-wrapper");if(!g.length){var b=f.children();
g=a("<div class='p-wrapper' style='position:relative;'></div>").appendTo(f);g.append(b)}g.stop().animate({left:15},200);f.data("shifted","right")}},_shiftAtPlace:function(f){if(f.data("shifted")){var g=f.find(".p-wrapper");if(g.length){var b=g.children();g.stop().css({left:0});f.append(b);g.remove()}f.data("shifted","")}},_bindExtDragActivate:function(f,g){a(document).bind("mousemove.ext_drag_activate",function(b){a.photos_dragndrop._extDragActivate(b,f,g)})},_unbindExtDragActivate:function(){a(document).unbind("mousemove.ext_drag_activate")},
_activatePhotoListItem:function(){var f=a(this),g=c(),b=g?"drag-active":"drag-active-disabled";g&&a.photos_dragndrop._shiftToRight(f);f.hasClass("last")?a.photos_dragndrop._bindExtDragActivate(f,b):f.addClass(b)},_unactivatePhotoListItem:function(f){f=a(this);var g=c(),b=g?"drag-active":"drag-active-disabled",e=b+"-last";f.hasClass("last")&&a.photos_dragndrop._unbindExtDragActivate();f.removeClass(b+" "+e);g&&a.photos_dragndrop._shiftAtPlace(f)},_extDragActivate:function(f,g,b){var e=b+"-last";if(g.hasClass("last")){var h=
f.pageX;f=f.pageY;var k=g.width(),l=g.height(),m=g.position();"template-photo-thumbs"==a.photos.list_template?h>m.left+.5*k&&h<=m.left+k?(g.removeClass(b).addClass(e),a.photos_dragndrop._shiftToLeft(g)):h>m.left&&h<=m.left+.5*k?(g.removeClass(e).addClass(b),a.photos_dragndrop._shiftToRight(g)):a.photos_dragndrop._shiftAtPlace(g):"template-photo-descriptions"==a.photos.list_template&&(f>m.top+.5*l?g.removeClass(b).addClass(e):f>m.top&&g.removeClass(e).addClass(b));(f<m.top||f>m.top+l||h<m.left||h>
m.left+k)&&g.removeClass(b).removeClass(e)}else g.addClass(b)},_fixUiDraggable:function(f){if(f.is("#photo"))return f;"IMG"==f.get(0).tagName&&(f=f.parents("li:first"));return f},_extendJqueryUIDragAndDrop:function(){a.fn.liveDraggable=function(g){this.each(function(e,h){e=a(this);e.data("init_draggable")&&e.die("mouseover",e.data("init_draggable"))});var b;this.live("mouseover",b=function(){var e=a(this);e.data("init_draggable")||e.data("init_draggable",b).draggable(g)})};a.fn.liveDroppable=function(g){this.each(function(e,
h){e=a(this);e.data("init_droppable")&&e.die("mouseover",e.data("init_droppable"))});var b=function(){var e=a(this);e.data("init_droppable")||(e.data("init_droppable",b).droppable(g),e.mouseover())};b.call(this);this.die("mouseover",b).live("mouseover",b);this.live("mouseover",b)};var f=a.ui.intersect;a.ui.intersect=function(g,b,e){a(g.element).is("#photo")||"custom"!=e||(e="pointer");if("custom"!=e)return f.call(a.ui,g,b,e);e=b.offset.left;var h=b.offset.top;g=g.helper.position();return a.ui.isOver(g.top,
g.left+a.photos_dragndrop.helper_shift,h,e,b.proportions.height,b.proportions.width)}}}})(jQuery);(function(a){var c=function(d,f){var g=/[^\w\-\.:]/.test(d)?new Function(c.arg+",tmpl","var _e=tmpl.encode"+c.helper+",_s='"+d.replace(c.regexp,c.func)+"';return _s;"):c.cache[d]=c.cache[d]||c(c.load(d));return f?g(f,c):function(b){return g(b,c)}};c.cache={};c.load=function(d){var f=document.getElementById(d),g=/<\\\/(\w+)/g;!f&&console&&console.log("template with id="+d+" not found");return f?("textarea"==f.tagName.toLowerCase()?f.value:document.getElementById(d).innerHTML).replace(g,"</$1"):null};
c.regexp=/([\s'\\])(?![^%]*%\})|(?:\{%(=|#)([\s\S]+?)%\})|(\{%)|(%\})/g;c.func=function(d,f,g,b,e,h){if(f)return{"\n":"\\n","\r":"\\r","\t":"\\t"," ":" "}[d]||"\\"+d;if(g)return"="===g?"'+_e("+b+")+'":"'+("+b+"||'')+'";if(e)return"';";if(h)return"_s+='"};c.encReg=/[<>&"'\x00]/g;c.encMap={"<":"&lt;",">":"&gt;","&":"&amp;",'"':"&quot;","'":"&#39;"};c.encode=function(d){return String(d||"").replace(c.encReg,function(f){return c.encMap[f]||""})};c.arg="o";c.helper=",print=function(s,e){_s+=e&&(s||'')||_e(s);},include=function(s,d){_s+=tmpl(s,d);}";
"function"===typeof define&&define.amd?define(function(){return c}):a.tmpl=c})(this);(function(a){a.fn.inlineEditable=function(c,d){function f(){m(a(this))||a(this).addClass(n.placeholderClass).text(n.placeholder)}function g(){m(a(this))==n.placeholder&&a(this).text("").removeClass(n.placeholderClass)}function b(r){return a(r).val()?!1:(a(this).text(n.placeholder).addClass(n.placeholderClass),!0)}function e(){t="edit";this.id=this.id||(""+Math.random()).slice(2);var r=this.id+"-input",v=a("#"+r);if(!v.length){var x=q,A=x.after;a:switch(n.inputType){case "textarea":var w='<textarea id="'+
r+'" style="display:none;"></textarea>';break a;default:w='<input type="text" id="'+r+'" style="display:none;">'}A.call(x,w);v=a("#"+r)}k(v,q);n.placeholder&&m(a(this))==n.placeholder&&g.call(q);n.beforeMakeEditable.call(this,v);u=n.truncate?q.data("real_text"):m(q);v.val(u).show().focus();q.hide();a(n.editLink).hide();if(!p){r=[];var y=[];x=0;for(A=n.makeReadableBy.length;x<A;++x)w=n.makeReadableBy[x],"blur"==w&&v.blur(function(){"read"!=t&&h.call(this)}),"enter"==w&&r.push(13),"esc"==w&&r.push(27);
...
n.placeholder===this.text()?"":this.text();this.data("real_text",r);this.text(r.length<n.truncate-3?r:r.substr(0,n.truncate-3)+"...")}n.placeholder&&f.call(this);n.editLink&&a(n.editLink).click(function(){n.hold.call(q)||"edit"!=t&&e.call(q.get(0))});n.editOnItself&&this.click(function(){n.hold.call(q)||"edit"!=t&&e.call(this)});this.bind("editable",function(){n.hold.call(q)||"edit"!=t&&e.call(this)});this.bind("placeholder",function(v,x){x&&n.placeholder&&f.call(this);x||a(this).removeClass(n.placeholderClass)});
this.data("inited",!0)}}).call(this);return this}})(jQuery);(function(a){a.fn.activeMenu=function(c,d,f){if("string"==typeof c){if("disable"==c||"enable"==c)return a.isArray(d)||(d=[d]),this.find("li").each(function(){var e=a(this);~d.indexOf(e.attr("data-action"))&&("disable"==c?e.hide():e.show())}),this;if("setOption"==c){var g=this.data("activeMenuSettings");if(!g)return;if("string"===typeof d){var b={};b[d]=f;d=b}a.extend(g,d);return this}}if("string"==typeof c&&"fire"==c){g=this.data("activeMenuSettings");if(!g)return;g["on"+c.substr(0,1).toUpperCase()+
c.substr(1)].call(this);return this}this.data("activeMenuSettings",a.extend({beforeAnyAction:function(){},defaultAction:function(){},onInit:function(){},onFire:function(){}},c||{}));if(g=this.data("activeMenuSettings"))return function(){var e=this;this.data("inited")||(this.bind("click.photos-active-menu",function(h){for(var k=h.target,l=e.get(0);"LI"!=k.tagName;){if(k==l)return;k=a(k).parent().get(0)}k=a(k);l=k.attr("data-action")||"default";l=l.split("-");for(var m=1;m<l.length;m++)l[m]=l[m][0].toUpperCase()+
l[m].slice(1);l=l.join("");l+="Action";g[l]&&"function"==typeof g[l]||(l="defaultAction");if(!1!==g.beforeAnyAction(k.attr("data-action")))g[l](k,h);h.preventDefault()}),g.onInit(this),this.data("inited",!0))}.call(this),this}})(jQuery);(function(a){a.fn.rateWidget=function(c,d,f){function g(k){var l=0;this.find("i").removeClass("star star-empty star-half star-hover").addClass("star-empty").each(function(){if(l==k)return!1;l++;l>k?.5==l-k&&a(this).removeClass("star-empty").addClass("star-half"):a(this).removeClass("star-empty").addClass("star")});this.attr("data-rate",k)}function b(k){return function(){return k}}if("string"==typeof c){if("getOption"==c&&"rate"==d)return parseInt(this.attr("data-rate"));if("setOption"==c&&("rate"==
d&&(c=parseFloat(f)||0,g.call(this,Math.round(2*c)/2),d={rate:f}),"object"===typeof d&&d)){var e=this.data("rateWidgetSettings")||{};a.extend(e,d);"undefined"!==typeof d.hold&&"function"!==typeof d.hold&&(e.hold=b(e.hold))}return this}this.data("rateWidgetSettings",a.extend({onUpdate:function(){},rate:null,hold:!1,withClearAction:!0,alwaysUpdate:!1},c||{}));e=this.data("rateWidgetSettings");var h=this;"function"!==typeof e.hold&&(e.hold=b(e.hold));(function(){if(!this.data("inited")){null!=e.rate&&
...
l=a("#"+k));l.click(function(){if(!e.hold.call(h)){var p=h.attr("data-rate");g.call(h,0);if(0!=p)e.onUpdate(0)}});var m;h.parent().mousemove(function(){e.hold.call(h)||(m&&clearTimeout(m),l.show(0))}).mouseleave(function(){m=setTimeout(function(){e.hold.call(h)||l.hide(0)},150)})}this.data("inited",!0)}}).call(this);return this}})(jQuery);var PhotoStream=function(){var a=function(c){this._options=c||{};this._onClear=this._options.onClear||function(){};this._photo_stream=[]};$.extend(a.prototype,{getById:function(c){for(var d=0,f=this._photo_stream[0],g=this._photo_stream.length;d<g;f=this._photo_stream[++d])if(f&&f.id==c)return f;return null},updateById:function(c,d,f){if(c=this.getById(c))return $.extend(c,d),c;f&&this._photo_stream.push(d);return d},deleteById:function(c){$.isArray(c)||(c=[c]);var d=c,f=0,g=d.length;for(c=d[0];f<
g;c=d[++f])(c=this.getById(c))&&c.index&&delete this._photo_stream[c.index];d=[];var b=0;f=0;g=this._photo_stream.length;for(c=this._photo_stream[0];f<g;c=this._photo_stream[++f])c&&(c.index=b++,d.push(c));this._photo_stream=d;return this},replace:function(c,d){c=c.index;this._photo_stream[c]=d;d.index=c;return this},push:function(c){this._photo_stream.push(c);c.index=this._photo_stream.length-1;return this},getNext:function(c){c=c||this.current;"object"!=typeof c&&(c=this.getById(c));if(!c)return null;
...
getCurrent:function(){return this.current},getCurrentId:function(){return"object"===typeof this.current&&this.current?this.current.id:null},set:function(c){this._photo_stream=[];this.append(c);this.isEmpty()||this.setCurrent(this.getFirst());return this},append:function(c){for(var d=0,f=c[d],g=this._photo_stream.length,b=c.length;d<b;f=c[++d],++g)f.index=g,this._photo_stream.push(f);return this},prepend:function(c){var d=this._photo_stream||[];this._photo_stream=[];for(var f=0,g=c[f],b=c.length;f<
b;g=c[++f])g.index=f,this._photo_stream.push(g);this.append(d);return this},clear:function(){this._photo_stream=[];this._onClear();return this},length:function(){return this._photo_stream.length},getAll:function(){return this._photo_stream},getFirst:function(){return this._photo_stream[0]},getLast:function(){return this._photo_stream[this._photo_stream.length-1]},isFirst:function(c){return c&&0==c.index},isLast:function(c){return c&&c.index==this._photo_stream.length-1},isEmpty:function(){return!this._photo_stream.length},
getCurrentIndex:function(){return this.current.index},slice:function(c,d){return this._photo_stream.slice(c,d)},move:function(c,d){var f=[],g=this._photo_stream;if($.isArray(c))for(var b=0,e=c.length;b<e;++b){var h=this.getById(c[b]);delete g[h.index];f.push(h)}else h=this.getById(c),delete g[h.index],f.push(h);if(f.length)for(h="undefined"===typeof d||null===d?this._photo_stream.length:(h=this.getById(d))?h.index:0,Array.prototype.splice.apply(g,[h,0].concat(f)),this.clear(),b=f=0,e=g.length;b<e;++b)h=
g[b],"object"===typeof h&&h&&(h.index=f++,this._photo_stream.push(h))}});return a}();Date.parseISO=function(a){var c=Date.parse(a);if(!isNaN(c))return c;a=a.match(/([0-9]{4})-([0-9]{2})-([0-9]{2}) ([0-9]{2}):([0-9]{2}):([0-9]{2})/);c=new Date(a[1],0,1);a[2]&&c.setMonth(a[2]-1);a[3]&&c.setDate(a[3]);a[4]&&c.setHours(a[4]);a[5]&&c.setMinutes(a[5]);a[6]&&c.setSeconds(a[6]);return+c};
function replaceImg(a,c,d,f){f=f||a.attr("id")||(""+Math.random()).slice(2);replaceImg.loading_map=replaceImg.loading_map||{};replaceImg.loading_map[f]=c;a.unbind("load");null===d?a.attr("src",c):$("<img>").attr("src",c).load(function(){setTimeout(function(){replaceImg.loading_map[f]==c&&(a.attr("src",c),"function"==typeof d&&d.call(a));$(this).remove()},100)});return f}
String.prototype.truncate=function(a,c){var d="";if("undefined"===typeof c||c)d=this.replace(/<\/?[\s\S]+?\/?>/g,"");d.length>a-3&&3<a&&(d=d.substr(0,a-3)+"...");return d};function parseSize(a){var c="unknown";a=(""+a).split("x");var d=a[0]&&0!=a[0]?a[0]:null,f=a[1]&&0!=a[1]?a[1]:null;1==a.length?(c="max",f=d):d==f?c="crop":d&&f?c="rectangle":null===d?c="height":null===f&&(c="width");return{type:c,width:d,height:f}}
function getRealSizesOfThumb(a,c){var d=parseInt(a.width,10),f=parseInt(a.height,10),g=d/f,b=f/d;if(isNaN(g)||isNaN(b))return null;var e="object"!==typeof c?parseSize(c):c;var h=e.width;c=e.height;switch(e.type){case "max":d>f?(g=h,b*=g):(b=h,g*=b);break;case "crop":g=b=h;break;case "rectangle":g=h;b=c;break;case "width":g=h;b*=g;break;case "height":b=c;g*=b;break;default:g=b=null}g=Math.round(g);b=Math.round(b);return d<g&&f<b?{width:a.width,height:a.height}:{width:g,height:b}};(function(a){a.fn.photoStreamSlider=function(c){var d=a.extend({duration:200},c||{}),f=this;(function(){function g(u){function r(){g.execution=!1;var B="on"+v.charAt(0).toUpperCase()+v.slice(1);B=d[B];"function"==typeof B&&B.call(f);B=u.fn;"function"==typeof B&&B.call(f)}"string"==typeof u&&(u={direction:u,animate:!0});var v=u.direction||"forward",x=u.steps||e.length;if(!g.execution){g.execution=!0;var A=e.filter(":first").outerWidth()*x,w=e.length;if("forward"==v){var y=e.filter(":last").nextAll(":lt("+
x+")");x=y.length;y=y.filter(":last");x&&(e.removeClass("visible"),y.prevAll(":lt("+(w-1)+")").addClass("visible"),y.addClass("visible"))}else y=e.filter(":first").prevAll(":lt("+x+")"),x=y.length,y=y.filter(":last"),x&&(e.removeClass("visible"),y.nextAll(":lt("+(w-1)+")").addClass("visible").show(),y.addClass("visible"));e=a("li.visible",b);w=b.position().left;"forward"==v?(x=l-k-n,w-=A,w=w>-x?w:-x):(w+=A,w=w<n?w:n);u.animate?b.animate({left:w},d.duration,r):(b.css({left:w}),r())}}var b=f.find(d.photoStream),
e=a("li.visible",b),h=a("li",b),k=e.filter(":first").outerWidth()*e.length,l=h.filter(":first").outerWidth()*h.length,m=h.filter(":first").outerHeight();b.parent().css({overflow:"hidden",height:m,position:"relative",padding:"4px 0",margin:0,width:k});m=b.find("li:first");var p=e.filter(":first"),n=(p.outerWidth()-p.width())/2,q=0,t=m.outerWidth();for(p=p.get(0);m.length&&m.get(0)!=p;)q+=t,m=m.next();b.css({position:"absolute",left:-(q-n),width:l});a(d.forwardLink).click(function(){g("forward");return!1});
a(d.backwardLink).click(function(){g("backward");return!1});f.bind("append prepend",function(u,r){if("append"==u.type){for(var v=b.find("li:last"),x=a();v.hasClass("dummy");)x=x.add(v),v=v.prev("li");x.remove();b.append(r)}else{v=a("<div></div>").html(r);r=v.find("li");var A=r.length*t;v.remove();v=b.find("li:first");for(x=a();v.hasClass("dummy");)x=x.add(v),v=v.next("li");x.remove();b.prepend(r)}h=b.find("li");l=h.filter(":first").outerWidth()*h.length;b.css("width",l);"prepend"==u.type&&(b.is(":animated")&&
b.stop(!1,!0),b.css("left",parseInt(b.css("left"))-A));b.find("li.selected").hasClass("visible")&&f.trigger("home",[null,!1])});f.bind("forward backward",function(u,r){g({direction:u.type,steps:r.steps,animate:"undefined"!==typeof r.animate?r.animate:!0,fn:r.fn});r=b.find("li.selected");u="forward"==u.type?r.next("li:not(.dummy)"):r.prev("li:not(.dummy)");u.length&&(r.removeClass("selected"),u.addClass("selected"))});f.bind("home",function(u,r,v){u=parseInt(e.length/2);u=e.filter(":eq("+u+")");var x=
u.nextAll(".selected:first"),A=u.prevAll(".selected:first"),w=0,y="";"function"!==typeof r&&(v=r);v="undefined"!==typeof v?v:!0;x.length?(y="forward",u.nextAll().each(function(){++w;if(a(this).hasClass("selected"))return!1})):A.length&&(y="backward",u.prevAll().each(function(){++w;if(a(this).hasClass("selected"))return!1}));y&&w?g({direction:y,steps:w,fn:r,animate:v}):"function"==typeof r&&r();return!1})})()}})(jQuery);(function(a){a.storage=new a.store;a.photos={namespace:".photos",load_from_hash:0,hash:"",raw_hash:"",options:{},shift_next:!1,anchor:"",album:null,total_count:null,photos_per_page:null,list_template:"template-photo-thumbs",photo_list_string:{},init:function(c){"undefined"!=typeof a.History&&(a.History.bind(function(){a.photos.dispatch()}),a.History.unbind=function(d,f){f?a.History.handlers.specific[d]&&a.each(a.History.handlers.specific[d],function(g,b){if(b===f)return a.History.handlers.specific[d].splice(g,
1),!1}):(f=d,a.each(a.History.handlers.generic,function(g,b){if(b===f)return a.History.handlers.generic.splice(g,1),!1}))},a.History.one=function(d,f){f||(f=d,d=null);var g=function(){f.call(this);a.History.unbind.apply(a.History,d?[d,g]:[g])};a.History.bind.apply(a.History,d?[d,g]:[g])});a.wa.errorHandler=function(d){a.storage.del("photos/hash");return 403===d.status?(a("#content").html('<div class="content left'+a.photos_sidebar.width+'px"><div class="block double-padded">'+d.responseText+"</div></div>"),
!1):a.photos.load_from_hash?(a.wa.setHash("#/"),!1):!0};this.options=c;(c=window.location.hash||a.storage.get("photos/hash"))&&c!=window.location.hash?(this.load_from_hash=2,a.wa.setHash("#/"+c)):this.dispatch()},dispatch:function(c){if(a.photos.ignore_dispatch)a.photos.ignore_dispatch--;else if(a.photos.hash="",void 0==c&&(c=window.location.hash),c=c.replace(/^[^#]*#\/*/,""),a.photos.raw_hash=c)if(c=c.split("/"),c[0]){for(var d="",f=c.length,g=0;g<c.length;g++){var b=c[g];if(2>g)if(0===g)d=b;else if("tag"==
d||"search"==d||"plugins"==d||"pages"==d||"app"==d){f=g;break}else if(parseInt(b,10)!=b&&-1==b.indexOf("="))d+=b.substr(0,1).toUpperCase()+b.substr(1);else{f=g;break}else{f=g;break}}f=c.slice(f);a.photos.hash="/"+c.slice(0,2).join("/");~a.photos.hash.indexOf("photo")&&(a.photos.hash="");this.beforeAnyAction(d,f);this[d+"Action"]?(this.load_from_hash&&this.load_from_hash--,this[d+"Action"].apply(this,f),a.storage.set("photos/hash",a.photos.hash)):(a.storage.del("photos/hash"),console&&console.log("Invalid action name:",
d+"Action"))}else this.beforeAnyAction(),this.defaultAction();else this.beforeAnyAction(),this.defaultAction()},ignore_dispatch:0,forceHash:function(c){c!=window.location.hash&&(a.photos.ignore_dispatch=1,window.location.hash=c)},menu:{stack:{list:[],photo:[]},extend_stack:{list:[],photo:[]},register:function(c,d,f){this.stack[c]&&this.stack[c].push(new ToolbarMenu(d,f))},get:function(c,d){if(this.stack[c]&&a.isArray(this.stack[c]))for(var f=0;f<this.stack[c].length;f++)if(this.stack[c][f].is(d))return this.stack[c][f];
return null},init:function(c){var d;if(this.stack[c]){for(;d=this.extend_stack[c].shift();)for(var f=0;f<this.stack[c].length;f++)if(this.stack[c][f].is(d.selector)){for(var g in d.actions)this.stack[c][f].setAction(g,d.actions[g]);break}for(f=0;f<this.stack[c].length;f++)this.stack[c][f].init()}},enable:function(c,d,f){d=d||"*";if(this.stack[c])for(var g=0;g<this.stack[c].length;g++){var b=this.stack[c][g];d&&!b.is(d)||b.enable(f)}},disable:function(c,d,f){d=d||"*";if(this.stack[c])for(var g=0;g<
this.stack[c].length;g++){var b=this.stack[c][g];d&&!b.is(d)||b.disable(f)}},extend:function(c,d,f){this.stack[c]&&this.extend_stack[c].push({selector:d,actions:f});return this}},setOption:function(c,d){this.options[c]=d},getOption:function(c){return this.options[c]},beforeAnyAction:function(){},initClearance:function(){a.photos.toggleFullScreen();a.photos.highlightSidebarItem();a.photos.hotkey_manager.unset();a.photos.unsetLazyLoad();a.photos.photo_stream_cache.clear();a.photos.photo_stack_cache.clear();
...
a("#p-block .p-content-control li a.album-view").click(function(){var b=a(this).attr("data-action");b!=f&&(f=b.replace(/-view$/,""),a.photos.list_template="template-photo-"+f,a.photos.renderPhotoList(),a.photos.selectPhotoListView(f));return!1}),a("#photo-list .p-description div").live("click",function(){a(this);a(this).height();var b=$_("add description");a(this).inlineEditable({inputType:"textarea",makeReadableBy:["esc"],updateBy:["ctrl+enter"],placeholder:b,placeholderClass:"gray",minSize:{height:40},
...
else{var f=a.photos.photo_stream_cache.getById(d);f?(a.photos.setTitle(f.name_not_escaped),a.photos.loadPhotoCompletly(f)):(f=a.photos.photo_stack_cache.getById(d))?(a.photos.setTitle(f.name_not_escaped),a.photos.loadPhotoInStack(f)):a.photos.loadNewPhoto(d)}},loadPhotoInStack:function g(f){a.photos.abortPrevLoading();a.photos.hooks_manager.trigger("beforeLoadPhoto",f);a.photos.photo_stack_cache.setCurrent(f);var b=a.photos._chooseProperThumb(f);"object"===typeof b.size&&b.size&&a("#photo").width(b.size.width).height(b.size.height);
replaceImg(a("#photo"),f.thumb.url+(f.edit_datetime?"?"+Date.parseISO(f.edit_datetime):""),null);a.photos.setNextPhotoLink();b=a.post("?module=photo&action=load",{id:f.id,in_stack:1},function(e){e=e.data;var h=e.photo;h=a.photos.photo_stack_cache.updateById(h.id,h);e.photo=h;a.photos.updateViewChildPhoto(e);a.photos.hooks_manager.trigger("afterLoadPhoto",h);delete g.xhr},"json");g.xhr=b;a("#photo-name").html(f.name)},updateViewChildPhoto:function(f){var g=f.author,b=f.albums,e=f.exif;f=f.photo;a.photos.renderPhotoImg(f);
a("#photo-author").html(tmpl("template-photo-author",{photo:f,author:g}));a.photos.updatePhotoOriginalBlock(f);a("#photo-exif").html(tmpl("template-photo-exif",{exif:e}));a.photos.renderMap(e.GPSLatitude,e.GPSLongitude,f.name);a("#photo-albums").html(tmpl("template-photo-albums",{albums:b}));a.photos.initPhotoContentControlWidget({frontend_link_template:frontend_link_template,photo:f})},loadNewPhoto:function b(g){a.photos.initClearance();a.photos.widget.loupe.init();b.xhr_map=b.xhr_map||{};b.xhr_map[g]&&
b.xhr_map[g].abort();b.xhr_map[g]=a.post("?module=photo&action=load",{id:g,hash:a.photos.hash},function(e){b.xhr_map[g]=null;e=e.data;var h=e.photo;a.photos.renderViewPhoto(e);var k=a.photos.photo_stream_cache.getNext();k&&a.photos.preloadPhoto(k);e.album&&a.photos.setAlbum(e.album);a.photos.hooks_manager.trigger("afterLoadPhoto",h)},"json")},renderViewPhoto:function(g){var b=g.photo,e=g.author,h=g.exif,k=g.stack,l=g.albums,m=g.album,p=g.hooks,n=g.frontend_link_template;g=g.photo_stream;var q=g.in_collection,
t=!1;if(m&&!q){if(m.type==Album.TYPE_STATIC){a.photos.goToHash("album/"+m.id+"/");return}t=!0}a.photos.setTitle(b.name_not_escaped);a("#content").html(tmpl("template-p-block"));a.photos.initPhotoToolbar({photo:b,author:e,exif:h,stack:k});a.photos.renderPhotoBlock({photo:b,hash:a.photos.hash,albums:l,hooks:p,frontend_link_template:n});a.photos.initPhotoWidgets({photo:b,stack:k,exif:h,photo_stream:g,hash:a.photos.hash});a.photos.anchor?(a.photos.goToAnchor(a.photos.anchor),a.photos.anchor=""):a.photos.scrollTop();
a("#p-warning-not-in-album").hide();t?(a("#p-warning-not-in-album").show(),a.photos.setNextPhotoLink(a.photos.photo_stream_cache.getCurrent())):a.photos.setNextPhotoLink()},loadPhotoCompletly:function(g){a.photos.photo_stream_cache.setCurrent(g);a.photos.updatePhotoStreamWidget({shift:g.id,fn:function(){a.photos._loadPhotoCompletly(g)}})},_loadPhotoCompletly:function e(b){a.photos.abortPrevLoading();a.photos.hooks_manager.trigger("beforeLoadPhoto",b);a("#p-warning-not-in-album").hide();a.photos.setNextPhotoLink();
a.photos.updatePhotoName(b.name);a.photos.updatePhotoDescription(b.description);a.photos.updatePhotoRate(b.rate);a("#photo-frontend-url").html(b.url);a("#stack-stream").hide();a("#photo-hook-bottom").html("");var h=a.photos.isPhotoPreloaded(b);if(h)a.photos.renderPhotoImg(b);else{var k=a.photos._chooseProperThumb(b);"object"===typeof k.size&&k.size&&a("#photo").width(k.size.width).height(k.size.height);replaceImg(a("#photo"),b.thumb.url+(b.edit_datetime?"?"+Date.parseISO(b.edit_datetime):""),null)}a.photos.updatePhotoTags(b.tags);
(k=a.photos.photo_stream_cache.getNext())&&a.photos.preloadPhoto(k);b=a.post("?module=photo&action=load",{id:b.id},function(l){if("ok"==l.status){l=l.data;var m=l.album,p=l.photo,n=l.photo_stream.in_collection,q=!1;if(m&&!n){if(m.type==Album.TYPE_STATIC){a.photos.goToHash("album/"+m.id+"/");return}q=!0}q?(a("#p-warning-not-in-album").show(),a.photos.setNextPhotoLink(a.photos.photo_stream_cache.getCurrent())):a.photos.setNextPhotoLink();p=a.photos.photo_stream_cache.updateById(p.id,p);l.photo=p;a.photos.updateViewPhoto(l,
h);a.photos.hooks_manager.trigger("afterLoadPhoto",p);delete e.xhr}},"json");e.xhr=b},updateViewPhoto:function(b,e){var h=b.author,k=b.albums,l=b.exif,m=b.frontend_link_template,p=b.hooks,n=b.stack;b=b.photo;e||a.photos.renderPhotoImg(b);a.photos.updateViewPhotoMenu(0!=b.parent_id||0<b.stack_count,b.edit_rights);a.photos.updatePhotoName(b.name,b.edit_rights);a.photos.updatePhotoDescription(b.description,b.edit_rights);a.photos.updatePhotoRate(b.rate,b.edit_rights);a.photos.updatePhotoTags(b.tags);
a("#photo-author").html(tmpl("template-photo-author",{photo:b,author:h}));a.photos.updatePhotoOriginalBlock(b);a("#photo-exif").html(tmpl("template-photo-exif",{exif:l}));a.photos.renderMap(l.GPSLatitude,l.GPSLongitude,b.name);a("#photo-albums").html(tmpl("template-photo-albums",{albums:k}));a.photos.initPhotoContentControlWidget({frontend_link_template:m,photo:b});n?(a("#stack-stream").html(tmpl("template-photo-stack",{stack:n,photo_id:b.id,hash:a.photos.hash})).show(),a.photos.photo_stack_cache.set(n),
a.photos.initPhotoStackWidget()):a.photos.photo_stack_cache.clear();e="";for(var q in p.backend_photo)p.backend_photo[q].bottom&&(e+=p.backend_photo[q].bottom);a("#photo-hook-bottom").html(e);e="";for(q in p.backend_photo)p.backend_photo[q].after_rate&&(e+=p.backend_photo[q].after_rate);e&&(a("#photo-rate").nextAll().remove(),a("#photo-rate").after(e));a.photos.anchor&&(a.photos.goToAnchor(a.photos.anchor),a.photos.anchor="")},renderPhotoImg:function(b){var e=a.photos._chooseProperThumb(b);replaceImg(a("#photo"),
...
e){if("boolean"===typeof b||"undefined"===typeof b)e=b,b=null;var h=a("#photo-name");null!==b&&h.html(b);e?h.addClass("editable"):h.removeClass("editable")},updatePhotoDescription:function(b,e){if("boolean"===typeof b||"undefined"===typeof b)e=b,b=a("#photo-description").html();var h=a("#photo-description"),k=$_("add description");e?(h.addClass("editable"),e=k,a("#photo-description-edit-link").show()):(e=null,b=b!==k?b:"",h.removeClass("editable"),a("#photo-description-edit-link").hide());h.inlineEditable("setOption",
{placeholder:e}).html(b).trigger("placeholder",!!e)},updatePhotoRate:function(b,e){if("boolean"===typeof b||"undefined"===typeof b)e=b,b=null;var h=a("#photo-rate");null!==b&&h.rateWidget("setOption","rate",b);e?h.removeClass("hold").show():(h.addClass("hold"),(b=h.rateWidget("getOption","rate"))||h.hide())},updatePhotoTags:function(b){var e=a("#photo-tags");e.data("current_value",e.val());"undefined"!==typeof b&&("object"===typeof b&&b&&(b=a.photos.joinObject(b,",")),e.importTags(b))},updatePhotoFrontendUrl:function(b){var e=
a("#photo-frontend-url");b?(e.removeClass("hold"),a("#photo-frontend-url-edit-link").show()):(e.addClass("hold"),a("#photo-frontend-url-edit-link").hide())},updatePhotoOriginalBlock:function(b){a("#photo-original").html(tmpl("template-photo-original",{photo:b}))},initPhotoToolbar:function(b){a("#p-toolbar").html(tmpl("template-photo-toolbar",b)).addClass("rendered");a.photos.menu.init("photo");var e=a("#photos-photo-popular-tags");e.data("inited")||e.off("click.photos","a").on("click.photos","a",
function(){var h=a(this).text(),k=a("#photo-tags");k.removeTag(h);k.addTag(h)}).data("inited",!0);a.photos.updateViewPhotoMenu(a.isArray(b.stack)&&b.stack.length,b.photo.edit_rights)},renderPhotoBlock:function(b){var e=b.photo,h=a.photos._chooseProperThumb(e),k=e.thumb.size;"object"===typeof h.size&&h.size&&(e.thumb.size={width:h.size.width,height:h.size.height});a("#p-block").html(tmpl("template-photo",b)).addClass("rendered");"object"===typeof k&&k&&(e.thumb.size={width:k.width,height:k.height});
replaceImg(a("#photo"),h.url+(e.edit_datetime?"?"+Date.parseISO(e.edit_datetime):""),function(){a.photos.hooks_manager.trigger("afterRenderImg",this,e,h)})},initPhotoWidgets:function(b){var e=b.photo,h=b.exif,k=b.stack;b=b.photo_stream;var l=a.photos.hash;a.photos.initPhotoNameWidget(e.edit_rights);a.photos.initPhotoDescriptionWidget(e.edit_rights);a.photos.initPhotoRateWidget(e.edit_rights);a.photos.initPhotoTagsWidget(e.tags);a.photos.initPhotoContentControlWidget(e.edit_rights);a.photos.hotkey_manager.set();
a.photos.renderMap(h.GPSLatitude,h.GPSLongitude,e.name);a.isArray(k)&&k.length&&(a.photos.photo_stack_cache.set(k).setCurrentById(e.id),a.photos.initPhotoStackWidget({stack:k,photo_id:e.id,hash:a.photos.hash}));e=a.photos.photo_stream_cache;e.hash=l;e.set(b.photos).setCurrentById(b.current_photo_id);a.photos.initPhotoStreamWidget({photos:b.photos,current_photo:e.getCurrent()});a("#p-block .p-one-photo > .p-image-nav").click(function(){if(a(this).hasClass("p-rewind")){var m=a.photos.photo_stream_cache.getPrev();
m&&(a.photos.goToHash(a.photos.getHashByPhotoId(m.id),!1),a.photos.shift_next=!0)}else if(m=a.photos.photo_stream_cache.getNext())a.photos.goToHash(a.photos.getHashByPhotoId(m.id),!1),a.photos.shift_next=!0})},_chooseProperThumb:function(b){var e=b.thumb_big;b=b.thumb_middle;var h=a("#p-block").width();var k=e;"object"===typeof e.size&&e.size?(parseInt(e.size.height,10)>parseInt(b.bound.height,10)&&parseInt(e.size.height,10)>a(window).height()&&(k=b),parseInt(k.size.width,10)>h&&(k.size.height=Math.round(h/
parseInt(k.size.width,10)*parseInt(k.size.height,10)),k.size.width=h)):k.size={width:h,height:""};"object"===typeof k.size&&k.size||(k.size={widht:h,height:""});return k},setNextPhotoLink:function(b){var e=a("#photo").parents("a:first");(b=b?b:a.photos.photo_stream_cache.getNext())?(e.attr("title",$_("Next \u2192")),e.attr("href","#"+a.photos.hash+"/photo/"+b.id+"/")):(e.attr("title",""),e.attr("href","javascript:void(0);"))},setTitle:function(b){b&&(document.title=b+a.photos.options.title_suffix)},
ignore_scrolltop:!1,scrollTop:function(){a.photos.ignore_scrolltop?a.photos.ignore_scrolltop=!1:a(document).scrollTop(0)},load:function(b,e,h,k){var l=a("#content");"function"==typeof e&&(k=h||null);k&&(l.empty().append(k),l=l.find(":last-child"));"function"==typeof e?l.load(b,e):l.load(b,e,h)},setCover:function(){a.photos.centralizeLoadingIcon();a("#cover").show()},unsetCover:function(){a("#cover").hide()},centralizeLoadingIcon:function(){var b=a("#cover"),e=a("#cover .loading"),h=b.width(),k=e.width();
b=b.height();e=e.height();a(".loading").css({position:"absolute",left:parseInt((h-k)/2)+"px",top:parseInt((b-e)/2)+"px"})},saveField:function(b,e,h,k){var l="photo";1==arguments.length&&(l=a.extend({type:l,fn:function(){}},b),b=l.id,e=l.name,h=l.value,k=l.fn,l=l.type);if(!~["photo","album"].indexOf(l))throw"Unknown type";a.isArray(b)||(b=[{name:"id[]",value:parseInt(b)}]);var m=[].concat(b,{name:"name",value:e},{name:"value",value:h});a.post("?module="+l+"&action=saveField",m,function(p){if("ok"==
p.status){var n={};n[e]=h;p.data.parent_id&&(b=p.data.parent_id);a.photos._updateStreamCache(b,n);"function"==typeof k&&k(p)}else"fail"==p.status&&"function"==typeof k&&k(p)},"json")},saveFields:function(b,e,h){a.post("?module=photo&action=saveFields",{data:b},function(k){if("ok"==k.status)for(var l in k.data.update){var m=k.data.update[l].id;a.isArray(m)||(m=[m]);var p=k.data.update[l].data;l=0;for(var n=m.length;l<n;++l)a.photos.photo_stream_cache.updateById(m[l],p)}},"json")},_updateStreamCache:function(b,
e){a.isArray(b)||(b=[{value:b}]);for(var h=0,k=b.length;h<k;++h)a.photos.photo_stream_cache.updateById(b[h].value,e)},restoreOriginal:function(b,e){e=e||function(){};a.post("?module=photo&action=restore",{id:b},function(h){"ok"==h.status&&(h=h.data.photo,h=0==h.parent_id?a.photos.photo_stream_cache.updateById(b,h):a.photos.photo_stack_cache.updateById(b,h),a.photos.updatePhotoOriginalBlock(h),a.photos.updatePhotoImgs(h,e))},"json")},rotate:function(b,e,h){h=h||function(){};a.post("?module=photo&action=rotate",
{id:b,direction:e},function(k){"ok"==k.status&&(k=k.data.photo,k=0==k.parent_id?a.photos.photo_stream_cache.updateById(b,k):a.photos.photo_stack_cache.updateById(b,k),a.photos.updatePhotoOriginalBlock(k),a.photos.updatePhotoImgs(k,h))},"json").error(function(k){a.photos.showServerError(k.responseText);"function"==typeof h&&h()})},updatePhotoImgs:function(b,e){var h=a.photos._chooseProperThumb(b),k=b.edit_datetime?"?"+Date.parseISO(b.edit_datetime):"";replaceImg(a("#photo"),h.url+k,function(){a("#photo").width(h.size.width).height(h.size.height);
a("#photo-stream .selected img, #stack-stream .selected img").each(function(){var l=a(this);l.hasClass("thumb")?l.attr("src",b.thumb.url+k):l.attr("src",b.thumb_crop.url+k)});"function"==typeof e&&e();a.photos.hooks_manager.trigger("afterRenderImg",this,b,h)})},deletePhotos:function(b,e){a.post("?module=photo&action=resolution",a.isArray(b)?b:{photo_id:b},function(h){if("ok"==h.status){var k=h.data.photo_id;h=[];for(var l=[],m=0,p=k.length;m<p;++m)h.push({name:"photo_id[]",value:k[m]});a.photos.massPost({photo_id:h,
url:"?module=photo&action=delete",dataType:"json",data:{photos_length:a.isArray(b)?b.length:1},success:function(n,q){if("ok"==n.status){l=l.concat(n.data.denied_photo_id);n=0;for(var t=l.length;n<t;++n)q.push({name:"denied_photo_id[]",value:l[n]})}},fullSuccess:function(n){if("ok"==n.status)if(a.isArray(b)){n.data.alert_msg&&alert(n.data.alert_msg);var q={};a.each(k,function(r,v){q[v]=v});n.data.denied_photo_id&&n.data.denied_photo_id.length&&a.each(n.data.denied_photo_id,function(r,v){delete q[v]});
q=a.map(q,function(r,v){a.photos.photo_stream_cache.deleteById(k[r]);return v});a("#photo-list li.selected").trigger("select",!1);q.length?a.photos.makeDeleteAnimation(q,function(){e&&e(n)}):e&&e(n)}else{l.length&&alert($_("You don't have sufficient access rights"));if(n.data.parent_id){var t=a.photos.getHashByPhotoId(n.data.parent_id);a.photos.photo_stack_cache.deleteById(k)}else{var u=a.photos.photo_stream_cache;t=(t=u.getNext(b))?a.photos.getHashByPhotoId(t.id):u.hash;u.deleteById(k)}a.wa.setHash(t);
e&&e(n)}else e&&e(n)}})}},"json")},deleteAllAlbums:function(b,e,h){if(!b.length)return h&&h();var k=b.shift();a.photos.deleteAlbum(k,e,function(){a.photos.deleteAllAlbums(b,e,h)})},deleteAlbum:function(b,e,h){e?a.photos._deleteAlbumWithPhotos(b,h):a.post("?module=album&action=delete",{album_id:b},function(k){"ok"==k.status&&(a.photos.onDeleteAlbum(b),a.photos.goToHash(""),"function"==typeof h&&h())},"json")},_deleteAlbumWithPhotos:function(b,e){a.post("?module=photo&action=resolution",{album_id:b},
function(h){if("ok"==h.status){h=h.data.photo_id;for(var k=[],l=0,m=h.length;l<m;++l)k.push({name:"photo_id[]",value:h[l]});k.length?a.photos.massPost({url:"?module=photo&action=delete",photo_id:k,dataType:"json",fullSuccess:function(p){"ok"==p.status?a.photos.deleteAlbum(b,0,e):console&&console.log("Error while delete album")}}):a.photos.deleteAlbum(b,0,e)}},"json")},serializeData:function(b,e){if("object"===typeof b&&!a.isArray(b)&&"undefined"===typeof e){var h=[];for(e in b)b.hasOwnProperty(e)&&
h.push({name:e,value:b[e]});return h}a.isArray(b)||(b=[b]);h=0;for(var k=b.length,l=b[0];h<k;l=b[++h])"object"!=typeof l&&(l={name:e,value:l}),b[h]=l;return b},saveAccess:function(b){function e(m){for(var p=[],n=[],q=[],t=0,u=m.length;t<u;++t)p.push({name:"photo_id[]",value:m[t]});a.photos.massPost({photo_id:p,url:"?module=photo&action=manageAccessSave",dataType:"json",data:k,success:function(r,v){if("ok"==r.status){n=n.concat(r.data.denied_photo_id);for(var x=0,A=n.length;x<A;++x)v.push({name:"denied_photo_id[]",
value:n[x]});q=r.data.allowed_photo_id;x=0;for(A=q.length;x<A;++x)v.push({name:"allowed_photo_id[]",value:q[x]})}},fullSuccess:function(r){"ok"==r.status&&r.data.alert_msg&&onDeniedExist(r.data.alert_msg);"function"===typeof l&&l(r,q)}})}var h=b.photo_id||[],k=b.data||[],l=b.fn;onDeniedExist=b.onDeniedExist||function(m){alert(m)};resolution="boolean"===typeof b.resolution?b.resolution:!0;"object"!==typeof k||a.isArray(k)||(k=a.photos.serializeData(k));k.push({name:"photos_length",value:h.length});
resolution?a.post("?module=photo&action=resolution",a.isArray(h)?h:{photo_id:h},function(m){"ok"==m.status&&e(m.data.photo_id)},"json"):e(a.isArray(h)?h:[h])},addToAlbums:function(b){var e=b.photo_id||[],h=b.album_id||[],k=void 0==b.copy?1:b.copy,l=b.fn,m=b.onDeniedExist||function(p){alert(p)};e=a.photos.serializeData(e,"photo_id[]");h=a.photos.serializeData(h,"album_id[]");b=e.concat(h);b.push({name:"copy",value:+k});a.post("?module=photo&action=addToAlbums",b,function(p){if("ok"==p.status){for(var n=
[].concat(p.data.albums||[],p.data.old_albums||[]),q=0,t=n.length;q<t;++q){var u=n[q];a("#album-list li[rel="+u.id+"]").find(".count:first").text(u.count).end().find(".count-new:first").text(0<u.count_new?"+"+u.count_new:"")}p.data.alert_msg&&m(p.data.alert_msg)}"function"==typeof l&&l(p)},"json")},assignTags:function(b){var e=b.photo_id||[],h=b.tags||[],k=b.delete_tags||[],l=b.fn,m=b.onDeniedExist||function(p){alert(p)};b=[];b=a.isArray(e)?e:b.concat([{name:"photo_id[]",value:e},{name:"one_photo",
value:1}]);a.isArray(h)&&h.length?b=b.concat(h):(b.push({name:"tags",value:h}),k.length&&(b=b.concat(k)));a.post("?module=photo&action=assignTags",b,function(p){if("ok"==p.status){var n=p.data.cloud,q=a("#tag-cloud-block");a.isArray(n)&&!n.length||!n?q.hide():(a("#tag-cloud").html(tmpl("template-tag-cloud",{cloud:n})),q.show());n=p.data.tags||{};for(var t in n)n.hasOwnProperty(t)&&(q=n[t],a.photos._updateStreamCache(t,{tags:q}));a("#album-create-dialog").remove();p.data.alert_msg&&m(p.data.alert_msg)}"function"==
typeof l&&l(p)},"json")},makeStack:function(b,e){var h=b.shift();a.post("?module=photo&action=resolution",b,function(k){if("ok"==k.status){k=k.data.photo_id;for(var l=[],m=[],p=0,n=k.length;p<n;++p)k[p]!=h.value&&l.push({name:"photo_id[]",value:k[p]});a.photos.massPost({photo_id:l,data:{parent_id:h.value,photos_length:b.length},url:"?module=stack&action=make",dataType:"json",success:function(q,t){if("ok"==q.status&&"ok"==q.status){m=m.concat(q.data.denied_photo_ids);q=0;for(var u=m.length;q<u;++q)t.push({name:"denied_photo_id[]",
value:m[q]})}},fullSuccess:function(q){if("ok"==q.status){q.data.alert_msg&&alert(q.data.alert_msg);for(var t=0,u=b.length;t<u;++t)a.photos.photo_stream_cache.deleteById(b[t].value);a.photos.photo_stream_cache.updateById(q.data.parent_id,q.data.photo);a("#photo-list li.selected").trigger("select",!1);a.photos.makeStackAnimation([h].concat(b))}}})}},"json")},makeStackAnimation:function(b,e){var h=b[0].value,k=a('li[data-photo-id="'+h+'"]'),l=k.offset(),m=a(window);(l.top<m.scrollTop()||l.top>m.scrollTop()+
m.height())&&a("html, body").animate({scrollTop:l.top},300);m=[];for(var p=1;p<b.length;p++){var n=b[p].value,q=a('li[data-photo-id="'+n+'"]'),t=q.offset();t=q.clone().css({"z-index":10,position:"absolute",top:t.top,left:t.left}).insertAfter(q);q.css({opacity:0});m.push(q.hide(300).promise());a.photos.photo_stream_cache.deleteById(n);m.push(t.animate({top:l.top,left:l.left},300).promise().done(function(){a(this).remove()}))}a.when.apply(a,m).done(function(){var u=k.hasClass("last");k.replaceWith(tmpl(a.photos.list_template,
{photos:[a.photos.photo_stream_cache.getById(h)],hash:a.photos.hash,last_login_time:a.photos.options.last_login_time,options:{}}));u||a('li[data-photo-id="'+h+'"]').removeClass("last");a('li[data-photo-id="'+h+'"]').addClass("highlighted");"function"===typeof e&&e()})},makeDeleteAnimation:function(b,e){var h={};a.each(b,function(l,m){h[m]=!0});var k=a("#photo-list").children().filter(function(){return!!h[a(this).data("photo-id")]}).animate({width:0},function(){k.remove();e&&e()})},highlightSidebarItem:function(){var b=
decodeURIComponent(a.photos.hash);a("#p-sidebar li.selected").removeClass("selected");var e=a('#p-sidebar li a[href="#'+(b||"/")+'"]');e.length||(e=a('#p-sidebar li a[href^="#'+(b||"/")+'"]'));e.length&&e.parents("li:first").addClass("selected")},toggleFullScreen:function(){a.storage.get("photos/maximize_photo")?a("#wa-app").addClass("p-full-screen"):a("#wa-app").removeClass("p-full-screen")},hotkey_manager:function(){function b(m){var p=m.target.type;m=m.keyCode;if(!(b.hold||"text"==p||"textarea"==
p||37!=m&&39!=m)){if(39==m){if(p=a.photos.photo_stream_cache.getNext())a.photos.goToHash(a.photos.getHashByPhotoId(p.id),!1),a.photos.shift_next=!0;b.hold=!0}if(37==m){if(p=a.photos.photo_stream_cache.getPrev())a.photos.goToHash(a.photos.getHashByPhotoId(p.id),!1),a.photos.shift_next=!0;b.hold=!0}}}function e(m){b.hold=!1}function h(m){switch(m){case 48:case 96:m=0;break;case 49:case 97:m=1;break;case 50:case 98:m=2;break;case 51:case 99:m=3;break;case 52:case 100:m=4;break;case 53:case 101:m=5;break;
default:m=null}return m}function k(m){var p=m.target.type;if(!k.hold&&"text"!=p&&"textarea"!=p){var n=h(m.keyCode);"number"===typeof n&&(k.hold=!0,a("#photo").length?(m=a.photos.photo_stream_cache.getCurrent(),m.edit_rights&&a.photos.saveField(m.id,"rate",n,function(q){"ok"==q.status&&q.data.count&&(a("#rated-count").text(0<q.data.count?q.data.count:""),a("#photo-rate").rateWidget("setOption","rate",n))})):(m=a("input[name^=photo_id]").map(function(){return this.checked?{name:"id[]",value:this.value}:
null}).toArray(),m.length&&a.photos.saveField({id:m,name:"rate",value:n,fn:function(q){if("ok"==q.status){var t=q.data.allowed_photo_id&&!a.isArray(q.data.allowed_photo_id)?q.data.allowed_photo_id:{};a("#photo-list li.selected").each(function(){var u=a(this);t[u.attr("data-photo-id")]&&a.photos.updateThumbRate(u,n)}).find("input:first").trigger("select",!1);q.data.count&&a("#rated-count").text(0<q.data.count?q.data.count:"");q.data.alert_msg&&alert(q.data.alert_msg)}}})))}}function l(){k.hold=!1}
return{set:function(m){"undefined"===typeof m?a(document).bind("keydown",b).bind("keyup",e).bind("keydown",k).bind("keyup",l):"rate"===m&&a(document).bind("keydown",k).bind("keyup",l)},unset:function(){a(document).unbind("keydown",b).unbind("keyup",e).unbind("keyup",k).unbind("keyup",l)}}}(),getHashByPhotoId:function(b){return a.photos.hash+"/photo/"+b},setLazyLoad:function(){var b=null;a(window).lazyLoad({container:"#photo-list",load:function(){b=b||a("#photo-list li").length;a(window).lazyLoad("sleep");
a(".lazyloading-wrapper .lazyloading-progress").show();a(".lazyloading-wrapper .lazyloading-link").hide();a.post("?module=photo&action=loadList",{offset:b,hash:a.photos.hash},function(e){if(e.data.hash==a.photos.hash){var h=a("#photo-list");if(e.data.photos.length){var k=a.photos.photo_stream_cache.length();a.photos.photo_stream_cache.append(e.data.photos);h.find("li.last").removeClass("last");a.photos.renderPhotoListChunk(h,k,{string:e.data.string},function(){!a.photos.total_count||a.photos.total_count>
...
distance:5,tolerance:"pointer",stop:function(h,k){a.post("?module=album&action=move",{id:k.item.data("album-id"),before_id:k.item.next().data("album-id")||0,parent_id:e})}})},hooks_manager:{handlers:{},bind:function(b,e,h){if(1==arguments.length&&arguments[0]&&"object"===typeof arguments[0]){var k=arguments[0];for(b in k)k.hasOwnProperty(b)&&this.bind(b,k[b])}else return h=h||(""+Math.random()).slice(2),this.handlers[b]=this.handlers[b]||{},this.handlers[b][h]=e,e.handler_name=h},unbind:function(b,
e){var h=e;"undefined"===typeof e?this.handlers[b]={}:("function"===typeof e&&(h=e.handler_name),"function"===typeof this.handlers[b][h]&&delete this.handlers[b][h])},trigger:function(b){var e=this.handlers[b];if(e&&"object"===typeof e){var h=Array.prototype.slice.call(arguments,1),k;for(k in e)e.hasOwnProperty(k)&&"function"===typeof e[k]&&e[k].apply(null,h)}}}}})(jQuery);
...
(a=!1)})})();$("#photo-list li").live("select",function(a,c,d){d=void 0!==d?d:!0;(void 0!==c?c:1)?$(this).addClass("selected").find("input:first").attr("checked",!0):(a=$("#selector-menu").find('[data-action="select-photos"]'),a.data("checked")&&a.data("checked",!1).find(".unchecked").show().end().find(".checked").hide(),$(this).removeClass("selected").find("input:first").attr("checked",!1));d&&$("#share-menu-block, #organize-menu-block").trigger("recount")});(function(){function a(f,g,b){if(f&&g&&
f[0]&&g[0]&&!f.is(g[0])){var e=!1;g.parent().children().each(function(h,k){if(e){if(f.is(k)||g.is(k))return!1;h=$(k).find(".p-details input:checkbox");h.prop("checked")!=b&&h.prop("checked",b).change()}else if(f.is(k)||g.is(k))e=!0})}}var c=null,d=null;$("#content").on("click","#photo-list li .p-details input:checkbox, #photo-list li .p-details label",function(f){var g=$(this).closest("li"),b=g.find(".p-details input:checkbox");if(b.is(f.target))var e=b.prop("checked");else e=!b.prop("checked"),b.prop("checked",
e).change();e?(f.shiftKey&&c&&a(c,g,!0),c=g,d=null):(f.shiftKey&&d&&a(d,g,!1),c=null,d=g)})})();$("#content").off($.photos.namespace+"-photo-list-select-checkbox").on("change"+$.photos.namespace+"-photo-list-select-checkbox",':checkbox[name="photo_id[]"]',function(){this.checked?$(this).closest("li").addClass("selected"):$(this).closest("li").removeClass("selected");$("#share-menu-block, #organize-menu-block").trigger("recount")});$.photos.hooks_manager.bind("afterLoadPhoto",function(){$.photos.photo_stream_cache.getPrev()?
...
function ToolbarMenu(a,c){var d=null;return{init:function(){d=$(a);d.length&&d.activeMenu(c);return this},enable:function(f){f?d.activeMenu("enable",f):(d.parents("div:first").show(),d.activeMenu("fire"));return this},disable:function(f){f?d.activeMenu("disable",f):d.parents("div:first").hide();return this},setAction:function(f,g){c[f]=g;d&&d.activeMenu("setOption",f,g);return this},getAction:function(f){return c[f]},is:function(f){return d?d.is(f):$(a).is(f)}}};(function(a){a.photos.menu.register("list","#organize-menu",{addToAlbumAction:function(){var c=a("#choose-albums");c.length&&c.parent().remove();a("<div></div>").appendTo("body").load("?module=dialog&action=albums",function(){a("#choose-albums").waDialog({onLoad:function(){a(this).find("h1:first span:first").text("("+a("#photo-list li.selected").length+")")},onSubmit:function(d){var f=a("input[name^=photo_id]").serializeArray(),g=a(this).serializeArray();if(!g.length)return alert($_("Please select at least one album")),
!1;if(!f.length)return d.trigger("close"),!1;d.trigger("change_loading_status",!0);a.photos.addToAlbums({photo_id:f,album_id:g,copy:1,fn:function(){a("#photo-list li.selected").trigger("select",!1);d.trigger("change_loading_status",!1).trigger("close")}});return!1}})})},assignTagsAction:function(){var c=$_("add a tag");a("#photo-list-tags-dialog").waDialog({onLoad:function(){var d=a("#photo-list-tags-dialog #photos-list-tags");a("#photo-list-tags-dialog .tagsinput").length||d.tagsInput({autocomplete_url:"?module=tag&action=list",
height:200,width:"100%",defaultText:c});d.importTags("");a("#photo-list-tags-dialog .js-selected-counter").text("("+a("input[name^=photo_id]:checked").length+")");var f=[];a("input[name^=photo_id]:checked").each(function(){f.push(a(this).val())});for(var g={},b=a.photos.photo_stream_cache.getAll(),e=0,h=a.photos.photo_stream_cache.length();e<h;e++){var k=b[e];if(-1!=a.inArray(k.id,f)&&(k=k.tags,!a.isEmptyObject(k)))if(a.isEmptyObject(g))g=k;else for(var l in k)k.hasOwnProperty(l)&&(g[l]=k[l])}a("#photos-tags-remove-list").empty();
...
onSubmit:function(d){var f=a("#photos-list-tags_tag");if(f.length&&f.val()!=c){var g=jQuery.Event("keypress",{which:13});f.trigger(g)}f=a("input[name^=photo_id]:checked").serializeArray();g=a("#photo-list-tags-dialog #photos-list-tags").val();var b=a("#photos-tags-remove-list input[name^=delete_tags]:checked").serializeArray();if(!g.length&&!b.length)return alert($_("Please select at least one tag")),!1;if(!f.length)return d.trigger("close"),!1;d.trigger("change_loading_status",!0);a.photos.assignTags({photo_id:f,
tags:g,delete_tags:b,fn:function(e){if("ok"==e.status){e=e.data.tags;var h=a("#photo-list li.selected"),k;for(k in e)if(e.hasOwnProperty(k)){var l=tmpl("template-photo-list-photo-tags",{tags:e[k]});h.filter("[data-photo-id="+k+"]:first").find(".tags>span").html(l)}h.trigger("select",!1);d.trigger("change_loading_status",!1).trigger("close")}}});return!1}})},deleteFromAlbumAction:function(){var c=a("input[name^=photo_id]").serializeArray();if(c.length){var d=a.photos.getAlbum().id;a.post("?module=photo&action=deleteFromAlbum&id="+
...
className:"width300px height200px",onLoad:function(d){c.find(".p-rate-photo-counter").text("("+a("input[name^=photo_id]:checked").length+")");a("#photos-rate",d).rateWidget({withClearAction:!1,onUpdate:function(f){var g=c;f=a("#photos-rate",g).rateWidget("getOption","rate");var b=a("input[name^=photo_id]").map(function(){return this.checked?{name:"id[]",value:this.value}:null}).toArray();if(!b.length)return g.trigger("close"),!1;a.photos.saveField({id:b,name:"rate",value:f,fn:function(e){if("ok"==
e.status){var h=e.data.allowed_photo_id&&!a.isArray(e.data.allowed_photo_id)?e.data.allowed_photo_id:{};a("#photo-list li.selected").each(function(){var k=a(this);h[k.attr("data-photo-id")]&&a.photos.updateThumbRate(k,f)}).find("input:first").trigger("select",!1);e.data.count&&a("#rated-count").text(0<e.data.count?e.data.count:"");e.data.alert_msg&&alert(e.data.alert_msg);g.trigger("close")}}});return!1}})}})},makeStackAction:function(){var c=a("input[name^=photo_id]").serializeArray();if(2>c.length)return alert($_("Please select at least two photos")),
!1;a.photos.makeStack(c);return!1},manageAccessAction:function(){var c=a("input[name^=photo_id]").serializeArray();a.photos.showManageAccessDialog(c,function(d){var f=a(this),g=f.serializeArray(),b=f.find("input[name=status]:checked").val();if(!c.length)return d.trigger("close"),!1;d.trigger("change_loading_status",!0);a.photos.saveAccess({photo_id:c,data:g,fn:function(e,h){e=a("#photo-list li.selected");for(var k=0,l=h.length;k<l;++k){var m=e.filter("[data-photo-id="+h[k]+"]:first").find(".p-image-corner.top.left");
...
a(this).select()});c.find("input[name=link]").focus().select();c.find(".switcher").activeMenu({selectedPhotosAction:function(n){e.size=c.find("select[name=size]").val();e.photo_ids=f;h(e)},allListPhotosAction:function(n){e.size=c.find("select[name=size]").val();e.photo_ids="";h(e)}}).find("li").click(function(){a(this).parent().find(".selected").removeClass("selected").end().end().addClass("selected")});h.data=h.data||a.extend({},e);var p=c.find("select[name=domain]");p.length&&(k(),l(),p.change(l))},
onSubmit:function(){return!1}})});return!1},beforeAnyAction:function(c){if(!a.photos.isSelectedAnyPhoto()&&"blog-post"!=c&&"embed"!=c)return alert($_("Please select at least one photo")),!1},blogPostAction:function(){for(var c=a("#blog-post-form"),d=a("#photo-list li.selected").map(function(){return a(this).attr("data-photo-id")}).toArray(),f=[0,0],g=0;g<d.length;g++){var b=a.photos.photo_stream_cache.getById(d[g]);b||(b=a.photos.photo_stack_cache.getById(d[g]));b&&(b.hash&&(d[g]+=":"+b.hash),++f[b.status])}g=
a.photos.getAlbum();b=a.photos.hash;var e={photo_ids:d.join(","),hash:b,size:obligatory_size};g&&0>=g.status&&(b=b.replace(/\/*$/,"")+":"+g.hash+"/",e.hash=b);e.hash=null;a("#photo-blog-dialog :submit").attr("disabled",!0);a.post("?module=photo&action=embedList",e,function(h){"ok"==h.status&&(h=h.data.context,c.find('[name="title"]:input').val(a("#photo-list-name").text()),c.find('[name="text"]:input').val(blog_smarty_enabled?h.smarty_code:h.html_with_descriptions),f[0]?a("#photo-blog-dialog :submit").attr("disabled",
!1):c.submit())},"json");f[0]&&a("#photo-blog-dialog").waDialog({onLoad:function(){a("#photo-blog-dialog :submit").attr("disabled",!0);var h=a("#photo-blog-dialog p"),k=[f[0],d.length];h.html(h.html().replace(/(%d)/g,function(){return k.shift()}))},onSubmit:function(){c.submit();return!1}});return!1},onFire:function(){a("#share-menu").trigger("recount")}});a("#p-sidebar a, #wa-header a, a.album-view, #photo-list div.p-image a").live("click",function(c){if(a("#save-menu-block").is(":visible")&&a("#save-menu-block input.button").hasClass("yellow")&&
!confirm($_("Unsaved changes will be lost if you leave this page now. Are you sure?")))return c.preventDefault(),!1});a.photos.menu.register("list","#save-menu",{saveDescriptionAction:function(){var c={},d,f,g;a("#photo-list.p-descriptions :text,#photo-list.p-descriptions textarea").each(function(){if(this.defaultValue!=this.value&&(d=a(this).attr("name").match(/^photo\[(\d+)\]\[(\w+)\]$/))){f=d[1];g=d[2];var e=a.photos.photo_stream_cache.getById(f);e&&this.value==e[g]||(c[f]||(c[f]={id:f}),c[f][g]=
this.value)}});a.photos.saveFields(c);a("#photo-list.p-descriptions :text.highlighted,#photo-list.p-descriptions textarea.highlighted").each(function(){a(this).removeClass("highlighted")});var b=a("#save-menu-block .count.indicator");b.length&&(b.text(0),a("#save-menu-block input.button").removeClass("yellow").addClass("green"),b.hide());return!1},hideNameAction:function(c,d){var f=c.find(":checkbox"),g=f.prop("checked");"INPUT"!=d.target.tagName&&(g=!g);g?(a('#photo-list li :text[name$="[name]"]').hide(),
a('#photo-list li textarea[name$="[description]"].js-small').css("height","+=27").removeClass("js-small").addClass("js-big")):(a('#photo-list li :text[name$="[name]"]').show(),a('#photo-list li textarea[name$="[description]"].js-big').css("height","-=27").removeClass("js-big").addClass("js-small"));setTimeout(function(){f.attr("checked",g)},50);a.storage.set("photos/list/hide_name",g)},onFire:function(){var c=a("#save-menu-block .count.indicator");c.length&&(c.text("0"),a("#save-menu-block input.button").removeClass("yellow").addClass("green"),
c.hide())},onInit:function(c){c.find('[data-action="hide-name"] :checkbox').prop("checked",a.storage.get("photos/list/hide_name",!1));c=function(){var d=[],f;a("#photo-list.p-descriptions :text,#photo-list.p-descriptions textarea").each(function(){if(this.defaultValue!=this.value&&(f=a(this).attr("name").match(/^photo\[(\d+)\]\[(\w+)\]$/))){var e=f[1];if(0>d.indexOf(e)){var h=a.photos.photo_stream_cache.getById(e);h&&this.value==h[f[2]]?a(this).hasClass("highlighted")&&a(this).removeClass("highlighted"):
(a(this).addClass("highlighted"),d.push(e))}}else a(this).hasClass("highlighted")&&a(this).removeClass("highlighted")});var g=a("#save-menu-block .count.indicator"),b=d.length;g.length&&g.text(b);b?(a("#save-menu-block input.button").removeClass("green").addClass("yellow"),g.show()):(a("#save-menu-block input.button").removeClass("yellow").addClass("green"),g.hide())};a("#p-content").on("change.photos-save-menu","#photo-list.p-descriptions :text, #photo-list.p-descriptions textarea",c);a("#p-content").on("keyup.photos-save-menu",
"#photo-list.p-descriptions :text, #photo-list.p-descriptions textarea",c)}})})(jQuery);(function(a){a.photos.menu.register("photo","#photo-organize-menu",{addToAlbumAction:function(){a('<div id="choose-albums-photo"></div>').waDialog({url:"?module=dialog&action=albums&id="+a.photos.getPhotoId(),className:"width600px height400px",onSubmit:function(c){var d=a.photos.photo_stream_cache.getCurrent().id;a.photos.addToAlbums({photo_id:d,album_id:a(this).serializeArray(),copy:0,fn:function(f){if("ok"==f.status){var g=f.data.old_albums||[],b=a.photos.getAlbum();f=f.data.albums;if(b)for(var e=
0,h=g.length;e<h;++e)if(b.id==g[e].id){f.length?a.photos.goToHash("/album/"+f[0].id+"/photo/"+d):a.photos.goToHash("/photo/"+d);c.trigger("close");return}a("#photo-albums").html(tmpl("template-photo-albums",{albums:f}));c.trigger("close")}}});return!1}})},deletePhotoAction:function(){a.photos.confirmDialog({url:"?module=dialog&action=confirmDeletePhoto&id="+a.photos.getPhotoId(),onSubmit:function(c){c.trigger("close");a.photos.setCover();a.photos.deletePhotos(a.photos.getPhotoId(),function(){a.photos.unsetCover()});
return!1}})},unstackAction:function(){a.photos.confirmDialog({url:"?module=dialog&action=confirmUnstack&cnt="+a.photos.photo_stack_cache.length(),onSubmit:function(c){c.trigger("close");c=a.photos.photo_stream_cache.getCurrent().id;a.post("?module=stack&action=unmake&id="+c,{},function(d){a.photos.goToHash(a.photos.hash)},"json");return!1}})},manageAccessAction:function(){var c=a.photos.photo_stream_cache.getCurrent().id;a.photos.showManageAccessDialog("photo_id="+c,function(d){var f=a(this).serializeArray();
f.push({name:"one_photo",value:1});a.photos.saveAccess({photo_id:a.photos.photo_stream_cache.getCurrent().id,data:f,fn:function(g){var b=g.data.photo,e=g.data.stack;if(b)b=a.photos.photo_stream_cache.updateById(b.id,b),a.photos.initPhotoContentControlWidget({frontend_link_template:g.data.frontend_link_template,photo:b}),a.photos.updatePhotoImgs(b);else if(e&&a.isArray(e)&&e.length){b=a.photos.photo_stack_cache;for(var h=b.getCurrent(),k=0,l=e.length;k<l;++k)b.updateById(e[k].id,e[k]);a.photos.initPhotoContentControlWidget({frontend_link_template:g.data.frontend_link_template,
...
a.photos.menu.register("photo","#share-menu",{embedAction:function(){var c=a("#embed-photo-dialog"),d=a.photos.getPhotoId(),f=a.photos.hash,g=a.storage.get("photos/embed_size");d="?module=dialog&action=embedPhoto&photo_id="+d+"&hash="+f;g&&(d+="&size="+g);c.length||(c=a('<div id="embed-photo-dialog"></div>'),a("body").append(c));c.load(d,function(){c.find("div:first").waDialog({onLoad:function(){function b(){k.length&&a.each(["textarea[name=html]","input[name=url]"],function(l,m){l=a(m);l.data("context_data",
l.val())})}function e(){if(!k.length)return!1;a.each(["textarea[name=html]","input[name=url]"],function(m,p){m=a(p);m.val(m.data("context_data").split(k.data("original-domain")).join(k.val()))});var l=k.children(":selected");l.data("frontend-url")?(c.find("input[name=link]").val(l.data("frontend-url")).closest(".field").slideDown(),c.find("a.link").attr("href",l.data("frontend-url"))):c.find("input[name=link]").closest(".field").slideUp()}var h=c.find("select[name=size]");h.val(g);h.change(function(){var l=
...
$.photos.widget.loupe={options:{animate:!0,debug:!1},css:{init:{width:null,"max-width":null,"margin-left":0,"margin-top":0,height:null}},drag:!1,loaded:!1,photo_data:null,thumb_data:null,container:null,helper:null,link:null,offset:{},status:"thumb",init:function(a){this.options=$.extend(this.options,a||{});var c=this;c.trace("init");$.photos.hooks_manager.bind("afterRenderImg",function(d,f,g){c.trace("afterRenderImg");c.prepare(d,f,g)});$.photos.hooks_manager.bind("beforeLoadPhoto",function(){c.trace("beforeLoadPhoto");
c.stop()});$.photos.hooks_manager.bind("onAbortPrevLoading",function(){c.trace("onAbortPrevLoading");c.stop()})},trace:function(a){console&&this.options.debug&&console.log(a)},prepare:function(a,c,d){var f=this;$(".p-one-photo a.next").die("click.loupe").live("click.loupe",function(g){return f.clickNextHandler.apply(f,[this,g])});this.trace("prepare, status="+this.status);this.photo_data=c;this.container=a;this.thumb_data={height:d.size.height,width:d.size.width,src:d.url};"thumb"!=this.status&&this.stop();
...
break;case "mousedown":case "click":this.clickNextHandler(a,c);if(!this.drag){$("div.photo-loupe-wrapper").css("cursor","move");this.drag=!0;this.offset.mouseX=c.pageX;this.offset.mouseY=c.pageY;var f=this;d.bind("mouseover.loupe-move mousemove.loupe-move",function(g){return f.watch.apply(f,[this,g])})}break;case "mouseleave":this.drag&&(c.preventDefault(),$("div.photo-loupe-wrapper").css("cursor","auto"),this.drag=!1,d.unbind(".loupe-move"))}},enlarge:function(){this.drag=!1;var a=this;this.trace("enlarge, status="+
