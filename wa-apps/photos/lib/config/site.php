...
return array(
    ...
    'vars' => array(
        '$wa' => array(
            ...
            '$wa->photos->photos(<em>search_conditions</em>[,<em>size</em>])' => _w('Returns photo list array by search criteria, e.g. <em>"tag/vacations"</em>, <em>"album/12"</em>, <em>"id/1,5,7"</em>'),
        ),
        'album.html' => array(
