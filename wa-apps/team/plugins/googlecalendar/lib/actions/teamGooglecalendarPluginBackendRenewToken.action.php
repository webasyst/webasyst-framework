...
class teamGooglecalendarPluginBackendRenewTokenAction extends waViewAction
{
    public function execute()
    {
        ...
        /**
         * @var teamGooglecalendarPlugin $plugin
         */
        $plugin = teamCalendarExternalPlugin::factoryByCalendar($calendar);
        if (!$plugin || !($plugin instanceof teamGooglecalendarPlugin)) {
            $this->pluginNotFound();
        }
