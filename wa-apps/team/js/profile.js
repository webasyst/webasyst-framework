...
var Profile = ( function($) {
    ...
    Profile.prototype.initClass = function() {
        ...
        if (that.is_own_profile) {
            that.initWebasystIDAuth();
        }

        that.initWebasystIDShowAccountInfo();
        that.initWebasystIDUnbindAuth();
        that.initWebasystIDHelpLink();
    };

    Profile.prototype.initWebasystIDShowAccountInfo = function() {
        var that = this,
            $link = $('.js-show-webasyst-id-account-info'),
            $icon = $link.parent().find('.js-loading'),
            contact_id = that.user.id,
            wa_app_url = that.wa_app_url || '',
            is_loading = false;
    ...
    Profile.prototype.initWebasystIDAuth = function() {
        var that = this;
    ...
    Profile.prototype.initWebasystIDHelpLink = function() {
        var that = this;
    ...
    Profile.prototype.initWebasystIDUnbindAuth = function() {
                ...
                $.waDialog({
                    ...
                    onOpen: function($dialog) {
                        ...
                        $unbind_link.on('click', function () {
                            ...
                            $.post('?module=profile&action=waidUnbind', { id: contact_id })
                                .always(function () {
