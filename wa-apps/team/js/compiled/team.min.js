...
k)};else if(k.scrollDefault&&"function"!=typeof k.scrollDefault){var q=k.scrollDefault;k.scrollDefault=function(){return k.roundingFunction(B(q),k)}}else k.minTime&&(k.scrollDefault=function(){return k.roundingFunction(k.minTime,k)});if("string"===c.type(k.timeFormat)&&k.timeFormat.match(/[gh]/)&&(k._twelveHourTime=!0),!1===k.showOnFocus&&-1!=k.showOn.indexOf("focus")&&k.showOn.splice(k.showOn.indexOf("focus"),1),0<k.disableTimeRanges.length){for(var p in k.disableTimeRanges)k.disableTimeRanges[p]=
[B(k.disableTimeRanges[p][0]),B(k.disableTimeRanges[p][1])];k.disableTimeRanges=k.disableTimeRanges.sort(function(t,w){return t[0]-w[0]});for(p=k.disableTimeRanges.length-1;0<p;p--)k.disableTimeRanges[p][0]<=k.disableTimeRanges[p-1][1]&&(k.disableTimeRanges[p-1]=[Math.min(k.disableTimeRanges[p][0],k.disableTimeRanges[p-1][0]),Math.max(k.disableTimeRanges[p][1],k.disableTimeRanges[p-1][1])],k.disableTimeRanges.splice(p,1))}return k}function b(k){var q=k.data("timepicker-settings"),p=k.data("timepicker-list");
if(p&&p.length&&(p.remove(),k.data("timepicker-list",!1)),q.useSelect)var t=p=c("<select />",{"class":"ui-timepicker-select"});else p=c("<ul />",{"class":"ui-timepicker-list"}),t=c("<div />",{"class":"ui-timepicker-wrapper",tabindex:-1}),t.css({display:"none",position:"absolute"}).append(p);if(q.noneOption)if(!0===q.noneOption&&(q.noneOption=q.useSelect?"Time...":"None"),c.isArray(q.noneOption))for(var w in q.noneOption){if(parseInt(w,10)==w){var E=d(q.noneOption[w],q.useSelect);p.append(E)}}else E=
d(q.noneOption,q.useSelect),p.append(E);(q.className&&t.addClass(q.className),null===q.minTime&&null===q.durationTime||!q.showDuration)||("function"==typeof q.step?"function":q.step,t.addClass("ui-timepicker-with-duration"),t.addClass("ui-timepicker-step-"+q.step));E=q.minTime;"function"==typeof q.durationTime?E=B(q.durationTime()):null!==q.durationTime&&(E=q.durationTime);w=null!==q.minTime?q.minTime:0;var H=null!==q.maxTime?q.maxTime:w+G-1;w>H&&(H+=G);H===G-1&&"string"===c.type(q.timeFormat)&&q.show2400&&
(H=G);var L=q.disableTimeRanges,K=0,Q=L.length,N=q.step;"function"!=typeof N&&(N=function(){return q.step});for(var O=0;H>=w;O++,w+=60*N(O)){var J=w,M=D(J,q);if(q.useSelect)var I=c("<option />",{value:M});else I=c("<li />"),I.addClass(43200>J%86400?"ui-timepicker-am":"ui-timepicker-pm"),I.data("time",86400>=J?J:J%86400);I.text(M);if((null!==q.minTime||null!==q.durationTime)&&q.showDuration)if(M=A(w-E,q.step),q.useSelect)I.text(I.text()+" ("+M+")");else{var P=c("<span />",{"class":"ui-timepicker-duration"});
P.text(" ("+M+")");I.append(P)}Q>K&&(J>=L[K][1]&&(K+=1),L[K]&&J>=L[K][0]&&J<L[K][1]&&(q.useSelect?I.prop("disabled",!0):I.addClass("ui-timepicker-disabled")));p.append(I)}(t.data("timepicker-input",k),k.data("timepicker-list",t),q.useSelect)?(k.val()&&p.val(f(B(k.val()),q)),p.on("focus",function(){c(this).data("timepicker-input").trigger("showTimepicker")}),p.on("blur",function(){c(this).data("timepicker-input").trigger("hideTimepicker")}),p.on("change",function(){u(k,c(this).val(),"select")}),u(k,
p.val(),"initial"),k.hide().after(p)):(w=q.appendTo,"string"==typeof w?w=c(w):"function"==typeof w&&(w=w(k)),w.append(t),n(k,p),p.on("mousedown click","li",function(R){k.off("focus.timepicker");k.on("focus.timepicker-ie-hack",function(){k.off("focus.timepicker-ie-hack");k.on("focus.timepicker",F.show)});h(k)||k[0].focus();p.find("li").removeClass("ui-timepicker-selected");c(this).addClass("ui-timepicker-selected");C(k)&&(k.trigger("hideTimepicker"),p.on("mouseup.timepicker click.timepicker","li",
function(S){p.off("mouseup.timepicker click.timepicker");t.hide()}))}))}function d(k,q){var p,t,w;return"object"==typeof k?(p=k.label,t=k.className,w=k.value):"string"==typeof k?p=k:c.error("Invalid noneOption value"),q?c("<option />",{value:w,"class":t,text:p}):c("<li />",{"class":t,text:p}).data("time",String(w))}function f(k,q){return k=q.roundingFunction(k,q),null!==k?D(k,q):void 0}function g(k){k.target!=window&&(k=c(k.target),k.closest(".ui-timepicker-input").length||k.closest(".ui-timepicker-wrapper").length||
(F.hide(),c(document).unbind(".ui-timepicker"),c(window).unbind(".ui-timepicker")))}function h(k){k=k.data("timepicker-settings");return(window.navigator.msMaxTouchPoints||"ontouchstart"in document)&&k.disableTouchKeyboard}function m(k,q,p){if(!p&&0!==p)return!1;k=k.data("timepicker-settings");var t=!1;p=k.roundingFunction(p,k);return q.find("li").each(function(w,E){w=c(E);if("number"==typeof w.data("time"))return w.data("time")==p?(t=w,!1):void 0}),t}function n(k,q){q.find("li").removeClass("ui-timepicker-selected");
var p=B(r(k),k.data("timepicker-settings"));null!==p&&(k=m(k,q,p))&&(p=k.offset().top-q.offset().top,(p+k.outerHeight()>q.outerHeight()||0>p)&&q.scrollTop(q.scrollTop()+k.position().top-k.outerHeight()),k.addClass("ui-timepicker-selected"))}function l(k,q){if(""!==this.value&&"timepicker"!=q){var p=c(this);if(!p.is(":focus")||k&&"change"==k.type){k=p.data("timepicker-settings");var t=B(this.value,k);if(null===t)return void p.trigger("timeFormatError");var w=!1;if(null!==k.minTime&&null!==k.maxTime&&
(t<k.minTime||t>k.maxTime)&&(w=!0),c.each(k.disableTimeRanges,function(){return t>=this[0]&&t<this[1]?(w=!0,!1):void 0}),k.forceRoundTime){var E=k.roundingFunction(t,k);E!=t&&(t=E,q=null)}k=D(t,k);w?u(p,k,"error")&&p.trigger("timeRangeError"):u(p,k,q)}}}function r(k){return k.is("input")?k.val():k.data("ui-timepicker-value")}function u(k,q,p){if(k.is("input")){k.val(q);var t=k.data("timepicker-settings");t.useSelect&&"select"!=p&&"initial"!=p&&k.data("timepicker-list").val(f(B(q),t))}return k.data("ui-timepicker-value")!=
q?(k.data("ui-timepicker-value",q),"select"==p?k.trigger("selectTime").trigger("changeTime").trigger("change","timepicker"):-1==["error","initial"].indexOf(p)&&k.trigger("changeTime"),!0):(k.trigger("selectTime"),!1)}function v(k){switch(k.keyCode){case 13:case 9:break;default:k.preventDefault()}}function y(k){var q=c(this),p=q.data("timepicker-list");if(!p||!a(p)){if(40!=k.keyCode)return!0;F.show.call(q.get(0));p=q.data("timepicker-list");h(q)||q.focus()}switch(k.keyCode){case 13:return C(q)&&(l.call(q.get(0),
{type:"change"}),F.hide.apply(this)),k.preventDefault(),!1;case 38:var t=p.find(".ui-timepicker-selected");return t.length?t.is(":first-child")||(t.removeClass("ui-timepicker-selected"),t.prev().addClass("ui-timepicker-selected"),t.prev().position().top<t.outerHeight()&&p.scrollTop(p.scrollTop()-t.outerHeight())):(p.find("li").each(function(w,E){return 0<c(E).position().top?(t=c(E),!1):void 0}),t.addClass("ui-timepicker-selected")),!1;case 40:return t=p.find(".ui-timepicker-selected"),0===t.length?
(p.find("li").each(function(w,E){return 0<c(E).position().top?(t=c(E),!1):void 0}),t.addClass("ui-timepicker-selected")):t.is(":last-child")||(t.removeClass("ui-timepicker-selected"),t.next().addClass("ui-timepicker-selected"),t.next().position().top+2*t.outerHeight()>p.outerHeight()&&p.scrollTop(p.scrollTop()+t.outerHeight())),!1;case 27:p.find("li").removeClass("ui-timepicker-selected");F.hide();break;case 9:F.hide();break;default:return!0}}function x(k){var q=c(this),p=q.data("timepicker-list"),
t=q.data("timepicker-settings");if(!p||!a(p)||t.disableTextInput)return!0;switch(k.keyCode){case 96:case 97:case 98:case 99:case 100:case 101:case 102:case 103:case 104:case 105:case 48:case 49:case 50:case 51:case 52:case 53:case 54:case 55:case 56:case 57:case 65:case 77:case 80:case 186:case 8:case 46:t.typeaheadHighlight?n(q,p):p.hide()}}function C(k){var q=k.data("timepicker-settings"),p=null,t=k.data("timepicker-list").find(".ui-timepicker-selected");return t.hasClass("ui-timepicker-disabled")?
!1:(t.length&&(p=t.data("time")),null!==p&&("string"!=typeof p&&(p=D(p,q)),u(k,p,"select")),!0)}function A(k,q){k=Math.abs(k);var p,t;k=Math.round(k/60);var w=[];return 60>k?w=[k,z.mins]:(p=Math.floor(k/60),t=k%60,30==q&&30==t&&(p+=z.decimal+5),w.push(p),w.push(1==p?z.hr:z.hrs),30!=q&&t&&(w.push(t),w.push(z.mins))),w.join(" ")}function D(k,q){if("number"!=typeof k)return null;var p=parseInt(k%60),t=parseInt(k/60%60),w=parseInt(k/3600%24);w=new Date(1970,0,2,w,t,p,0);if(isNaN(w.getTime()))return null;
if("function"===c.type(q.timeFormat))return q.timeFormat(w);for(var E="",H=0;H<q.timeFormat.length;H++)switch(p=q.timeFormat.charAt(H)){case "a":E+=11<w.getHours()?z.pm:z.am;break;case "A":E+=11<w.getHours()?z.PM:z.AM;break;case "g":p=w.getHours()%12;E+=0===p?"12":p;break;case "G":p=w.getHours();k===G&&(p=q.show2400?24:0);E+=p;break;case "h":p=w.getHours()%12;0!==p&&10>p&&(p="0"+p);E+=0===p?"12":p;break;case "H":p=w.getHours();k===G&&(p=q.show2400?24:0);E+=9<p?p:"0"+p;break;case "i":t=w.getMinutes();
E+=9<t?t:"0"+t;break;case "s":p=w.getSeconds();E+=9<p?p:"0"+p;break;case "\\":H++;E+=q.timeFormat.charAt(H);break;default:E+=p}return E}function B(k,q){if(""===k||null===k)return null;if("object"==typeof k)return 3600*k.getHours()+60*k.getMinutes()+k.getSeconds();if("string"!=typeof k)return k;k=k.toLowerCase().replace(/[\s\.]/g,"");"a"!=k.slice(-1)&&"p"!=k.slice(-1)||(k+="m");var p="("+z.am.replace(".","")+"|"+z.pm.replace(".","")+"|"+z.AM.replace(".","")+"|"+z.PM.replace(".","")+")?",t=k.match(new RegExp("^"+
p+"([0-9]?[0-9])\\W?([0-5][0-9])?\\W?([0-5][0-9])?"+p+"$"));if(!t)return null;k=parseInt(1*t[2],10);if(24<k){if(q&&!1===q.wrapHours)return null;k%=24}p=t[1]||t[5];var w=k;12>=k&&p&&(w=p==z.pm||p==z.PM,w=12==k?w?12:0:k+(w?12:0));t=3600*w+60*(1*t[3]||0)+(1*t[4]||0);12>k&&!p&&q&&q._twelveHourTime&&q.scrollDefault&&(q=t-q.scrollDefault(),0>q&&q>=G/-2&&(t=(t+G/2)%G));return t}var G=86400,z={am:"am",pm:"pm",AM:"AM",PM:"PM",decimal:".",mins:"mins",hr:"hr",hrs:"hrs"},F={init:function(k){return this.each(function(){var q=
c(this),p=[],t;for(t in c.fn.timepicker.defaults)q.data(t)&&(p[t]=q.data(t));p=c.extend({},c.fn.timepicker.defaults,p,k);if(p.lang&&(z=c.extend(z,p.lang)),p=e(p),q.data("timepicker-settings",p),q.addClass("ui-timepicker-input"),p.useSelect)b(q);else{if(q.prop("autocomplete","off"),p.showOn)for(var w in p.showOn)q.on(p.showOn[w]+".timepicker",F.show);q.on("change.timepicker",l);q.on("keydown.timepicker",y);q.on("keyup.timepicker",x);p.disableTextInput&&q.on("keydown.timepicker",v);l.call(q.get(0),
null,"initial")}})},show:function(k){var q=c(this),p=q.data("timepicker-settings");if(k&&k.preventDefault(),p.useSelect)return void q.data("timepicker-list").focus();h(q)&&q.blur();k=q.data("timepicker-list");if(!q.prop("readonly")&&(k&&0!==k.length&&"function"!=typeof p.durationTime||(b(q),k=q.data("timepicker-list")),!a(k))){q.data("ui-timepicker-value",q.val());n(q,k);F.hide();k.show();var t={};p.orientation.match(/r/)?t.left=q.offset().left+q.outerWidth()-k.outerWidth()+parseInt(k.css("marginLeft").replace("px",
""),10):t.left=q.offset().left+parseInt(k.css("marginLeft").replace("px",""),10);"t"==(p.orientation.match(/t/)?"t":p.orientation.match(/b/)?"b":q.offset().top+q.outerHeight(!0)+k.outerHeight()>c(window).height()+c(window).scrollTop()?"t":"b")?(k.addClass("ui-timepicker-positioned-top"),t.top=q.offset().top-k.outerHeight()+parseInt(k.css("marginTop").replace("px",""),10)):(k.removeClass("ui-timepicker-positioned-top"),t.top=q.offset().top+q.outerHeight()+parseInt(k.css("marginTop").replace("px",""),
10));k.offset(t);t=k.find(".ui-timepicker-selected");if(!t.length){var w=B(r(q));null!==w?t=m(q,k,w):p.scrollDefault&&(t=m(q,k,p.scrollDefault()))}t&&t.length?(t=k.scrollTop()+t.position().top-t.outerHeight(),k.scrollTop(t)):k.scrollTop(0);return p.stopScrollPropagation&&c(document).on("wheel.ui-timepicker",".ui-timepicker-wrapper",function(E){E.preventDefault();var H=c(this).scrollTop();c(this).scrollTop(H+E.originalEvent.deltaY)}),c(document).on("touchstart.ui-timepicker mousedown.ui-timepicker",
g),c(window).on("resize.ui-timepicker",g),p.closeOnWindowScroll&&c(document).on("scroll.ui-timepicker",g),q.trigger("showTimepicker"),this}},hide:function(k){k=c(this);var q=k.data("timepicker-settings");return q&&q.useSelect&&k.blur(),c(".ui-timepicker-wrapper").each(function(){var p=c(this);if(a(p)){var t=p.data("timepicker-input"),w=t.data("timepicker-settings");w&&w.selectOnBlur&&C(t);p.hide();t.trigger("hideTimepicker")}}),this},option:function(k,q){return"string"==typeof k&&"undefined"==typeof q?
c(this).data("timepicker-settings")[k]:this.each(function(){var p=c(this),t=p.data("timepicker-settings"),w=p.data("timepicker-list");"object"==typeof k?t=c.extend(t,k):"string"==typeof k&&(t[k]=q);t=e(t);p.data("timepicker-settings",t);w&&(w.remove(),p.data("timepicker-list",!1));t.useSelect&&b(p)})},getSecondsFromMidnight:function(){return B(r(this))},getTime:function(k){var q=r(this);if(!q)return null;q=B(q);if(null===q)return null;k||(k=new Date);k=new Date(k);return k.setHours(q/3600),k.setMinutes(q%
3600/60),k.setSeconds(q%60),k.setMilliseconds(0),k},isVisible:function(){var k=this.data("timepicker-list");return!(!k||!a(k))},setTime:function(k){var q=this.data("timepicker-settings"),p=q.forceRoundTime?f(B(k),q):D(B(k),q);return k&&null===p&&q.noneOption&&(p=k),u(this,p),this.data("timepicker-list")&&n(this,this.data("timepicker-list")),this},remove:function(){if(this.hasClass("ui-timepicker-input")){var k=this.data("timepicker-settings");return this.removeAttr("autocomplete","off"),this.removeClass("ui-timepicker-input"),
...
className:null,closeOnWindowScroll:!1,disableTextInput:!1,disableTimeRanges:[],disableTouchKeyboard:!1,durationTime:null,forceRoundTime:!1,maxTime:null,minTime:null,noneOption:!1,orientation:"l",roundingFunction:function(k,q){if(null===k)return null;if("number"!=typeof q.step)return k;var p=k%(60*q.step);return p>=30*q.step?k+=60*q.step-p:k-=p,k==G&&q.show2400?k:k%G},scrollDefault:null,selectOnBlur:!1,show2400:!1,showDuration:!1,showOn:["click","focus"],showOnFocus:!0,step:30,stopScrollPropagation:!1,
...
"");e.initClass()})};Sidebar.prototype.showInviteDialog=function(a){a.preventDefault();var e=this;e.inviteDialog?e.inviteDialog.show():c.get(c.team.app_url+e.options.api.inviteDialog,function(b){e.inviteDialog=c.waDialog({html:b,onClose:function(d){d.hide();return!1}})})};Sidebar.prototype.showGroupDialog=function(a){a.preventDefault();var e=this,b=c(a.target).hasClass(e.options.classes.initGroupDialog)?"group":"location";e.groupDialog[b]?e.groupDialog[b].show():c.get(c.team.app_url+e.options.api.group,
{type:b},function(d){e.groupDialog[b]=c.waDialog({html:d,onOpen:function(f,g){g.$content.find(".js-edit-group-name").focus()},onClose:function(f){f.hide();return!1}})})};Sidebar.prototype.setCounts=function(){function a(g,h,m,n){var l=0<=g.indexOf(b.options.app_url),r=b.$wrapper.find('a[href="'+g+'"]');if(l&&r.length&&(m=h-m,!(0>m))){var u=c('<strong class="highlighted small js-sidebar-counter" style="height: fit-content;">+ '+m+"</strong>");l=r.find(".js-sidebar-counter");l.length?l.text("+ "+m):
r.append(u);r.one("click",function(v){v.preventDefault();u.remove();b.saveCount(g,h);b.options.link_count_update_date=n;c(document).one("wa_loaded",function(){b.options.link_count_update_date=!1})})}}function e(){var g=new Date,h=parseInt(g.getUTCDate()),m=parseInt(g.getUTCMonth())+1,n=parseInt(g.getUTCFullYear()),l=parseInt(g.getUTCHours()),r=parseInt(g.getUTCMinutes());g=parseInt(g.getUTCSeconds());return result={year:n,month:m,day:h,hours:l,minutes:r,seconds:g}}var b=this,d=function(){var g={},
h=b.$wrapper.find("li .js-count"),m=e();h.each(function(){var n=c(this),l=parseInt(n.text()),r=n.closest("li").find("> a");0<=l&&(b.options.counters[r.attr("href")]=n,g[r.attr("href")]={count:l,date:m})});return g}(),f=function(g){var h={};(g=localStorage.getItem(g))&&(h=JSON.parse(g));return h}(b.options.storage_count_name);b.options.storageCount=c.extend(!0,{},d);f&&c.each(f,function(g,h){var m=g in d&&0<=d[g].count&&d[g].count!==h.count;0<=h.count&&m&&(b.options.storageCount[g].count=h.count,b.options.storageCount[g].date=
h.date,a(g,d[g].count,h.count,h.date))});b.setStorage()};Sidebar.prototype.saveCount=function(a,e){a in this.options.storageCount&&(this.options.storageCount[a].count=e);this.setStorage()};Sidebar.prototype.updateCount=function(a,e){if(a&&(e||0===e)){var b=this.options.counters[a]||!1;this.saveCount(a,e);b.length?b.text(e):this.reload()}};Sidebar.prototype.setStorage=function(){localStorage.setItem(this.options.storage_count_name,JSON.stringify(this.options.storageCount))};Sidebar.prototype.initUpdater=
function(){var a=this;a.options.timer=setTimeout(function(){c.contains(document,a.$wrapper[0])&&a.reload(!0)},a.options.updateTime)};Sidebar.prototype.initSortable=function(){function a(g){var h=[];g.find("> li").each(function(){var m=c(this).data("group-id");m&&0<m&&h.push(m)});return h}function e(g,h){f&&(f.abort(),f=!1);f=c.post(g,h,function(){f=!1})}var b=this,d=c.team.app_url+b.options.api.sort,f=!1;1<b.$groups.length&&b.$groupsWrapper.sortable({animation:150,handle:"."+b.options.classes.drop,
direction:"vertical",onEnd:function(g){if(g.oldIndex!==g.newIndex){g=a(b.$groupsWrapper);var h=[];c.each(g,function(m,n){h.push({name:"groups[]",value:n})});e(d,h)}}});1<b.$locations.length&&b.$locationsWrapper.sortable({animation:150,handle:"."+b.options.classes.drop,direction:"vertical",onEnd:function(g){g.oldIndex!==g.newIndex&&(g=a(b.$locationsWrapper),e(d,{locations:g}))}})};Sidebar.prototype.initDroppable=function(){function a(d,f){d=parseInt(d.data("group-id"));var g=parseInt(f.data("user-id"));
f=c.team.app_url+e.options.api.moveUser;0<d&&0<g&&(d={user_id:g,group_id:d},b&&b.abort(),b=c.post(f,d,function(h){b=!1;"ok"!==h.status?console.warn(h):c.team.sidebar.reload()}))}var e=this,b=!1;e.$groups.each(function(){var d=c(this);d.hasClass(e.options.classes.drop)&&d.droppable({tolerance:"pointer",hoverClass:e.options.classes.highlighted,over:function(f,g){g.draggable.hasClass(e.options.classes.uiDraggable)||d.removeClass(e.options.classes.highlighted)},drop:function(f,g){a(c(this),g.draggable)}})});
e.$locations.each(function(){var d=c(this);d.hasClass(e.options.classes.drop)&&d.droppable({tolerance:"pointer",hoverClass:e.options.classes.highlighted,over:function(f,g){g.draggable.hasClass(e.options.classes.uiDraggable)||d.removeClass(e.options.classes.highlighted)},drop:function(f,g){a(c(this),g.draggable)}})})};Sidebar.prototype.showSearch=function(a){a.preventDefault();a=c(a.target).find(".t-search-field").val();a=encodeURIComponent(a);c.team.content.load(c.team.app_url+"search/"+a+"/");this.$wrapper.find(".sidebar-mobile-toggle").trigger("click")};
Sidebar.prototype.setSelected=function(a){switch(a.type){case "invited":var e=this.$body.find("[data-invited-item]");break;case "inactive":e=this.$body.find("[data-inactive-item]");break;case "search":e=this.$body.find("#all-users-sidebar-link");break;case "group":e=this.$body.find('[data-group-id="'+a.groupId+'"]')}this.setItem(c(e))};return Sidebar}(jQuery);var CalendarPage=function(c){var a=function(e){a=function(b){this.$wrapper=b.$wrapper;this.$monthSelect=this.$wrapper.find(".month");this.$yearSelect=this.$wrapper.find(".year");this.filters_href=b.filters_href;this.month=parseInt(this.$monthSelect.val());this.year=parseInt(this.$yearSelect.val());this.initClass()};a.prototype.initClass=function(){var b=this;b.$monthSelect.on("change",function(){var d=e(this).val();d&&(b.month=parseInt(d));b.useFilter();return!1});b.$yearSelect.on("change",function(){var d=
...
{week:this.end.week,day:this.end.day};this.end=e}this.createEvent();this.end=this.start=!1};TeamCalendar.prototype.initMove=function(){function e(n){n=d.getDayPosition(n);var l=d.daysArray[n.week-1][n.day-1];if(!l)return console&&console.log&&console.log("error: date is not exist"),!1;n=c.team.app_url+"?module=schedule&action=eventMove";l={id:parseInt(g.data("id")),start:l.data("date").replace(" 00:00:00","")};m&&m.abort();m=c.post(n,l,function(r){"ok"==r.status&&d.reload()},"json")}function b(n){var l=
f.offset(),r=[l.left,l.left+f.outerWidth()];l=[l.top,l.top+f.outerHeight()];d.clearSelection();if(n.pageX<=r[0]||n.pageX>=r[1]||n.pageY<=l[0]||n.pageY>=l[1])return!1;r=parseInt(g.data("day-count")||g.closest(".t-column").attr("colspan"));d.start=d.getDayPosition(n);n=d.daysArray;var u=d.start;l={week:u.week,day:u.day};u=7-u.day;--r;r<=u?l.day+=r:(l.week+=1,l.day=r-u,l.week>n.length&&(l={week:n.length,day:7}));d.end=l;d.markDays()}var d=this,f=d.$wrapper,g=!1,h=!1,m;f.find(".js-move-event").draggable({helper:"clone",
appendTo:"body",cursor:"move",zIndex:1100,cursorAt:{top:11,left:16},start:function(n,l){n=c(n.target);l=l.helper;g=n;var r=parseInt(g.closest(".t-column").attr("colspan")),u=n.data("move-hint")||!1;u&&l.find(".t-event-block").append("<span class='t-day-count'>("+u+")</span>");l.addClass("is-clone").css({minWidth:parseInt(n.width()/r)+"px",height:n.height()+"px"})},drag:function(n,l){h||(h=!0,setTimeout(function(){h=!1},100),b(n))},stop:function(n,l){d.clearSelection();g=!1}});f.droppable({drop:function(n){e(n)}})};
...
setTimeout(function(){f.removeAttr("style");e.is_locked=!1},200)}};EventEditDialog.prototype.save=function(a){var e=this;a=function(b){function d(n){var l=n.split("-");n=parseInt(l[0]);var r=parseInt(l[1]);l=parseInt(l[2]);return 0<n&&0<r&&0<l?new Date(n,r-1,l):!1}function f(n){e.$form.find(".state-error-hint").remove();c.each(n,function(l,r){l=e.$form.find("[name='"+r.field+"']");l.length&&(l.parent(".value").length?l.addClass(e.has_error_class).after('<span class="state-error-hint custom-mt-4">'+
e.locales[r.locale]+"</span>"):l.addClass(e.has_error_class).closest(".t-date-wrapper").append('<div class="state-error-hint custom-mt-4">'+e.locales[r.locale]+"</div>"))})}var g={},h=[];c.each(b,function(n,l){g[l.name]=l.value});g["data[summary_type]"]||(g["data[summary_type]"]="custom");if(b=e.is_status)g["data[description]"]=g["data[status_description]"]?g["data[status_description]"]:"",delete g["data[status_description]"],g["data[summary]"]=e.summary,delete g["data[status_summary]"];c.trim(g["data[summary]"]).length||
...
this.fieldValue));var d=this;b=(d.fieldData.parent_field||"").split(":");for(var f=a.fieldEditors[b.shift()];f&&b.length;){var g=f.subfieldEditors;if(g instanceof Array){f=null;for(var h=0;h<g.length;h++)if(g[h]===d.parentEditor){f=g[h];break}}else f=g[b.shift()]}if(f){var m=this.fieldData.options&&this.fieldData.options[this.fieldValue]||this.fieldValue,n=c('<input type="text" class="hidden val">').val(m),l=c('<select class="hidden val"></select>').hide(),r=function(){var u=c(this),v=n.is(":visible")?
n.val():l.is(":visible")?l.val():m;u=(u.val()||"").toLowerCase();if(u=d.fieldData.parent_options[u]){n.hide();l.show().children().remove();for(h=0;h<u.length;h++)l.append(c("<option></option>").attr("value",u[h]).text(u[h]).attr("selected",d.fieldValue==u[h]));l.val(v)}else n.val(v||"").show().blur(),l.hide()};setTimeout(function(){if(f.domElement){f.domElement.on("change",".val",r);var u=f.domElement.find(".val:visible");u.length&&r.call(u.get(0))}else n.show()},0);d.unbindEventHandlers=function(){r&&
f.domElement&&f.domElement.find(".val").unbind("change",r);d.unbindEventHandlers=function(){}};return c("<div></div>").append(n).append(l)}return c("<div></div>").append(c('<input type="text" class="val small width-100-mobile">').val(d.fieldValue))}});a.factoryTypes.Timezone=c.extend({},a.factoryTypes.Select,{notSet:function(){return $_("Auto")}});a.factoryTypes.Region=c.extend({},a.factoryTypes.Select,{notSet:function(){return""},unbindEventHandlers:function(){},setCurrentCountry:function(){var b=
...
this,m.find(".replace-me-with-value").replaceWith(c('<a href="javascript:void(0)" class="button rounded outlined small light-gray custom-mb-16"><i class="fas fa-plus"></i> '+$_("Add another")+"</a>").click(function(l){var r=d.subfieldFactory.createEditor(this.contactType);l=d.subfieldEditors.length;var u={value:r.getValue(),temp:!0};"undefined"!=typeof d.fieldData.ext&&(u.ext="");d.fieldValue[l]=u;d.subfieldEditors[l]=r;"null"!=d.currentMode&&r.setMode(d.currentMode);r=d.newSubFieldElement(b,l);r.data("subfieldEditor",
d.subfieldEditors[l]);r.prepend('<span class="sort sort-handler custom-mr-16 custom-mt-8 custom-mt-0-mobile"><i class="fas fa-grip-vertical text-light-gray"></i></span>');f.append(r);a.dialog.resize()})),h.append(m),this.fieldData.multi&&c.fn.sortable?h.find(".multifield-subfields").sortable({direction:"vertical",handle:".sort-handler",animation:150,onEnd:function(l){var r=0;c(l.item).closest(".multifield-subfields").find("[data-multifield-index]").each(function(){var u=c(this);d.subfieldEditors[r]=
u.parent().data("subfieldEditor");u.data("subfieldIndex",r).attr("data-multifield-index",r);r++})}}):console.log(["$.fn.sortable available?",!!c.fn.sortable]));g&&(h=a.wrapper(h,this.fieldData.name+"").attr("data-field-id",this.fieldData.id));return h},setMode:function(b,d){"undefined"==typeof d&&(d=!0);if("view"!=b&&"edit"!=b)throw Error("Unknown mode: "+b);if(this.currentMode!=b){if("view"==b&&"edit"==this.currentMode&&this.origFieldValue)this.setValue(this.origFieldValue);else if("view"==this.currentMode&&
...
b){if(!this.fieldValue.value)return null;var d="string"===typeof this.fieldValue.for_map?this.fieldValue.for_map:this.fieldValue.for_map.coords?this.fieldValue.for_map.coords:this.fieldValue.for_map.with_street;return d=c('<div class="address-field width-100-mobile"></div>').append('<span class="small">'+this.fieldValue.value+"</span>").append('<span style="display:none" class="replace-with-ext"></span> ').append('<a target="_blank" href="//maps.google.com/maps?q='+encodeURIComponent(d)+'&z=15" class="map-link small">'+
$_("map")+'<i class="fas fa-external-link-alt small custom-ml-4"></i></a>')}b=c('<div class="address-field width-100-mobile"></div>');b.append('<span style="display:none" class="replace-with-ext"></span>');for(d in this.subfieldEditors){var f=this.subfieldEditors[d],g=f.newInlineFieldElement("edit");f.domElement=g;"Hidden"!==f.fieldData.type?b.append(c('<div class="address-subfield custom-mt-12"></div>').append(g)):b.append(c('<div class="address-subfield"></div>').append(g));"Hidden"!==f.fieldData.type&&
(f=f.fieldData.name+(f.fieldData.required?" ("+$_("required")+")":""),g.find("input.val,textarea.val").attr("placeholder",f).attr("title",f).addClass("small width-100-mobile"))}return b}});a.factoryTypes.Birthday=c.extend({},a.baseFieldType,{newInlineFieldElement:function(b){this.fieldValue=this.fieldValue||{};if("view"==b&&!this.fieldValue.value)return null;var d=this.fieldValue.data||{};if("edit"==b){b=c('<div class="wa-select small"></div>');var f=c('<select class="val" data-part="day"><option data=""></option></select>'),
g=[].concat($jscomp.arrayFromIterable(Array(32).keys())).slice(1);g=$jscomp.makeIterator(g);for(var h=g.next();!h.done;h=g.next()){h=h.value;var m=c('<option data="'+h+'" value="'+h+'">'+h+"</option>");h===+d.day&&m.attr("selected",!0);f.append(m)}b.append(f);f=c('<div class="wa-select small"></div>');g=c('<select class="val" data-part="month"><option data=""></option></select>');h="January February March April May June July August September October November December".split(" ");m=$jscomp.makeIterator(h.entries());
for(var n=m.next();!n.done;n=m.next()){n=$jscomp.makeIterator(n.value);var l=n.next().value;n.next();n=l+1;l=$_(h[l]);l=c('<option data="'+n+'" value="'+n+'">'+l+"</option>");n===+d.month&&l.attr("selected",!0);g.append(l)}f.append(g);g=c('<input type="text" data-part="year" class="val small" style="min-width: 54px; width: 54px;" placeholder="'+$_("year")+'">');d.year&&g.val(d.year);d=c("<span></span>").append(b).append(" ").append(f).append(" ").append(g)}else d=c('<span class="val small"></span>').text(this.fieldValue.value);
return d},getValue:function(){var b=this.fieldValue;if("edit"==this.currentMode&&null!==this.domElement){var d=this.domElement.find(".val");0<d.length&&(b={value:{day:null,month:null,year:null}},d.each(function(){var f=c(this),g=f.data("part");b.value[g]=parseInt(f.val(),10)||null}))}return b},setValue:function(b){this.fieldValue=b;if("null"!=this.currentMode&&null!==this.domElement)if("edit"==this.currentMode)b&&b.data&&this.domElement.find(".val").each(function(){var f=c(this),g=f.data("part");
f.val(b.data[g]||"")});else{var d=this.fieldValue;"object"===typeof this.fieldValue&&this.fieldValue.value&&(d=this.fieldValue.value);this.domElement.find(".val").html(c.wa.encodeHTML(d))}}});a.factoryTypes.Date=c.extend({},a.factoryTypes.String,{initializeFactory:function(b,d){this.fieldData=b||{};this.options=d||{};this.fieldData.input_height=1},setValue:function(b){this.fieldValue=b;"null"!=this.currentMode&&null!==this.domElement&&("edit"==this.currentMode?this.domElement.find("input:text").datepicker("setDate",
this.fieldValue):this.domElement.find(".val").html(c.wa.encodeHTML(this.fieldValue)))},newInlineFieldElement:function(b){var d=a.factoryTypes.String.newInlineFieldElement.call(this,b);if("edit"==b){var f=this,g=d.addClass("state-with-inner-icon right").find("input:text").addClass("js-datepicker").removeClass("val"),h=c('<input type="hidden" class="val">').insertAfter(g);c('<span class="icon cursor-pointer js-datepicker-trigger"><i class="fas fa-calendar-alt"></i></span>').insertAfter(g);(function(m){g.datepicker?
m():c.wa.loadFiles([c.wa.contactEditor.wa_backend_url+"wa-content/js/jquery-ui/jquery.ui.core.min.js",c.wa.contactEditor.wa_backend_url+"wa-content/js/jquery-ui/jquery.ui.datepicker.min.js"]).then(m)})(function(){g.datepicker({altField:h,altFormat:"yy-mm-dd",dateFormat:f.fieldData.format,changeMonth:!0,changeYear:!0,shortYearCutoff:2,showOtherMonths:!0,selectOtherMonths:!0,stepMonths:2,numberOfMonths:2,beforeShow:function(m,n){setTimeout(function(){return n.dpDiv.css({"z-index":"1051"})})}});f.fieldValue&&
g.datepicker("setDate",f.fieldValue);(function(m){var n=null;g.keydown(function(){n&&clearTimeout(n);n=setTimeout(function(){m()},250)});g.change(m)})(function(){0>=c.trim(g.val()).length&&(g.datepicker("setDate",null),f.fieldValue=null)})});d.on("click",".js-datepicker-trigger",function(){g.trigger("focus")})}return d}});a.factoryTypes.IM=c.extend({},a.baseFieldType,{setValue:function(b){"undefined"==typeof b&&(b="");c.isPlainObject(b)?(this.fieldValue=b.data,this.viewValue=b.value):this.fieldValue=
this.viewValue=b;"null"!=this.currentMode&&this.domElement&&("edit"==this.currentMode?this.domElement.find("input.val").val(this.fieldValue):this.domElement.find(".val").html(this.viewValue))},newInlineFieldElement:function(b){if("view"==b&&!this.fieldValue)return null;"edit"==b?(b=c('<span class="width-100-mobile custom-mr-0-mobile"><input class="val small width-100-mobile" type="text"></span>'),b.find(".val").val(this.fieldValue)):b=c('<span class="val small custom-mt-12-mobile"></span>').html(this.viewValue);
return b}});a.factoryTypes.SocialNetwork=c.extend({},a.baseFieldType,{setValue:function(b){"undefined"==typeof b&&(b="");c.isPlainObject(b)?(this.fieldValue=b.data,this.viewValue=b.value):this.fieldValue=this.viewValue=b;"null"!=this.currentMode&&this.domElement&&("edit"==this.currentMode?this.domElement.find("input.val").val(this.fieldValue):this.domElement.find(".val").html(this.viewValue))},newInlineFieldElement:function(b){if("view"==b&&!this.fieldValue)return null;"edit"==b?(b=c('<span class="width-100-mobile custom-mr-0-mobile"><input class="val small width-100-mobile" type="text"></span>'),
b.find(".val").val(this.fieldValue)):b=c('<span class="val small nowrap custom-mt-12-mobile"></span>').html(this.viewValue);return b}});a.factoryTypes.Url=c.extend({},a.factoryTypes.IM,{validate:function(b){var d=c.trim(this.getValue());if(!b&&this.fieldData.required&&!d)return $_("This field is required.");if(!d)return null;/^(https?|ftp|gopher|telnet|file|notes|ms-help)/.test(d)||(d="http://"+d,this.setValue(d));b=/^(https?|ftp|gopher|telnet|file|notes|ms-help):((\/\/)|(\\\\))+[^`!\[\]{}'"<>\u00ab\u00bb\u201c\u201d\u2018\u2019\s]*$/i;
return!b.test(d)||/^(http|ftp)/.test(d.toLowerCase())&&(b=/^(https?|ftp):((\/\/)|(\\\\))+((?:[^`!()\[\]{};:'".,<>?\u00ab\u00bb\u201c\u201d\u2018\u2019\s+]+\.)+[^`!()\[\]{};:'".,<>?\u00ab\u00bb\u201c\u201d\u2018\u2019\s+]{2,6})((\/|\\|#)[^`!\[\]{}'"<>\u00ab\u00bb\u201c\u201d\u2018\u2019\s]*)?$/i,!b.test(d))?$_("Incorrect URL format."):null}});a.factoryTypes.Email=c.extend({},a.factoryTypes.Url,{validate:function(b){var d=c.trim(this.getValue());return b||!this.fieldData.required||d?d?/^([^@\s]+)@[^\s@]+\.[^\s@\.]{2,}$/i.test(d)?
null:$_("Incorrect email address format."):null:$_("This field is required.")}});a.factoryTypes.Checkbox=c.extend({},a.baseFieldType,{setValue:function(b){this.fieldValue=parseInt(b);"null"!=this.currentMode&&this.domElement&&("edit"==this.currentMode?this.domElement.find("input.val").attr("checked",!!this.fieldValue):this.domElement.find(".val").text(this.fieldValue?"Yes":"No"))},newInlineFieldElement:function(b){"edit"==b?(b=c('<label>\n                    <span class="wa-checkbox">\n                        <input class="val" type="checkbox" value="1" checked="checked">\n                        <span>\n                            <span class="icon">\n                                <i class="fas fa-check"></i>\n                            </span>\n                        </span>\n                    </span>\n                </label>'),
this.fieldValue||b.find(".val").removeAttr("checked")):b=c('<span class="val small"></span>').text(this.fieldValue?"Yes":"No");return b}});a.factoryTypes.Number=c.extend({},a.baseFieldType,{validate:function(b){var d=c.trim(this.getValue());return b||!this.fieldData.required||d||0===d?d&&!/^-?[0-9]+([\.,][0-9]+$)?/.test(d)?$_("Must be a number."):null:$_("This field is required.")}});return a.factoryTypes};c.wa.contactEditorFactory=function(a){a=c.extend({contact_id:null,current_user_id:null,contactType:"person",
baseFieldType:null,saveUrl:"?module=profile&action=save",saveGeocoordsUrl:"?module=contacts&action=saveGeocoords",regionsUrl:"?module=backend&action=regions&country=",el:"#contact-info-block",update_title:!0,dialog:{}},a);var e=c.extend({wa_app_url:"",fields:{},fieldsOrder:[],fieldsValues:{},factoryTypes:{},editorFactories:{},fieldEditors:{},initFactories:function(b,d){var f=this;this.fields=b;this.fieldsOrder=d;this.editorFactories={};this.fieldEditors={};this.fieldsOrder=c.each(d,function(g,h){try{if("object"!=
typeof b[h]||!b[h].type)throw Error("Field data error for "+h);if("undefined"==typeof f.factoryTypes[b[h].type])throw Error("Unknown factory type: "+b[h].type);f.editorFactories[h]=b[h].multi?c.extend({},f.factoryTypes.Multifield):c.extend({},f.factoryTypes[b[h].type]);f.editorFactories[h].initializeFactory(b[h]);return h}catch(m){console.log("Unable to init field "+h),console.log(m),b[h]=void 0,delete b[h]}}).filter(function(g){return!!g})},resetFieldEditors:function(){for(var b=0;b<this.fieldsOrder.length;b+=
1){var d=this.fieldsOrder[b];"undefined"==typeof this.fieldEditors[d]?this.fieldEditors[d]=this.editorFactories[d].createEditor(this.contactType,d):this.fieldEditors[d].reinit()}},initFieldEditors:function(b){if(!(b instanceof Array)){this.fieldsValues=b;for(var d=0;d<this.fieldsOrder.length;d+=1){var f=this.fieldsOrder[d];if("undefined"==typeof this.editorFactories[f]){c.wa.controller.contactAction([this.contact_id]);break}try{"undefined"==typeof this.fieldEditors[f]&&(this.fieldEditors[f]=this.editorFactories[f].createEditor(this.contactType)),
this.fieldEditors[f].setValue(b[f])}catch(g){console.log("Unable to initialize editor "+f),console.log(g)}}}},initContactInfoBlock:function(b){this.switchMode(b,!0)},getSaveUrl:function(){return this.saveUrl},getSaveGeocoordsUrl:function(){return c.wa.contactEditor.wa_backend_url+"?module=profile&action=saveGeocoords"},getRegionsUrl:function(){return c.wa.contactEditor.wa_backend_url+"?module=profile&action=regions&country="},switchMode:function(b,d){var f=c(this.el),g=this;d&&(f.html(""),f.removeClass("edit-mode view-mode"),
f.off("click.map",".map-link").on("click.map",".map-link",function(){var r=c(this).parent().data("multifield-index");void 0!==r&&g.geocodeAddress(g.fieldEditors.address.fieldValue,r)}));if("edit"!=b||!f.hasClass("edit-mode"))if("view"!=b||!f.hasClass("view-mode")){c(this).trigger("before_switch_mode",[b,this]);f.find(".buttons").remove();for(var h=[],m=0;m<this.fieldsOrder.length;m+=1){var n=this.fieldsOrder[m];h.push(n);try{var l=this.fieldEditors[n].setMode(b);c(this).trigger("set_mode",[{mode:b,
el:f,field_id:n,field:this.fieldEditors[n]}]);d&&f.append(l)}catch(r){console.log("Error initializing field",n,r)}}"edit"==b?(f.addClass("edit-mode"),f.removeClass("view-mode"),f.find(".subname").wrapAll('<div class="subname-wrapper fields-group custom-mt-0"></div>'),f.find(".jobtitle-company").wrapAll('<div class="jobtitle-company-wrapper fields-group"></div>'),d=this.inplaceEditorButtons(h,function(r){if("undefined"!=typeof r&&!r)return!1;if("undefined"!=typeof g.justCreated&&g.justCreated)throw r=
c("#all-users-sidebar-link .count"),r.text(1+parseInt(r.text())),Error("!!! Not implemented because never used. Redirect to contact_id="+g.contact_id);g.dialog.hide()}),null===g.contact_id&&d.find(".cancel").remove(),g.dialog.$body.find(".dialog-footer").append(d)):(f.addClass("view-mode"),f.removeClass("edit-mode"),f.find(".subname-wrapper").length&&f.find(".subname").unwrap(),f.find(".jobtitle-company-wrapper").length&&f.find(".jobtitle-company").unwrap());c(this).trigger("after_switch_mode",[b,
this])}},saveFields:function(b,d){function f(y,x,C){if(C)for(var A=0;A<C.length;A+=1){if(y[C[A]]&&x[C[A]]&&y[C[A]]!=x[C[A]])return!1}else{for(A in y)if(y.hasOwnProperty(A)&&y[A]&&x[A]&&y[A]!=x[A])return!1;for(A in x)if(x.hasOwnProperty(A)&&y[A]&&x[A]&&y[A]!=x[A])return!1}return!0}function g(y){y=void 0===y?!0:y;c.post(l.getSaveUrl(),{data:JSON.stringify(n),type:l.contactType,id:null!=l.contact_id?l.contact_id:0},function(x){if("ok"!=x.status)throw new Exception("AJAX error:",x);var C=l.fieldsValues||
{};x=x.data;var A=null;x.data&&x.data.top&&(A=x.data.top);x.data.top=void 0;delete x.data.top;null!=l.contact_id&&l.initFieldEditors(x.data);var D=!1,B;for(B in l.fieldEditors)if("undefined"!=typeof x.errors[B]){if(l.fieldEditors[B].showValidationErrors(x.errors[B]),!D)for(D=l.fieldEditors[B].domElement;!D.is(":visible");)D=D.parent()}else"edit"==l.fieldEditors[B].currentMode&&l.fieldEditors[B].showValidationErrors(null);D||(l.contact_id&&x.data.reload?window.profileTab?window.profileTab.rootWindow.location.reload():
window.location.reload():(null===l.contact_id&&(l.justCreated=!0),l.contact_id=x.data.id,!D&&y&&h(C,x),d(!D),D||(c(e).trigger("contact_saved",x.data),A&&c(e).trigger("top_fields_updated",{data:A}),c.team.content.reload(!0))))},"json")}function h(y,x){var C=c.storage.get("contacts/last_geocoding")||0;if(3600<(new Date).getTime()-C&&(c.storage.del("contacts/last_geocoding"),x=x.data.address,!c.isEmptyObject(x))){var A=[],D=[];for(C=0;C<x.length;C+=1){var B=!0;n.address[C]&&(B=!f(x[C].data,(y.address[C]||
{}).data||{},["city","country","region","street","zip"]));B&&(A.push(l.sendGeocodeRequest(x[C].for_map)),D.push(C))}if(A.length){var G=function(z,F){if("OK"===z.status){var k=z.lng||"";n.address[F].value.lat=z.lat||"";n.address[F].value.lng=k}else"OVER_QUERY_LIMIT"===z.status&&c.storage.set("contacts/last_geocoding",(new Date).getTime()/1E3)};c.when.apply(c,A).then(function(){if(1>=A.length&&"success"===arguments[1])G(arguments[0],D[0]);else for(var z=0;z<arguments.length;z+=1)"success"===arguments[z][1]&&
G(arguments[z][0],D[z]);g(!1)})}}}if(!b){b=[];for(var m in this.fields)this.fields.hasOwnProperty(m)&&b.push(m)}var n={},l=this;m=!1;for(var r=0;r<b.length;r++){var u=b[r],v=this.fieldEditors[u].validate();if(v){if(!m)for(m=this.fieldEditors[u].domElement;!m.is(":visible");)m=m.parent();this.fieldEditors[u].showValidationErrors(v)}else this.fieldEditors[u].showValidationErrors(null);n[u]=this.fieldEditors[u].getValue()}m?d(!1):g(!0)},createExtSelect:function(b,d){var f="",g=!0,h;for(h in b){var m=
"";if(b[h]===d||h===d)m=' selected="selected"',g=!1;var n=this.htmlentities(b[h]);f+='<option value="'+("undefined"===typeof b.length?h:n)+'"'+m+">"+n+"</option>"}if(g){f+='<option value="%custom" selected="selected">'+$_("other")+"...</option>";var l='<input type="text" class="shorter small ext width-100-mobile custom-mt-12-mobile">'}else f+='<option value="%custom">'+$_("other")+"...</option>",l='<input type="text" class="shorter small empty ext width-100-mobile custom-mt-12-mobile">';f=c('<div class="wa-select small width-100-mobile custom-mr-12 custom-mt-12-mobile"><select class="ext">'+
f+'</select></div><span class="width-100-mobile custom-mr-12 custom-mr-0-mobile">'+l+"</span>");var r=f.children("select");l=f.find("input");l.val(d);"%custom"!==r.val()&&l.hide();d=$_("which?");var u=function(){l.val()||l.hasClass("empty")||(l.val(d),l.addClass("empty"))};l.blur(u);l.focus(function(){l.hasClass("empty")&&(l.val(""),l.removeClass("empty"))});r.change(function(){var v=r.val();"%custom"===v?(l.hasClass("empty")&&l.val(d),l.show()):(l.hide(),l.addClass("empty"),l.val(v||""));u()});l[0].getExtValue=
function(){return"%custom"===r.val()&&l.hasClass("empty")?"":l.val()};l[0].setExtValue=function(v){b[v]?r.val(v):r.val("%custom");l.val(v)};return f},inplaceEditorButtons:function(b,d){var f=c('<div class="field buttons"><div class="value"><p class="state-error-hint custom-mt-8" id="validation-notice"></p></div></div>'),g=this,h=function(){c(".buttons .loading").show();g.saveFields(b,function(l){c(".buttons .loading").hide();d(l)});return!1};c("#tc-contact").off("keyup.contact_save").on("keyup.contact_save",
'#contact-info-block.edit-mode input[type="text"]',function(l){13!=l.keyCode||c(l.currentTarget).data("autocomplete")&&c(l.currentTarget).data("contact_id")||h()});var m=c('<input type="submit" class="button" value="'+$_("Save")+'" />').click(h);g=this;var n=c('<a href="javascript:void(0)" class="cancel button light-gray js-close-dialog">'+$_("Cancel")+"</a>");n.on("click",function(l){l.preventDefault();c(".buttons .loading").hide();g.fieldEditors.name.showValidationErrors(null)});f.children(".value").append(m).append(n).append(c('<i class="fas fa-spinner fa-spin loading custom-ml-16 wa-animation-spin speed-1000" style="display: none;"></i>'));
return f},destroy:function(){c(this.el).html("")},dialogInstance:function(b){this.dialog=b},wrapper:function(b,d,f){f=c('<div class="field'+("undefined"!=typeof f&&f?" "+f:"")+'"></div>');"undefined"!=typeof d&&d&&(c(this).on("set_mode",function(g,h){"Checkbox"===h.field.fieldData.type?h.field.domElement.find(".name").toggleClass("for-checkbox","edit"==h.mode):h.field.domElement.find(".name").toggleClass("for-input","edit"==h.mode)}),f.append('<div class="name'+(c(this.el).closest(".dialog-content").length?
" for-input":"")+'">'+c.wa.encodeHTML(d)+"</div>"));if("object"!=typeof b||!(b instanceof jQuery)||0>=b.find("div.value").size())b=c('<div class="value custom-mb-12"></div>').append(b);f.append(b);return f},htmlentities:function(b){var d=document.createElement("div");b=document.createTextNode(b);d.appendChild(b);return d.innerHTML},geocodeAddress:function(b,d){var f=this;b[d].data.lat&&b[d].data.lng||this.sendGeocodeRequest(b[d].for_map||b[d].value,function(g){b[d].data.lat=g.lat;b[d].data.lng=g.lng;
c.post(f.getSaveGeocoordsUrl(),{id:f.contact_id,lat:g.lat,lng:g.lng,sort:d})})},sendGeocodeRequest:function(b,d){var f=[];"string"===typeof b?f.push(b):b.with_street&&b.without_street&&b.with_street===b.without_street?f.push(b.with_street):(b.with_street&&f.push(b.with_street),b.without_street&&f.push(b.without_street));var g=c.Deferred();b=this.geocoding||{};var h=function(n){c.ajax({url:"https://maps.googleapis.com/maps/api/geocode/json",data:{sensor:!1,key:n,address:f[0]},dataType:"json",success:function(l){if(l)if("OK"===
l.status){for(var r=l.results.length,u=!1,v=0;v<r;v+=1)if(!l.results[v].partial_match){var y=l.results[v].geometry.location.lat||"";var x=l.results[v].geometry.location.lng||"";d instanceof Function&&d({lat:y,lng:x});u=!0;break}u||(y=l.results[0].geometry.location.lat||"",x=l.results[0].geometry.location.lng||"",d instanceof Function&&d({lat:y,lng:x}));g.resolve([{lat:y,lng:x,status:l.status},"success"])}else g.resolve([{status:l.status},"success"]);else g.resolve([{status:"FAIL"},"error"])},error:function(l){g.resolve([{status:l.status},
"error"])}})},m=function(n){c.ajax({url:"https://geocode-maps.yandex.ru/1.x/?format=json",data:{apikey:n,geocode:f[0]},dataType:"json",success:function(l){var r,u;l.response&&l.response.GeoObjectCollection&&l.response.GeoObjectCollection.featureMember?(c.each(l.response.GeoObjectCollection.featureMember,function(v,y){if(y.GeoObject&&y.GeoObject.Point&&y.GeoObject.Point.pos&&"string"===typeof y.GeoObject.Point.pos&&(v=y.GeoObject.Point.pos.split(" "),2===v.length))return u=v[0],r=v[1],d instanceof
Function&&d({lat:r,lng:u}),g.resolve([{lat:r,lng:u,status:"OK"},"success"]),!1}),r&&u||g.resolve([{status:"FAIL"},"error"])):g.resolve([{status:"FAIL"},"error"])},error:function(l){g.resolve([{status:"FAIL"},"error"])}})};"google"===b.type&&b.key?h(b.key):"yandex"===b.type&&b.key?m(b.key):g.resolve([{geocoding:b},"error"]);return g},initCheckboxList:function(b){b=c(b);var d=function(f,g){f=c(g||this);f.is(":checked")?f.parent().addClass("access-highlighted"):f.parent().removeClass("access-highlighted")};
b.find('input[type="checkbox"]').click(d).each(d);return b}},a);c.wa.fieldTypesFactory(e);return e};c.wa.contactEditor=c.wa.contactEditorFactory()})(jQuery);var AccessPage=function(c){var a=function(b){a=function(d){this.$wrapper=d.$wrapper;this.$accessWrapper=this.$wrapper.find(".t-access-wrapper");this.$accessSlider=this.$wrapper.find(".t-access-slider");this.$headerApps=this.$wrapper.find(".t-header-apps");this.$headerList=this.$headerApps.find(".t-apps-list");this.$apps=this.$headerList.find(".t-app-item");this.item_count=this.$apps.length;this.type_class=!1;this.items_left=this.left=0;this.item_w=this.access_slider_w=this.access_wrapper_w=!1;this.initClass()};
...
a(document).trigger("team_access_level_changed",{app_id:d.app_id,contact_id:d.contact_id,prev_level:h,new_level:f});d.active_access_id=f;d.noticeToggle.success();d.is_locked=!1;d.teamDialog.close()})};return e}(c);window.ProfileAccessTab=function(a){function e(){c(".js-webasyst-id-auth").on("click",function(l){l.preventDefault();c("body").trigger("wa_webasyst_id_auth")})}function b(l,r){if(c.fn.iButton){var u=c(".basic-user-fields"),v=c(".js-block-user-reason-form");v.on("click",".js-block-user-cancel",
function(){v.hide()});v.on("submit",function(C){C.preventDefault();c.waDialog.confirm({title:'<i class="fas fa-exclamation-triangle smaller state-error"></i> '+y.data("alert"),success_button_title:n.blockUser||"Ok",success_button_class:"danger",cancel_button_title:n.cancel,cancel_button_class:"light-gray",onSuccess:function(){var A=v.find(".js-block-user-reason");A=c.trim(A.val());c(".c-shown-on-enabled").hide();var D=x.parent().find(".loading").show();c.post(h+"?module=accessSave&action=ban&id="+
g,{magic_word:"please",text:A},function(B){D.hide();v.hide();"ok"===B.status&&(u.addClass("gray"),c(".c-shown-on-disabled").show(),c("#tc-user-access-disabled").show().html(B.data.access_disable_msg),c.team.sidebar.reload())},"json")}})});var y=c("#c-access-link-block");y.on("click",function(C){C.preventDefault();v.show()});var x=c("#c-access-link-unblock").on("click",function(C){C.preventDefault();c.waDialog.confirm({title:'<i class="fas fa-exclamation-triangle smaller state-error"></i> '+x.data("alert"),
success_button_title:n.unblockUser||"Ok",success_button_class:"danger",cancel_button_title:n.cancel,cancel_button_class:"light-gray",onOpen:function(A,D){console.log(A,D)},onSuccess:function(){c(".c-shown-on-disabled").hide();var A=x.parent().find(".loading").show();c.post(h+"?module=accessSave&action=unban&id="+g,{magic_word:"please"},function(){A.hide();u.removeClass("gray");c(".c-shown-on-enabled").show();c("#tc-user-access-disabled").hide().html("");c(".t-sidebar-profile-dialog").data("dialog").resize();
c.team.sidebar.reload()})}})})}else c.ajax({cache:!0,dataType:"script",url:l+"wa-content/js/jquery-plugins/ibutton/jquery.ibutton.min.js?"+r,success:function(){b(l,r)}})}var d=a.login,f=a.password,g=a.contact_id,h=a.wa_app_url,m=a.url_change_api_token,n=a.loc;(function(){var l=c("#form-customize-groups");l.length&&(c("#open-customize-groups").on("click",function(r){r.preventDefault();c(this).hide();c("#form-customize-groups").toggle()}),c("#cancel-customize-groups").on("click",function(r){r.preventDefault();
r=c("#form-customize-groups").hide();c("#open-customize-groups").show();r.find(".loading").hide();r.find(".state-error-hint").remove()}),l.submit(function(){var r=c(this);r.find(".state-error-hint").remove();r.find(".loading").show();c.post(r.attr("action"),r.serialize(),function(u){if("ok"==u.status){try{c.team.sidebar.reload();c.team.content.reload();r.find(".loading").hide();r.hide();var v=c.team.profile.$profile_header_links.find('[data-section-id="access"]:first').attr("data-url"),y=r.closest(".dialog").data("dialog");
y.$content.css({position:"relative",overflow:"hidden"}).append('<div class="js-reload-spinner" style="position:absolute;top:0;bottom:0;left:0;right:0;display:grid;place-items:center;background:var(--background-color-blank);"><span class="spinner custom-p-16"></span></div>');c.post(v,{userId:c.team.profile.user.id},function(x){y.$content.css("overflow","auto").empty().html(x)}).always(function(){y.$content.css("overflow","auto").find(".js-reload-spinner").remove()})}catch(x){}window.hasOwnProperty("profileTab")&&
window.profileTab.reload()}else"fail"==u.status&&r.find(".c-checkbox-menu-container").after(c('<span class="state-error-hint">'+u.errors.join("<br />")+"</span>"))},"json");return!1}))})();(function(){c("#c-credentials-form").submit(function(){var l=c(this);l.find("input.state-error").removeClass("error");l.find(".state-error-hint").remove();var r=l.find(".c-login-input"),u=c.trim(r.val());if(!u)return r.addClass("error").after('<p class="state-error-hint custom-mt-4">'+n["Login is required"]+"</p>"),
!1;r=l.serializeArray();"1"===c("#c-access-rights-toggle").val()&&(r=r.concat([{name:"set_rights",value:"1"},{name:"app_id",value:"webasyst"},{name:"name",value:"backend"},{name:"value",value:1}]));c.post(l.attr("action"),r,function(v){if("ok"===v.status){l.hide();d=u;c("#c-login-block").show().find(".c-login-input").val(d).end().find(".c-login").text(d);try{c.team.sidebar.reload()}catch(y){}try{window.profileTab.reload()}catch(y){}}else"fail"===v.status&&l.find('input[type="submit"]').parent().prepend(c('<p class="state-error-hint custom-mt-4 custom-mb-8">'+
v.errors.join("<br>")+"</p>"))},"json");return!1}).find(".cancel").click(function(l){l.preventDefault();c("#c-credentials-block").hide();return!1})})();(function(){var l=c("#c-login-form"),r=l.find(".c-login-input");l.submit(function(){l.find("input.state-error").removeClass("error");l.find(".state-error-hint").remove();var u=c.trim(r.val());if(d===u)return!1;if(!u)return r.addClass("error").after('<p class="state-error-hint custom-mt-4">'+n["Login is required."]+"</p>"),!1;l.find(".loading").show();
c.post(l.attr("action"),l.serialize(),function(v){l.find(".loading").hide();if("ok"===v.status){c("#c-login-block").show();r.val(u);l.find(".c-login").text(u);l.find(".c-one-tab").show();l.find(".c-two-tab").hide();if(!d)try{window.profileTab.reload()}catch(y){}d=u}else"fail"===v.status&&l.find('input[type="submit"]').parent().prepend(c('<p class="state-error-hint custom-mt-4 custom-mb-8">'+v.errors.join("\n<br>\n")+"</p>"))},"json");return!1});l.find(".c-tab-toggle").click(function(u){u.preventDefault();
l.find(".c-one-tab,.c-two-tab").toggle();r.is(":visible")&&r.focus();return!1})})();(function(){var l=c("#c-password-form"),r=l.find(".c-password-input"),u=l.find(".c-confirm-password-input");l.submit(function(){l.find("input.state-error").removeClass("error");l.find(".state-error-hint").remove();if(r.val()!==u.val())return r.addClass("error"),u.after().after('<p class="state-error-hint custom-mt-4">'+n["Passwords do not match."]+"</p>"),!1;l.find(".loading").show();c.post(l.attr("action"),l.serialize(),
function(v){l.find(".loading").hide();"ok"===v.status?(f=!0,r.val(""),u.val(""),l.find(".c-one-tab").show(),l.find(".c-two-tab").hide(),c("#c-password-block").show()):"fail"===v.status&&u.after('<p class="state-error-hint custom-mt-4">'+v.errors.join("<br />")+"</p>")},"json");return!1});l.find(".c-tab-toggle").click(function(v){v.preventDefault();l.find(".c-one-tab,.c-two-tab").toggle();v=l.find(".c-password-input");v.is(":visible")&&v.focus();return!1})})();(function(){var l=c("#tc-api-tokens-filed"),
r=l.find(".js-api-tokens-list"),u=!1;l.on("click",".js-remove-api-token",function(v){v.preventDefault();var y=c(this).parents(".js-token-item"),x=y.find(".icon16");v=y.data("token");var C={action:"remove",token_id:v};!u&&v&&confirm(n.remove_ask)&&(u=!0,x.removeClass("no").addClass("loading"),c.post(m,C,function(A){A.status&&"ok"===A.status?(y.remove(),0===r.find(".js-token-item").length&&l.remove()):(u=!1,x.removeClass("loading").addClass("no"))}).always(function(){u=!1;x.removeClass("loading").addClass("no")}))})})();
a.is_own_profile||b(a.wa_url,a.wa_framework_version);a.is_own_profile&&e();(function(){c(".js-webasyst-id-unbind-auth").on("click",function(l){l.preventDefault();c(".js-webasyst-id-unbind-auth").trigger("wa_waid_unbind_auth",{id:g})})})();(function(){c(".js-webasyst-id-help-link").on("click",function(l){l.preventDefault();c("body").trigger("wa_waid_help_link")})})();(function(l,r,u){function v(){y(!0)&&x()}function y(B){c("#c-access-rights-hint-warning").hide();c("#c-access-rights-hint-customize").hide();
var G=C.val();void 0===G&&(G="1");switch(G){case "remove":c("#c-credentials-block").hide();c("#c-login-block").hide();c("#c-password-block").hide();if(u){c("#c-access-rights-by-app").hide();c(".c-shown-on-access").hide();break}C.val(D||"0");c("#c-access-rights-hint-warning").show();return!1;case "0":if(d||f)if(d){var z=c("#c-access-rights-by-app");z.show();B&&z.find(".t-access-status").removeClass("type-no type-limited type-full").addClass("type-no");c(".c-shown-on-access").show();c("#c-login-block").show();
...
break}else return c("#c-login-block").show().find(".cancel").one("click.access",function(){C.val(D);v()}).end().find(".c-tab-toggle:first").click(),c("#c-password-block").show(),!1;else return c("#c-credentials-block").show().find(".c-login-input").focus().end().find(".cancel").one("click.access",function(){C.val(D);v()}),!1;default:return!1}l&&(c("#c-login-block").show(),c("#c-password-block").show());D=G;return!0}function x(){function B(z,F,k){return c.post(h+"?module=accessSave&action=rights&id="+
g,{app_id:z,name:F,value:k},"json")}var G=C.val();void 0===G&&(G="1");(function(){switch(G){case "0":return c.post(h+"?module=accessSave&action=makeuser",{id:g},"json").then(function(){return B("webasyst","backend",0)});case "1":return B("webasyst","backend",1);case "remove":return c.post(h+"?module=accessSave&action=revoke",{id:g},"json")}})().then(function(){u&&"0"==G?c("#c-access-rights-hint-customize").show():c("#c-access-rights-hint-warning").hide()})}var C=c("#c-access-rights-toggle"),A=c("#access-rights-toggle-confirm"),
D=C.val();r?c(".c-shown-on-access").hide():c(".c-shown-on-access").show();y();A.on("click",".cancel",function(){C.val(D);A.hide()});A.on("click",".button",function(){A.hide();v()});C.change(function(){if(d){c("#c-access-rights-hint-warning").hide();c("#c-access-rights-hint-customize").hide();var B=C.val();void 0===B&&(B="1");B===D?A.hide():A.show()}else y(!0)})})(a.is_own_profile,a.contact_no_access,a.contact_groups_no_access);new UserAccessTable({$wrapper:c("#c-access-rights-wrapper"),contact_id:g,
...
this.$activeIcon.removeClass(this.selected_class);this.$form.find('input[name="data[icon]"]').val(e).trigger("change");a.addClass(this.selected_class);this.$activeIcon=a};GroupEditDialog.prototype.save=function(a){function e(n){function l(v){b.$form.find(".state-error-hint").remove();c.each(v,function(y,x){y=b.$form.find("[name='"+x.field+"']");y.length&&y.addClass(b.has_error_class).after('<p class="state-error-hint custom-my-0">'+b.locales[x.locale]+"</p>")})}var r={},u=[];c.each(n,function(v,y){r[y.name]=
y.value});c.trim(r["data[name]"]).length||u.push({field:"data[name]",locale:"empty"});return u.length?(l(u),!1):r}var b=this,d;a=a||0;if(!b.is_locked)if(b.is_locked=!0,d=e(b.$form.serializeArray())){if(b.is_map_loading&&5>a)return b.is_locked=!1,b.save_timeout=setTimeout(function(){c.contains(document,b.$wrapper[0])&&b.save(a+1)},1E3),!1;b.$form.find(".js-submit-loading").remove();b.$submitButton.parent().append("<i class='fas fa-spin fa-spinner js-submit-loading wa-animation-spin speed-1000'></i>");
...
function(n,l){d["data[location][latitude]"]=n;d["data[location][longitude]"]=l;f()},function(){f()})}else b.is_locked=!1};GroupEditDialog.prototype.initMap=function(a){function e(u){function v(y,x){h.is(":hidden")&&h.show();r.render(y,x);g.val(y);f.val(x);b.dialog.resize()}clearTimeout(n);"string"===c.type(u)?(b.is_map_loading=!0,r.geocode(u,function(y,x){g.val(y);f.val(x);m.hide();v(y,x);b.is_map_loading=!1},function(){h.hide();f.val("");g.val("");m.show();b.is_map_loading=!1})):v(u.lat,u.lng)}var b=
this,d=b.$addressToggle.find(".f-location-edit-address-input"),f=b.$addressToggle.find(".t-location-longitude-input"),g=b.$addressToggle.find(".t-location-latitude-input"),h=b.$mapToggle.find(".t-location-edit-map"),m=b.$addressToggle.find(".t-map-hint"),n=0;if(0<d.length){var l=b.$form.find(".value").first().width();h.width(l);h.height(l/1.618)}var r=new TeamMap(h,a);a=f.val();l=g.val();a&&l&&e({lat:l,lng:a});d.on("change",function(){var u=c(this).val();u.length?e(u):(f.val(""),g.val(""),h.hide(400,
function(){return b.dialog.resize()}))});d.on("keyup",function(){clearTimeout(n);var u=c(this).val();u.length?(b.is_map_loading=!0,n=setTimeout(function(){e(u)},1E3)):(f.val(""),g.val(""),h.hide(400,function(){return b.dialog.resize()}))});return r};return GroupEditDialog}(jQuery),GroupDeleteDialog=function(c){GroupDeleteDialog=function(a){this.$wrapper=a.$wrapper;this.$block=this.$wrapper.find(".t-dialog-block");this.$deleteButton=this.$wrapper.find(".js-delete-event");this.api_enabled=window.history&&
...
a.$selectedStyleButton.removeClass(a.classes.selected_class)}var d=this;Pickr.create(d.pickr_options).on("change",function(f){return b(f)}).on("changestop",function(f,g){return g.hide()});d.$wrapper.dataset.colorPicker=d;d.$field.addEventListener("keyup",b,!1)};return e}();a.$styleWrapper.find(".t-color-toggle .t-toggle").each(function(){new e({$wrapper:this})})};CalendarEditDialog.prototype.setPreviewName=function(a){this.$badgeName.text(a.target.value.length?a.target.value:this.options.locales.preview)};
CalendarEditDialog.prototype.colorConvert=function(a,e){e=void 0===e?0:e;var b=0,d=0,f=0;a.includes("#")?4===a.length?(b="0x"+a[1]+a[1],d="0x"+a[2]+a[2],f="0x"+a[3]+a[3]):7===a.length&&(b="0x"+a[1]+a[2],d="0x"+a[3]+a[4],f="0x"+a[5]+a[6]):(f=a.split("(")[1].split(")")[0].split(",").splice(0,3),b=f[0],d=f[1],f=f[2]);b/=255;d/=255;f/=255;var g=Math.min(b,d,f),h=Math.max(b,d,f),m=h-g,n=0,l=a=0;n=0===m?0:h===b?(d-f)/m%6:h==d?(f-b)/m+2:(b-d)/m+4;n=Math.round(60*n);0>n&&(n+=360);l=(h+g)/2;a=0==m?0:m/(1-
Math.abs(2*l-1));a=+(100*a).toFixed();l=+(100*l).toFixed();0!==e&&(50<=l&&(l-=20),0<e?(l+=parseInt(e,10),100<=l&&(l-=10)):0>e&&(l+=parseInt(e,10)));e={hsl:"hsl("+n+","+a+"%,"+l+"%)"};l/=100;var r=a*Math.min(l,1-l)/100;b=function(u){u=(u+n/30)%12;return Math.round(255*(l-r*Math.max(Math.min(u-3,9-u,1),-1))).toString(16).padStart(2,"0")};e.hex="#"+b(0)+b(8)+b(4);return e};CalendarEditDialog.prototype.save=function(a){a.preventDefault();var e=this;e.is_locked||((a=function(b){function d(h){e.$form.find(".state-error-hint").remove();
c.each(h,function(m,n){m=e.$form.find('[name="'+n.field+'"]');m.length&&m.addClass(e.classes.has_error_class).after('<div class="state-error-hint custom-mt-4">'+e.options.locales[n.locale]+"</div>")})}var f={},g=[];c.each(b,function(h,m){f[m.name]=m.value});f["data[is_limited]"]||delete f["data[is_limited]"];c.trim(f["data[name]"]).length||g.push({field:"data[name]",locale:"empty"});return g.length?(d(g),!1):f}(e.$form.serializeArray()))?(e.is_locked=!0,c.post(e.options.api.save,a,function(b){"ok"!==
b.status?console.warn(b):(e.is_locked=!1,c.team.content.reload(),c.team.sidebar.reload(),e.teamDialog.close())})):(console.warn("have no data to save"),e.is_locked=!1,e.teamDialog.close()))};return CalendarEditDialog}(jQuery),CalendarDeleteDialog=function(c){CalendarDeleteDialog=function(a,e){this.$wrapper=a;this.$block=this.$wrapper.find(".dialog-body");this.$deleteButton=this.$block.find(".js-delete-calendar");this.options=e;this.is_locked=!1;this.initClass()};CalendarDeleteDialog.prototype.initClass=
function(){this.$deleteButton.on("click",c.proxy(this.deleteCalendar,this))};CalendarDeleteDialog.prototype.deleteCalendar=function(a){a.preventDefault();var e=this;e.is_locked||(a={id:e.options.calendar_id},e.is_locked=!0,c.post(e.options.api.delete,a,function(b){"ok"!==b.status?console.warn(b):(c.team.content.reload(),e.$wrapper.data("dialog").close())},"json"))};return CalendarDeleteDialog}(jQuery);var SiteApiTokenPage=function(c){SiteApiTokenPage=function(a){this.$wrapper=a.$wrapper;this.locale=a.locale;this.initClass()};SiteApiTokenPage.prototype.initClass=function(){this.initRemoveApiToken()};SiteApiTokenPage.prototype.initRemoveApiToken=function(){var a=this,e=a.$wrapper.find(".js-api-tokens-list"),b;a.$wrapper.on("click",".js-remove-api-token",function(d){d.preventDefault();d.stopImmediatePropagation();var f=c(this).closest(".js-token-item"),g=f.find("svg"),h=f.data("token");d=f.data("contact-id");
...
this.$inviteList.append(a);this.initWaToggle()};WelcomePage.prototype.sendInvites=function(){function a(g){var h=[];c.each(g,function(m,n){m=n.text;n=parseInt(n.name.replace(/[^0-9]/g,""));n=e.$inviteList.find(".t-invite-item").eq(n).find('[type="email"]');n.length&&h.push({$field:n,locale:m})});e.displayErrors(h)}var e=this,b=c.team.app_url+"?module=welcome&action=save",d=function(){var g=[],h=[];e.$inviteList.find(".t-invite-item").each(function(m){var n=c(this).find('[type="email"]'),l=c(this).find('[type="checkbox"]'),
r=n.val();l=l.prop("checked");c.trim(r).length&&(r.match(".+@.+")?(g.push({name:"data["+m+"][email]",value:r}),g.push({name:"data["+m+"][access]",value:l})):h.push({$field:n,locale:e.locales.incorrect}))});return h.length?(e.displayErrors(h),!1):g.length?g:!1}(),f=e.$wrapper.find(".js-send-invites");e.is_locked=!0;f.attr("disabled",e.is_locked).find("svg").toggleClass("hidden",!e.is_locked);d?c.post(b,d,function(g){g.errors&&g.errors.length?a(g.errors):location.href=c.team.app_url}).always(function(){e.is_locked=
!1;f.attr("disabled",e.is_locked).find("svg").toggleClass("hidden",!e.is_locked)}):(e.is_locked=!1,f.attr("disabled",e.is_locked).find("svg").toggleClass("hidden",!e.is_locked))};WelcomePage.prototype.removeErrors=function(a){var e=this.error_class;a?(a.removeClass(e),a.parent().find(".state-error-hint").remove()):(this.$inviteList.find(".state-error-hint").remove(),this.$inviteList.find("."+e).removeClass(e))};WelcomePage.prototype.displayErrors=function(a){var e=this.error_class;this.removeErrors();
c.each(a,function(b,d){b='<span class="state-error-hint" style="display: block">'+d.locale+"</span>";d.$field.addClass(e).after(b)})};return WelcomePage}(jQuery);var LongActionProcess=function(c){var a="",e="",b=500,d=750,f=[],g={},h=null,m,n,l,r,u,v,y,x,C=!1,A=function(){for(;0<f.length;){var z=f.shift();z&&clearTimeout(z)}},D=function(){var z=c.extend(!0,{},g);z.processId=e;z.cleanup=1;c.post(a,z,function(F){m&&m(F)}).always(function(){A()})},B=function(z){C||(z=z||b,z=setTimeout(function(){var F=c.extend(!0,{},g);F.processId=e;c.post(a,F,function(k){k?k.ready?(n&&n.call(h,k),D()):k.error?r&&r.call(h,k):k.progress?(l&&l.call(h,k),B()):k.warning?(u&&u.call(h,
k),B()):B(d):B(d);x&&x.call(h,k)},"json").error(function(){B(d)})},z),f.push(z))},G=function(z){if(!z.url)throw Error("Url is required");a=z.url;b=z.step_delay||b;d=z.rest_delay||d;g=z.post_data||g;m=z.onCleanup;n=z.onReady;l=z.onProgress;r=z.onError;u=z.onWarning;v=z.onStart;y=z.onStop;x=z.onAlways;h=this};c.extend(G.prototype,{start:function(){v&&v();var z=c.extend(!0,{},g);c.post(a,z,function(F){F&&F.processId?(e=F.processId,B(100),B(200)):F&&F.error?r&&r.call(h,F):r&&r.call(h,"Server error")},
"json").error(function(){r&&r.call(h,"Server error")})},stop:function(){C=!0;y&&y.call(h);A()}});return G}(jQuery);var TeamMap=function(c){var a=function(e,b,d){if(!e)throw Error("DOM element is required");this.$map=c(e);(this.provider=b)&&0>["google","yandex","disabled"].indexOf(this.provider)&&console.error("Not supported map provider: %s".replace("%s",this.provider));this.map_info=null;this.initClass()};a.prototype.initClass=function(){};a.prototype.render=function(e,b){switch(this.provider){case "google":return this.googleRender(e,b);case "yandex":return this.yandexRender(e,b)}};a.prototype.googleRender=function(e,
