...
class waHtmlControl
{
     ...
     *     'class'=>string/array of string, //CSS classes of control
     *     'style'=>string/array of string, //CSS classes of control
     *     'value'=>mixed,
     *     'size'=>int,    //HTML property of control
     *     'maxlength'=>int, //HTML property of control
     *     'cols'=>int,
     *     'rows'=>int,
     *     'wrap'=>bool,
     *     'options'=>array( //variants for selectable control
     ...
     * name="control_name" became name="namespace[name]" for string and name="namespace1[namespace2]...[control_name ] for array
     * @param $params array
