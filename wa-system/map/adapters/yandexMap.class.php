...
HTML;
    ...
    protected function initControls()
    {
        ...
        if ($env == waMapAdapter::FRONTEND_ENVIRONMENT) {
            $description = _ws('Obtain an API key for <strong>the free or paid version</strong> on the <a href="https://developer.tech.yandex.ru/" target="_blank">developer dashboard</a>. Select “<strong>JavaScript API, Geocoding API</strong>” option.');
        } else {
            $description = _ws('Obtain an API key for <strong>paid version</strong> on the <a href="https://developer.tech.yandex.ru/" target="_blank">developer dashboard</a>. Select “<strong>JavaScript API, Geocoding API</strong>” option.')
             . '<br>'
             . _ws('If no commercial version API key is entered, only the map link will be shown.');
        }
