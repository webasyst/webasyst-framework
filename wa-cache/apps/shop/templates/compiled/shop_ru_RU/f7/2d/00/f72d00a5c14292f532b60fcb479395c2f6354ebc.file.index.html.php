<?php /* Smarty version Smarty-3.1.14, created on 2015-02-09 16:54:13
         compiled from "/var/www/admin/data/www/pchelkinazabava.ru/wa-data/public/site/themes/default/index.html" */ ?>
<?php /*%%SmartyHeaderCode:31300149554d8adf5622041-86965885%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '31300149554d8adf5622041-86965885',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_54d8adf5939336_31745713',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54d8adf5939336_31745713')) {function content_54d8adf5939336_31745713($_smarty_tpl) {?><?php if (!is_callable('smarty_function_wa_print_tree')) include '/var/www/admin/data/www/pchelkinazabava.ru/wa-system/vendors/smarty-plugins/function.wa_print_tree.php';
...
">Регистрация</a></li>
        ...
        <div class="bee2"><?php if ($_smarty_tpl->tpl_vars['wa']->value->shop){?> 
              ...
              <div id="cart" class="cart<?php if (!$_smarty_tpl->tpl_vars['cart_total']->value){?> empty<?php }?>"> <a href="<?php echo $_smarty_tpl->tpl_vars['wa']->value->getUrl('shop/frontend/cart');?>
...
" class="cart-to-checkout" style="display: none; font-size:10px;"> Оформить заказ </a> </div>
              <?php }?> </div>
      </div>
        </div>
    <div id="navigation">
