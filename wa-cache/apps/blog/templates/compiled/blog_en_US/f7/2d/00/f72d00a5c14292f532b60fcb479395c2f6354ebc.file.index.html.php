...
<?php /*%%SmartyHeaderCode:7627005905506c5c978f4a7-91145209%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '7627005905506c5c978f4a7-91145209',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5506c5c9bc1626_59649474',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5506c5c9bc1626_59649474')) {function content_5506c5c9bc1626_59649474($_smarty_tpl) {?><?php if (!is_callable('smarty_function_wa_print_tree')) include '/var/www/admin/data/www/pchelkinazabava.ru/wa-system/vendors/smarty-plugins/function.wa_print_tree.php';
...
" class="cart-summary"> <b class="cartname"> Cart:</b><br>
...
" class="cart-to-checkout" style="display: none; font-size:10px;"> Proceed to checkout </a> 
                                <?php if ($_smarty_tpl->tpl_vars['wa']->value->user()->isAuth()){?>
...
"<?php if ($_smarty_tpl->tpl_vars['wa']->value->get($_smarty_tpl->tpl_vars['filter']->value['code'])){?> checked<?php }?> value="1"> Yes</label>
                                        <label><input type="radio" name="<?php echo $_smarty_tpl->tpl_vars['filter']->value['code'];?>
"<?php if ($_smarty_tpl->tpl_vars['wa']->value->get($_smarty_tpl->tpl_vars['filter']->value['code'])==='0'){?> checked<?php }?> value="0"> No</label>
                                        <label><input type="radio" name="<?php echo $_smarty_tpl->tpl_vars['filter']->value['code'];?>
"<?php if ($_smarty_tpl->tpl_vars['wa']->value->get($_smarty_tpl->tpl_vars['filter']->value['code'],'')===''){?> checked<?php }?> value=""> Any</label>
...
"<?php }?>>
                                                            to <input type="text" class="max" name="<?php echo $_smarty_tpl->tpl_vars['filter']->value['code'];?>
